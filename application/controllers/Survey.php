...
/********************************************Ravi Coading Start******************************************/
	...
	{		
		...
		{	
			...
			$data["results"] = $this->Survey_model->survey_multiple_choices_list($data['Company_id']);
			...
			else
			{
				...
				$check_no_of_options = is_numeric(strip_tags($this->input->post('no_of_options')));
				if($check_no_of_options !=1)
				{
					$this->session->set_flashdata("error_code", "Please Enter Valid No of Options");
					redirect(current_url());
				}
				...
				{ 
					...
					if($result == true)				
					{
						...
						$opval = strip_tags($this->input->post('multiple_choice_name'));
	...
	public function update_survey_multiple_choices()
	{
		...
		{	
			...
			{	
				$Choice_id= App_string_decrypt($this->input->post('Choice_id'));
	...
	public function edit_multiple_choice()
	{
		...
		{	
			...
			if($_GET['Choice_id'])
			{
				$Choice_id = $_SESSION[$_REQUEST['Choice_id']];
				$data["results"] = $this->Survey_model->survey_multiple_choices_list($data['Company_id']);
				$data['MultipleChoice_details']= $this->Survey_model->Get_multiple_choices_details($Choice_id);
	...
	{			
		...
		{	
			...
			$data["Survey_structure"] = $this->Survey_model->survey_structure_list($data['Company_id']);
			...
			$Required_filed = array(
				...
				array(
						'field' => 'Type_of_survey',
						'label' => 'Type_of_survey',
						'rules' => 'required'
				),
				array(
				...
				array(
						'field' => 'remind_after_validity',
						'label' => 'remind_after_validity',
						'rules' => 'required'
				),
				array(
						'field' => 'remind_before_validity',
						'label' => 'remind_before_validity',
						'rules' => 'required'
				),
				array(
						'field' => 'r2',
				...
				array(
						'field' => 'Survey_template',
						'label' => 'Survey_template',
						'rules' => 'required'
				));
			...
			$Type_of_survey = strip_tags($this->input->post('Type_of_survey'));
			$Survey_type = array('1','2','3');
			if (!in_array($Type_of_survey, $Survey_type))
			{
				$this->session->set_flashdata("error_code", "Please Provide Valid Survey Type");
				redirect(current_url());
			}	
			$check_no_of_questions = is_numeric(strip_tags($this->input->post('no_of_questions')));
			if($check_no_of_questions !=1)
			{
				$this->session->set_flashdata("error_code", "Please Enter Valid No of Questions");
				redirect(current_url());
			}
			$check_multiple_choice = is_numeric(strip_tags($this->input->post('multiple_choice')));
			if($check_multiple_choice !=1)
			{
				$this->session->set_flashdata("error_code", "Please Enter Valid Multiple Choice Questions");
				redirect(current_url());
			}
			$check_text_based = is_numeric(strip_tags($this->input->post('text_based')));
			if($check_text_based !=1)
			{
				$this->session->set_flashdata("error_code", "Please Enter Valid Text Based Questions");
				redirect(current_url());
			}
			$check_remind_after_validity = is_numeric(strip_tags($this->input->post('remind_after_validity')));
			if($check_remind_after_validity !=1)
			{
				$this->session->set_flashdata("error_code", "Please Enter remind after validity");
				redirect(current_url());
			}
			$check_remind_before_validity = is_numeric(strip_tags($this->input->post('remind_before_validity')));
			if($check_remind_before_validity !=1)
			{
				$this->session->set_flashdata("error_code", "Please Enter remind before validity");
				redirect(current_url());
			}			
				$Post_data=array
						   ( 
							'Company_id'=>$Company_id,
							'Survey_name'=>strip_tags($this->input->post('survey_name')),
							'Survey_type'=>strip_tags($this->input->post('Type_of_survey')),
							'No_of_questions'=>strip_tags($this->input->post('no_of_questions')),
							'No_of_multiple_choice'=>strip_tags($this->input->post('multiple_choice')),
							'No_of_text_based'=>strip_tags($this->input->post('text_based')),	
							'Start_date'=>$from_date,
							'End_date'=>$to_date,
							'Reminder_days_after'=>strip_tags($this->input->post('remind_after_validity')),
							'Reminder_days_before'=>strip_tags($this->input->post('remind_before_validity')),
							'Status'=>1,
							'Send_flag'=>0,
							'Survey_rewarded'=>strip_tags($this->input->post('r2')),
							'Survey_reward_points'=>$Survey_Reward_Points,
	...
	function editsurveystructure()
	{
		...
		{	
			...
			$data["Survey_structure"] = $this->Survey_model->survey_structure_list($data['Company_id']);
			$Survey_id = $_SESSION[$_REQUEST['Survey_id']];
			if($Survey_id)
			{
				$data["Survey_details"] = $this->Survey_model->get_survey_structure_details($data['Company_id'],$Survey_id);	
			}			
	...
	{	
		...
		{	
			...
			{
				$Survey_id = App_string_decrypt($this->input->post('Survey_id'));
				//$Company_id=$this->input->post('Company_id');
				$today=date('Y-m-d H:i:s');
				$from_date=date('Y-m-d',strtotime($this->input->post('Valid_from')));
				$to_date=date('Y-m-d',strtotime($this->input->post('Valid_till')));
				
				$Survey_rewarded = strip_tags($this->input->post('Survey_Reward'));
							
					if($Survey_rewarded == 1)
					{
						$Survey_reward_points = strip_tags($this->input->post('Survey_Reward_Points'));
					}
					else
					{
						$Survey_reward_points = 0;
				...
				$Post_data=array
						   (							
							...
							'Survey_reward_points' =>$Survey_reward_points ,							
							'Survey_template' =>strip_tags($this->input->post('Survey_template')),							
							'Update_date'=>$today
						   );
				...
				if($result == true)				
				{
					...
					/*******************Insert igain Log Table*********************/
						...
						$lastName = '';
						$Seller_name = $session_data['Full_name'];
						$opval = strip_tags($this->input->post('survey_name'));
						$result_log_table = $this->Igain_model->Insert_log_table($Company_id,$enroll,$username,$Seller_name,$Todays_date,$what,$where,$userid,$opration,$opval,$firstName,$lastName,$To_enrollid);
					/*******************Insert igain Log Table*********************/	
				}
				else
...
/**************************************Nilesh Work Start**********************************/
	...
	{	
		...
		{	
			...
			$data["Survey_NPS"] = $this->Survey_model->survey_nps_list(0,0,$data['Company_id']);
			...
			else
			{
				...
				$Post_data=array
						   (
							'NPS_company_id'=>$Company_id,
							'NPS_type_name'=> strip_tags($this->input->post('nps_type_name')),
							'NPS_type_description'=> strip_tags($this->input->post('description')),
							'Active_flag'=>1,
	...
	{	
		...
		{	
			...
			$data["Survey_NPS_details"] = $this->Survey_model->survey_nps_list(0,0,$data['Company_id']);
			$NPS_type_id = $_SESSION[$_REQUEST['NPS_type_id']];
			if($NPS_type_id)
			{
				$data["Survey_NPS"] = $this->Survey_model->get_survey_nps_details($data['Company_id'],$NPS_type_id);	
			}
	...
	{	
		...
		{	
			...
			$data["Survey_structure"] = $this->Survey_model->survey_nps_list(0,0,$data['Company_id']);
			...
			else
			{
				...
				$NPS_type_id=App_string_decrypt($this->input->post('NPS_type_id'));
				$NPS_type_name= strip_tags($this->input->post('nps_type_name'));
				$NPS_type_description= strip_tags($this->input->post('description'));
				$today=date('Y-m-d H:i:s');
	...
	function surveyquestion()
	{
		...
		{	
			...
			$data["SurveyQuestion"] = $this->Survey_model->survey_structure_list($data['Company_id']);
			...
			else
			{
				...
				{
					$MultipleSelect = strip_tags($this->input->post('Multiple_selection'));
				}
				if(strip_tags($this->input->post('ResponseType')) == 2)
				{
					$MultipleSelect=0;
				}
				else
				...
				{
					$ChoiceSet = strip_tags($this->input->post('MultipleChoiceSet'));
				}
				...
				$Post_data=array
						   (
							...
							'Question'=>strip_tags($this->input->post('surveyquestion')),
							'Response_type'=>strip_tags($this->input->post('ResponseType')),
							'Choice_id'=>$ChoiceSet,
				...
				if($result == true)				
				{
					/*******************Insert igain Log Table*********************/
						...
						$lastName = '';
						$Seller_name = $session_data['Full_name'];
						$opval = strip_tags($this->input->post('surveyquestion'));
						$result_log_table = $this->Igain_model->Insert_log_table($Company_id,$enroll,$username,$Seller_name,$Todays_date,$what,$where,$userid,$opration,$opval,$firstName,$lastName,$To_enrollid);
					/*******************Insert igain Log Table*********************/
			...
			{	
				...
				if( $this->input->post("submit") == "Send" )
				{
							...
							if($Insert_survey_details == true)
							{
									...
									if($send_notification == true)
									{
										...
										/*---------------Insert into iGain Log Table for single member-----------*/
											...
											$what="Send Survey to Member";
											$where="Send Survey to Member(s)";
											$toname="";
					...
					if($radio2 == 5) //****Segment customer
					{
							...
							foreach ($all_customers as $row)
							{
								$Applicable_array = $this->Igain_model->Segment_applicable_function($compid,$Segment_id,$row["Enrollement_id"],$row["Sex"],$row["Country_id"],$row["District"],$row["State"],$row["City"],$row["Zipcode"],$row["total_purchase"],$row["Date_of_birth"],$row["joined_date"],$row["Tier_id"]);
								if(!in_array(0, $Applicable_array, true))
								{
									...
									if($Insert_survey_details == true)
									{
											...
											'Template_type' => 'Survey_send',
											// 'Notification_type' => 'Send Survey'
											'Notification_type' => 'Survey From '.$Company_name
											);								
											$send_notification = $this->send_notification->send_Notification_email($Enrollment_id,$Email_content,$super_seller->Enrollement_id,$compid);
																			
											if($send_notification == true)
											{
												$this->session->set_flashdata("success_code","Survey Sent Successfuly!!");
...
/***********************************************Nilesh Code Start**********************************************/
	...
	{	
		...
		{	
			...
			$data["NPS_master"] = $this->Survey_model->nps_master_list(0,0,$data['Company_id']);
			...
			else
			{
				...
				array(
						'field' => 'NPS_dictionay_name',
						'label' => 'NPS dictionay name',
						'rules' => 'required'
				),
				array(
						'field' => 'NPS_dictionary_keywords',
						'label' => 'NPS dictionary keywords',
						'rules' => 'required'
				),
				array(
						'field' => 'description',
				...
				$Post_data=array
						   (
							...
							'NPS_type_id'=>strip_tags($this->input->post('Npstype')),
							'NPS_dictionay_name'=>strip_tags($this->input->post('NPS_dictionay_name')),
							'NPS_dictionary_keywords'=>$this->input->post('NPS_dictionary_keywords'),
							'NPS_dictionary_description'=>strip_tags($this->input->post('description')),
							'Active_flag'=>1,
							'Create_User_id'=>$data['enroll'],
							'Creation_date'=>$today
				...
				if($result == true)				
				{
					...
					/*******************Insert igain Log Table*********************/
						...
						$lastName = '';
						$Seller_name = $session_data['Full_name'];
						$opval =strip_tags($this->input->post('NPS_dictionay_name'));
						$result_log_table = $this->Igain_model->Insert_log_table($Company_id,$enroll,$username,$Seller_name,$Todays_date,$what,$where,$userid,$opration,$opval,$firstName,$lastName,$To_enrollid);
					/*******************Insert igain Log Table*********************/
				}
				else
	...
	{	
		...
		{	
			...
			$NPS_id = $_SESSION[$_REQUEST['NPS_id']];
			
			if($NPS_id)
			{
				$data["NPS_master_details"] = $this->Survey_model->get_nps_master_details($data['Company_id'],$NPS_id);	
			}
	...
	{	
		...
		{	
			...
			else
			{
				...
				$NPS_id = App_string_decrypt($this->input->post('NPS_id'));
				$NPS_type_id= strip_tags($this->input->post('Npstype'));
				$NPS_dictionay_name= strip_tags($this->input->post('NPS_dictionay_name'));
				$NPS_dictionary_keywords=$this->input->post('NPS_dictionary_keywords');
