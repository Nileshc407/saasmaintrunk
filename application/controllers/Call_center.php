				...
				else if($Query_status == 2) //Forward
				{
					...
					if($result == true && $result1 == true)				
					{
						...
						$Email_content = array(
								...
								'Priority_name' => $Resolution_priority_name,
								'Excecative_email' => $Company_primary_email_id,
								'Excecative_contact_no' => $Company_primary_phone_no,
	...
	{	
		...
		{			
			...
			{	
				...
				$data["Assign_qry"] = $this->CallCenter_model->Assign_query($data['Company_id'],$data['enroll'],$Log_ticket,$querypriority,$Closure_date,$Sub_seller_admin);
				...
				$data["Forward_qury"] = $this->CallCenter_model->Forward_querys($data['Company_id'],$LoginUserQry_id,$data['enroll'],$Log_ticket,$querypriority,$Closure_date,$Sub_seller_admin);		
				
				$data["closed_qury"] = $this->CallCenter_model->Closed_querys($data['Company_id'],$LoginUserQry_id,$Log_ticket,$querypriority,$Closure_date,$SuperSellerFlag,$data['enroll'],$Sub_seller_admin);
