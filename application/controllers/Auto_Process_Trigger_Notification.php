				...
				foreach($trigger_results as $trig)
				{
					...
					if($Trigger_notification_type == 1) //***** customer tier defined ****
					{
						...
						foreach($next_tier_info as $Tiers_Record)
						{
							...
							{
								$Trans_Records2 = $this->Auto_process_model->Get_Cumulative_spend_transactions($Company_id,$From_date,$Todays_date,$Tier_id,$Tier_Business_flag);
							}
							if($next_Tier_criteria==2)//Cumulative Number of Transactions
							{
								$Trans_Records2 = $this->Auto_process_model->Get_Cumulative_Total_transactions($Company_id,$From_date,$Todays_date,$Tier_id,$Tier_Business_flag);
							}
							if($next_Tier_criteria==3)//Cumulative Points Accumlated
							{
								$Trans_Records2 = $this->Auto_process_model->Get_Cumulative_Points_Accumlated($Company_id,$From_date,$Todays_date,$Tier_id,$Tier_Business_flag);
							}
							// $next_Operator_id = 6; 
					...
					if($Trigger_notification_type == 3)  //********* Auction defined ******
					{
						...
						if($Todays_date >= $auction_from_date || $Todays_date <= $auction_end_date)
						{
							...
							list($month, $day, $year) = EXPLODE('-', $auction_from_date);
							$timeStamp = mktime(0, 0, 0, $month, $day, $year);
							$Difference = ceil(abs($timeStamp - $tUnixTime) / 86400);
							
							
							echo "<br>-0-tUnixTime---".$tUnixTime."--<br>";
							echo "<br>-0-timeStamp---".$timeStamp."--<br>";
							echo "<br>-0-Difference days---".$Difference."--<br>";
							
							
							
							$tUnixTime1 = time();
							list($month1, $day1, $year1) = EXPLODE('-', $auction_end_date);
							
							$timeStamp1 = mktime(0, 0, 0, $month1, $day1, $year1);
							$Difference1 = ceil(abs($timeStamp1 - $tUnixTime1) / 86400);
							
							
							echo "<br>-1-tUnixTime---".$tUnixTime."--<br>";
							echo "<br>-1-timeStamp---".$timeStamp."--<br>";
							echo "<br>-1-Difference days---".$Difference1."--<br>";
							...
							if($Difference == $Trigger_notification_start_days || $Difference1 == $Trigger_notification_end_days)
							{
