	...
	<div class="content-box">
		<div class="row">
			...
			<?php $attributes = array('id' => 'formValidate');
				echo form_open_multipart('Company_redemption_report/Redemption_Report',$attributes); ?>
				<div class="element-wrapper">
					<h6 class="element-header">COMPANY PARTNER REDEMPTION REPORT</h6>  
					<div class="element-box">
						<div class="row">
							<div class="col-sm-6">	
								...
								<div class="form-group">
									<label for=""><span class="required_info">*</span> Select Partner</label>
										<select class="form-control" name="Partner_id" id="Partner_id" required data-error="Please Select Partner" onchange="get_clients(this.value);">
										<option value="">Select Partner</option>							
										
										<option value="0">All Partners</option>
										
										<?php								
											foreach($Partner_companys as $Partner)
											{									
												
													echo '<option value="'.$Partner['Company_id'].'">'.$Partner['Company_name'].'</option>';
							...
							<div class="col-sm-6">
							 ...
							 <div class="form-group">
								<div id="client">
									<label for=""><span class="required_info">*</span> Select Company Clients</label>
									<select  class="form-control" name="partner_client" id="partner_client" required>
							  ...
							  <div class="form-group">
								<label for="exampleInputEmail1"><span class="required_info">*</span> Select Voucher Status</label>
									...
									<option value="296">Delivered</option>
		...
		$partner_client=$_REQUEST["partner_client"];
				...
				<div class="element-wrapper">											
					<div class="element-box">
					  ...
					  <div class="table-responsive">
						...
						if($Trans_Records != NULL)
						{
							...
							foreach($Trans_Records as $row)
							{
								...
								/* if($lv_Enrollement_id!=$Enrollement_id)
								{
									...
									if($row->Voucher_status=="Issued" || $row->Voucher_status=="Ordered" || $row->Voucher_status=="Delivered")
									{
										$color="green";
									}
									else
									...
									/* if($row->Cost_payable_to_partner>0){
										...
										$Cost_payable_to_partner=$row->Cost_payable_to_partner;
										
									}else{
										
										$Cost_payable_to_partner = $row->Cost_payable_partner;
									} */
									
									// $Cost_payable_to_partner = $row->Paid_amount;
								...
								<a href="javascript:void(0);" id="receipt_redemption_details" onclick="receipt_redemption_details(<?php echo $row->Company_id; ?>,<?php echo $row->Card_id; ?>,'<?php echo $row->Voucher_no; ?>');" title="Receipt">
									...
									echo "<td>".($row->Cost_payable_partner*$row->Quantity)."</td>";
									echo "</tr>";
						...
						<!--
						<a href="<?php echo base_url()?>index.php/Reportc/export_partner_update_voucher_status/?start_date=<?php echo $start_date; ?>&end_date=<?php echo $end_date; ?>&partner_client=<?php echo $partner_client; ?>&Partner_id=<?php echo $Partner_id; ?>&Voucher_status=<?php echo $Voucher_status; ?>&pdf_excel_flag=1">Update Details
						<button class="btn btn-success" type="button"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Excel</button>
						</a>
						<a href="<?php echo base_url()?>index.php/Reportc/export_partner_update_voucher_status/?start_date=<?php echo $start_date; ?>&end_date=<?php echo $end_date; ?>&partner_client=<?php echo $partner_client; ?>&Partner_id=<?php echo $Partner_id; ?>&Voucher_status=<?php echo $Voucher_status; ?>&pdf_excel_flag=2">
							<button class="btn btn-danger" type="button"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Pdf</button>
						</a>						
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						-->
						
						<a href="<?php echo base_url()?>index.php/Company_redemption_report/export_partner_redempion_report/?start_date=<?php echo $start_date; ?>&end_date=<?php echo $end_date; ?>&partner_client=<?php echo $partner_client; ?>&Partner_id=<?php echo $Partner_id; ?>&Voucher_status=<?php echo $Voucher_status; ?>&pdf_excel_flag=1"><button class="btn btn-success" type="button"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Excel</button>
						</a>						

						<a href="<?php echo base_url()?>index.php/Company_redemption_report/export_partner_redempion_report/?start_date=<?php echo $start_date; ?>&end_date=<?php echo $end_date; ?>&partner_client=<?php echo $partner_client; ?>&Partner_id=<?php echo $Partner_id; ?>&Voucher_status=<?php echo $Voucher_status; ?>&pdf_excel_flag=2">
							<button class="btn btn-danger" type="button"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Pdf</button>
						</a>
				<?php } ?>
...
$('#Register').click(function()
{
	...
	/* $('#Partner_id').change(function()
	{
		...
		$.ajax({
			...
			{
				//alert(data)
				$('#partner_client').html(data.Get_Partner_Branches2);
