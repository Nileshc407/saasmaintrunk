		  ...
		  <div class="col-sm-12">
			<div class="element-wrapper">
			  ...
			  <?php
				...
				<input type="hidden" id="Tier_Business_flag" name="Tier_Business_flag" value="0">
					<div class="row">
					<div class="col-sm-6">	
					  ...
					  <!--
						<div class="form-group" >
							<label for=""> &nbsp;</label>
							<div class="grid-item">
							<input type="radio" name="Tier_Business_flag" id="Business_flag1" value="1"  checked  onclick='$("#busTierlevel").show();$("#indTierlevel").hide();'> Bussiness
							&nbsp;	&nbsp;	&nbsp;
							<input type="radio" name="Tier_Business_flag" id="Business_flag2" value="0"  onclick='$("#indTierlevel").show();$("#busTierlevel").hide();' > Individual
							</div>	
						</div> 
					  -->
							
						
						<div class="form-group" id="indTierlevel" style="display:none;">
						...
						<?php }
							...
							{ 
								$Tier_levelI++;	
							?>
							<option value="<?php echo $Tier_levelI; ?> ">Level <?php echo $Tier_levelI; ?> </option>
						<?php } ?>
						</select>
						</div>
					...
					<div class="col-sm-6">	
						...
						<?php }
							...
							{ 
								$Tier_levelB++;	
							?>
							<option value="<?php echo $Tier_levelB; ?> ">Level <?php echo $Tier_levelB; ?> </option>
						<?php } ?>
						</select>
						</div>
					...
					<div class="form-group">
							...
							<input type="text" class="form-control" name="Tier_redemption_ratio" id="Tier_redemption_ratio" required onkeypress="return isDecimal(event,this.id);"  >
							<div class="help-block form-text with-errors form-control-feedback"></div>
						</div>
				   </div> 
				   </div> 
...
<script>
	$("#indTierlevel").show();$("#busTierlevel").hide();
