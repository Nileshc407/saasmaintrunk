				...
				echo form_open('TierC/tier_masterc',$attributes); ?>
					...
					<div class="col-sm-6">	
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="Redeemtion_limit" id="Redeemtion_limit"  <?php if($Company_details->Enable_company_meal_flag==1){echo 'placeholder="Enter Meal Top Up"';}else{echo 'placeholder="Enter Redeemtion Limit"';} ?>  required="required" onkeyup="this.value=this.value.replace(/\D/g,'')" >
							<div class="help-block form-text with-errors form-control-feedback"></div>
						</div>
