		  ...
		  <div class="col-sm-12">
			<div class="element-wrapper">
			  <h6 class="element-header">
				CALL CENTER RESOLUTION PRIORITY LEVEL
			  </h6>
			   <div class="element-box">
			<?php $attributes = array('id' => 'formValidate');
				echo form_open_multipart('Call_center/Resolution_priority_levels',$attributes); ?> 
				  <?php
					...
					<div class="row">
						<div class="col-sm-6">
						  <div class="form-group">
							...
							<input class="form-control" type="text" name="PriorityLevel" id="PriorityLevel" placeholder="Enter priority level" data-error="Please enter priority level" onkeypress="return isNumberKey(event)" required="required">
						  ...
						  <div class="form-group" id="Levelname">
							...
							<input class="form-control" type="text" name="Level_name" id="Level_name" placeholder="Enter level name" data-error="Please enter level name" required="required">
						  ...
						  <div class="form-group" id="No_of_days_expected_resolve">
							...
							<input class="form-control" type="text" name="days_expected_resolve" id="days_expected_resolve" placeholder="Enter no. of hours to resolve" data-error="Please enter no. of hours to resolve" onkeypress="return isNumberKey(event)" required="required">
						...
						if($CallCenterresolutionpriority != NULL)
						{
							...
							<tr>
								...
								<?php if($_SESSION['Privileges_Edit_flag']==1){ ?>
									<a href="<?php echo base_url()?>index.php/Call_center/Edit_Resolution_priority_levels/?Resolution_id=<?php echo $row->Resolution_id;?>" title="Edit"><i class="os-icon os-icon-ui-49"></i></a><?php } ?>
								</td>
