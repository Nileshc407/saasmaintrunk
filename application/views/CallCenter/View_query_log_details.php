       ...
       <tbody>														
				...
				{	?>													
					<tr>
						...
						<td class="text-center">
							<?php if($row->Resolution_priority_levels==1){ ?> <div class="badge badge-success-inverted" href="" style="width: 100%;"><?php echo "Normal";//$row->Level_name; ?></div><?php } ?>
							<?php if($row->Resolution_priority_levels==2){ ?> <div class="badge badge-danger-inverted" href="" style="background-color: #fbe4a0 !important;width: 100%;"><?php echo "Urgent";//$row->Level_name ?> </div> <?php } ?>
							<?php if($row->Resolution_priority_levels==3){ ?> <div class="badge badge-danger-inverted" href="" style="background-color: #ffb3b3 !important;width: 100%;"><?php echo "Very Urgent"; //$row->Level_name;?> </div><?php } ?>
							<?php if($row->Resolution_priority_levels==4){ ?> <div class="badge badge-primary-inverted" href="" style="width: 100%;"><?php echo "Top Priority";//$row->Level_name;?> </div> <?php } ?>
