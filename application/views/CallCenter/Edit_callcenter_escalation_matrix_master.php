		  ...
		  <div class="col-sm-12">
			<div class="element-wrapper">
			  <h6 class="element-header">
				EDIT CALL CENTER ESCALATION MATRIX
			  </h6>
			...
			<?php 	$attributes = array('id' => 'formValidate');
					echo form_open_multipart('Call_center/Update_Call_center_escalation_levels',$attributes); ?>
						
					  <div class="form-group">
						<label for=""><span class="required_info">* </span>Enter No. of Unresolved Days</label>
						<input class="form-control" type="text" name="Unresolved_Days" id="Unresolved_Days" value="<?php echo $escalation_matrix->No_of_unresolved_days; ?>" placeholder="Enter no. of unresolved days" data-error="Please enter no. of unresolved days" onkeypress="return isNumberKey(event)" required="required">
					  ...
					  <div class="form-group" id="User_Type">
						...
						if($UserType != NULL)
						{
							...
							{ ?>		
							<option value="<?php echo $row1->User_id; ?>" <?php if($escalation_matrix->User_type_id == $row1->User_id) { ?> selected <?php  } ?> ><?php echo $row1->User_type; ?> 
							</option>
					<?php  }
						}
						 ?>
					  ...
					  <div class="form-group" id="User_Name">
							...
							<?php $get_enrollment = $ci_object->Igain_model->get_enrollment_details($escalation_matrix->Enrollment_id); ?>
							
							<option value="<?php echo $escalation_matrix->Enrollment_id; ?>"><?php echo $get_enrollment->First_name.' '.$get_enrollment->Last_name; ?></option>
							</select>	
							<div class="help-block form-text with-errors form-control-feedback"></div>						
					  </div>
					  ...
					  <div class="form-buttons-w">
						...
						<input type="hidden" name="Escalation_matrix_id" value="<?php echo $escalation_matrix->Escalation_matrix_id ?>">
					  </div>
					<?php echo form_close(); ?>		  
				  </div>
				</div>
