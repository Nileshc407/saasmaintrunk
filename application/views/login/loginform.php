...
<body style="">
    ...
    <div class="container">
        <div class="card card-container" style="margin-left: 70%;">	
            <img id="profile-img" class="profile-img-card" src="<?php echo base_url()?>images/Miraclecartes-logo.png" />			
...
body {
 background-image: url("<?php echo base_url()?>images/home_page_login1.png"); 
