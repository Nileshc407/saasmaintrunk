		...
		<div class="col-xs-12 col-md-8"><br/>	
			<div class="modal-content">	
				<div class="modal-header">
					<div class="col-md-12">
						<img id="profile-img" class="profile-img-card" src="<?php echo base_url(); ?><?php echo $Company_logo; ?>" style="width:30%;">
					</div>
					<br>
					<h4 class="modal-title" style="text-align:center">Set New Password</h4>
				</div>
...
$("#change_pwd").click(function()
{
	...
	if($('#new_Password').val().indexOf('#') !== -1)
		{
			Error_count++;		
			has_error("#has-feedback21","#glyphicon21","#help-block21","Can not use # % & + and = characters for security purpose.");			
			setTimeout(function(){
				
				$("#feedback21").removeClass("glyphicon glyphicon-remove");
...
<style>
body {
	<?php if($Pwd_variables["Company_id"] ==3) { ?>
		background-image: url("<?php echo  base_url()?>images/home_page_login1.jpg");
	<?php } else if($Pwd_variables["Company_id"] ==13) { ?>
		background-image: url("<?php echo  base_url()?>images/aeroclub/aeroclub.png"); 
