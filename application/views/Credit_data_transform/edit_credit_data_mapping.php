		  ...
		  <div class="col-sm-12">
			<div class="element-wrapper">
			  <h6 class="element-header">
			   EDIT CREDIT TRANSACTION DATA MAPPING
			  </h6>
			  <div class="element-box">
				...
				<?php $attributes = array('id' => 'formValidate');
					echo form_open('Credit_data_transform/update_data_map',$attributes); ?>
				...
				<div class="row">
					...
					<div class="col-sm-12 col-md-6">
						...
						<input class="form-control" onchange="checkVAL(this.value,this.id);"  name="Column_Membership_ID" id="Column_Membership_ID" type="text" placeholder="Enter Column No. Membership ID" required="required" onkeyup="this.value=this.value.replace(/\D/g,'')" data-error="Please enter column number of membership id" value="<?php echo $Records->Column_Membership_ID;?>">
						<div class="help-block form-text with-errors form-control-feedback"></div>
					</div>
						
					<div class="form-group">
						<label for=""> <span class="required_info">* </span>Bill No. </label>								
						<input class="form-control" onchange="checkVAL(this.value,this.id);"  name="Column_Bill_no"  id="Column_Bill_no"  type="text" onkeyup="this.value=this.value.replace(/\D/g,'')"   placeholder="Enter Column No. Bill No" required="required" data-error="Please enter column number of bill number" value="<?php echo $Records->Column_Bill_no;?>">
						<div class="help-block form-text with-errors form-control-feedback"></div>
					</div>
					  
					  <div class="form-group">
						<label for=""> <span class="required_info">* </span>Credit Points </label>								
						<input class="form-control" onchange="checkVAL(this.value,this.id);"  name="Column_Credit_Points"  id="Column_Credit_Points"  type="text" onkeyup="this.value=this.value.replace(/\D/g,'')"   placeholder="Enter Column No. of Credit Points" required="required" data-error="Please enter column number of Credit Points" value="<?php echo $Records->Column_Amount;?>">
						<div class="help-block form-text with-errors form-control-feedback"></div>
					  </div>
					 <div class="form-group">
						<label for=""> <span class="required_info">* </span>Remarks </label>
						<input class="form-control" onchange="checkVAL(this.value,this.id);"  name="Column_Remarks" id="Column_Remarks" type="text" placeholder="Enter Column No. of Remarks" required="required" onkeyup="this.value=this.value.replace(/\D/g,'')" data-error="Please enter column number of Remarks" value="<?php echo $Records->Column_remarks;?>">
						<div class="help-block form-text with-errors form-control-feedback"></div>
					</div>  
					<div class="form-group">
						<label for=""> <span class="required_info">* </span>Date </label>
						<input class="form-control" onchange="checkVAL(this.value,this.id);"  name="Column_Date" id="Column_Date" type="text" placeholder="Enter Column No. Date" required="required" onkeyup="this.value=this.value.replace(/\D/g,'')" data-error="Please enter column number of date" value="<?php echo $Records->Column_Date;?>">
						<div class="help-block form-text with-errors form-control-feedback"></div>
					</div> 
...
function setArray() 
{
	...
	Val_array.push(document.querySelector('#Column_Credit_Points').value);
...
{
	if( $('#Column_header_rows').val() != "" &&  $('#Column_Bill_no').val() != "" &&  $('#Column_Credit_Points').val() != "" &&  $('#Column_Remarks').val() != "" &&  $('#Column_Membership_ID').val() != "" )
	{
		show_loader();
	}
});
