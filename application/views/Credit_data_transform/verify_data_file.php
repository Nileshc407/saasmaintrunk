        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="element-wrapper">
                    <h6 class="element-header">STEP 2: Verify Transaction Data</h6>
                   
						 <?php
						 $attributes = array('id' => 'formValidate');
                         echo form_open('Credit_data_transform/verify_data_file', $attributes);
                                ...
                                <tbody>
									...
									?>
										<tr>
											...
											<td><?php echo round($row->Pos_Billamt); ?></td>
