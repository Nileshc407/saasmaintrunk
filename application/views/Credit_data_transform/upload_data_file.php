                ...
                <div class="element-wrapper">
                    ...
                    <div class="element-box">
                        ...
                        <?php
                          ...
                          echo form_open_multipart('Credit_data_transform/upload_data', $attributes);
                        ?>
                        <div class="form-group">
                            <label for=""> <span class="required_info">*</span>Merchant Name (Business/Merchant)</label>
                            <select class="form-control" name="Column_Seller_id" id="Column_Seller_id" data-error="Select Merchant" required="required">
...
/* CallOwnUrl function defined in dropzone.js */
  ...
  function CallOwnUrl(){
	...
	if($('#seller_id').val() !="" || $('#seller_id').val() !=0)
	{
		...
		window.location.href = '<?php echo base_url(); ?>index.php/Credit_data_transform/verify_data_file';
