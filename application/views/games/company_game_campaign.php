			...
			<div class="element-wrapper">
			  ...
			  <div class="element-box">
				...
				<?php $attributes = array('id' => 'formValidate');
					echo form_open_multipart('Gamec/company_game_campaign',$attributes); ?>
				...
				<div class="row">
					<div class="col-sm-6">	  		
					  ...
					  <div class="form-group" >
						...
						<input class="form-control" name="cmp_name"  id="cmp_name"  type="text" placeholder="Enter Campaign Name" onblur="game_name_validation(this.value);" required="required" data-error="Please enter campaign name">
						...
						<div class="form-group">
							...
							<select class="form-control " name="Game_id" id="Game_id" required="required" data-error="Please select game" onchange="get_game_levels(this.value)">

							 <option value=""> Select Game </option>
								<?php 
								foreach($games as $game_details)
								{
									if($game_details->Link_to_game_campaign == 1)
									{
								?>
					...
					<div class="col-sm-6">	  
						...
						<div class="form-group">
						   <label for=""> <span class="required_info">* </span>Competition Start Date</label>
							<input class="single-daterange form-control" placeholder="Campaign Start Date" type="text"  name="start_date" id="datepicker1"/>
						</div>
						
						<div class="form-group">
						   <label for=""> <span class="required_info">* </span>Competition End Date</label>
							<input class="single-daterange form-control" placeholder="Campaign End Date" type="text"  name="end_date" id="datepicker2"/>
						</div>
