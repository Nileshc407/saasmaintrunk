...
<p>MiracleCartes ( regd. Miracle Smart Card Pvt. Ltd.)</p>
...
<div class="container">
  <form name='payform' action="pay.php" method="POST">
	...
	<div class="row">
      ...
      <div class="col-75">
        <select id="country" name="currency" required>
          ...
          <option value="USD">Australia</option>
	...
	<div class="row">
      ...
      <div class="col-75">
        <input type="text" id="order_no" name="order_no" placeholder="Your order no.." required>
      </div>
    </div>
	<div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="amount" name="amount" placeholder="Your amount.." required>
      </div>
    </div>
    <div class="row">
