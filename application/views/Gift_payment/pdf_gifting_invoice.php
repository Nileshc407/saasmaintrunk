  ...
  <tr>
    <td>   
 			<table border="0" cellpadding="0" cellspacing="0" style="width: 660px; margin:0 auto;background: #fff;padding: 15px;border:1px solid #d8dade; border-radius:5px;">
 				...
 				<tr>
 					<td style="padding: 30px 0 15px;">
 						<table style="border:1px solid #000;" width="100%" cellpadding="0" cellspacing="0" border="0">
 							...
 							<tr>
 								<td style="padding-left:5px; border-bottom:1px solid #000;border-right:1px solid #000;"><?php echo $Application_name; ?> </td>
 								<td style="padding-right:5px;border-bottom:1px solid #000;"  align="right"><?php echo $Symbol_currency.' '.number_format($Payment_details->Bill_amount,2); ?></td>
 							</tr>
 							...
 							<tr>
 								...
 								<td style="padding-right:5px;border-bottom:1px solid #000;"  align="right"><?php echo $Symbol_currency.' '.number_format($Payment_details->Bill_amount,2); ?>
								</td>
 							</tr>
 				...
 				<tr>
 					<td style="font-size: 10px;padding: 30px 0 10px;">Subject to Pune, Maharashtra, India Jurisdiction</td>
 				</tr>
				<tr>
					<td style="font-size: 10px;padding: 10px 0 0px;">Declaration :</td>
				</tr>
				<tr>
					<td style="font-size: 10px;padding: 10px 0 0px;">1. Vouchers/ Points are exempted under GST Act, 2017. Hence no HSN/ SAC/ GST is applicable.</td>
				</tr>
				<tr>
					<td style="font-size: 10px;padding: 10px 0 30px;">2. TDS is not applicable on Vouchers/ Points / Products. Hence don’t deduct TDS on these.</td>
				</tr>
 				<tr>
