...
<html lang="en">
    ...
    <body>
        <header class="clearfix">
            <div id="logo">
                <img src="<?php echo base_url() . '' . $Company_details->Company_logo; ?>" width="100" height="100" align="center">
            </div>
            ...
            <div id="project" class="clearfix">
                ...
                <div><?php echo App_string_decrypt($Current_address); ?></div>
                <div><?php echo $City_name; ?>,<?php echo $State_name; ?>,<br /> <?php echo $Country_name; ?>-<?php echo $Zipcode; ?></div>
                <div><a href="mailto:<?php echo App_string_decrypt($User_email_id); ?>"><?php echo App_string_decrypt($User_email_id); ?></a></div>
                <div><?php echo App_string_decrypt($Phone_no); ?></div>
