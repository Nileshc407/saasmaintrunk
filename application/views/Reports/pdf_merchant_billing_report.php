...
<div class="panel panel-info" style="border-color: #bce8f1;">
	<div>
		...
		<h2 style="text-align:center">Merchant Billing & Settlement Report - <?php if($Report_type == 0) { echo " Details"; } else { echo " Summary";} ?></h2>
		...
		<?php
				...
				?>					
                    <tr>	
						...
						<td style="text-align:center"><?php echo $row->Joy_coins_issued; ?></td>
