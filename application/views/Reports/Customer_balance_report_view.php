	...
	<div class="content-box">
		<div class="row">
			...
			<?php $attributes = array('id' => 'formValidate');
				echo form_open_multipart('Reportc/Customer_balance_report',$attributes); ?>
				<div class="element-wrapper">
					<h6 class="element-header">MEMBER BALANCE REPORT</h6>  
		...
		<?php echo form_close(); ?>
				...
				<?php if($Trans_Records != NULL)
						{
					?>
							<a href="<?php echo base_url()?>index.php/Reportc/Customer_balance_report/?Company_id=<?php echo $Company_id; ?>&Source=<?php echo $Source; ?>&select_cust=<?php echo $select_cust; ?>&Tier_id=<?php echo $Tier_id; ?>&Single_cust_membership_id=<?php echo $Single_cust_membership_id; ?>&pdf_excel_flag=1">
							<button class="btn btn-success" type="button"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Excel</button>
							</a>
						
							<a href="<?php echo base_url()?>index.php/Reportc/Customer_balance_report/?Company_id=<?php echo $Company_id; ?>&Source=<?php echo $Source; ?>&select_cust=<?php echo $select_cust; ?>&Tier_id=<?php echo $Tier_id; ?>&Single_cust_membership_id=<?php echo $Single_cust_membership_id; ?>&pdf_excel_flag=2">
