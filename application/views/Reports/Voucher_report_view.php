	...
	<div class="content-box">
		<div class="row">
			...
			<?php $attributes = array('id' => 'formValidate');
				echo form_open_multipart('Reportc/Voucher_report',$attributes); ?>
				<div class="element-wrapper">
					<h6 class="element-header">Voucher Report</h6>  
				...
				<div class="element-wrapper">											
					...
					?>
					  ...
					  <div class="table-responsive">
						...
						?>
							<a href="<?php echo base_url()?>index.php/Reportc/Voucher_report/?pdf_excel_flag=1">
							<button class="btn btn-success" type="button"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Excel</button>
							</a>
						
							<a href="<?php echo base_url()?>index.php/Reportc/Voucher_report/?pdf_excel_flag=2">
