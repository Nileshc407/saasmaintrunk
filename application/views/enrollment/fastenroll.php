			...
			<?php 	} ?>
					...
					<?php $attributes = array('id' => 'formValidate');
					  ...
					  <div class="form-group">
						...
						<input class="form-control" type="email" name="userEmailId" id="userEmailId" placeholder="Enter email address" data-error="Please enter valid email address" required="required" onchange="validateEmail(this.value);">
