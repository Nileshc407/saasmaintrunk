	...
	<div class="content-box">
		<div class="row">
			...
			<?php
				...
				echo form_open_multipart('Enrollmentc/OutletEnrollment',$attributes); 
			?>
				<div class="element-wrapper">
					<h6 class="element-header">OUTLET ENROLLMENT 
					</h6>
				...
				<?php 	} ?>
							<div class="row">
								...
								<div class="col-sm-6">
								  ...
								  <div class="form-group" id="MercahndizeCategory_div">
								...
								<div class="row" >
									<div class="col-sm-6">
										...
										<div class="form-group">
											...
											<input type="text" name="Seller_Redemptionratio" id="Seller_Redemptionratio"  class="form-control" placeholder="Enter redemption ratio"  onkeypress="return isNumberKey2(event)" value="<?php echo $Redemptionratio;?>" data-error="Please enter redemption ratio"/>
											<div class="help-block form-text with-errors form-control-feedback"></div>
										</div>
