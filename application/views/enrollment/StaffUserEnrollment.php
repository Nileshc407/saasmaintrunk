	...
	<div class="content-box">
		<div class="row">
			...
			<?php
				...
				echo form_open_multipart('Enrollmentc/StaffUserEnrollment',$attributes); 
			?>
				<div class="element-wrapper">
					<h6 class="element-header">STAFF USER ENROLLMENT 
					</h6>
							...
							?>
								<tr>
									<td class="row-actions">
										...
										<a class="danger" href="javascript:void(0);" onclick="delete_me('<?php echo $Encrypt_Enrollement_id;?>','<?php echo $row->First_name.' '.$row->Last_name; ?>','','Enrollmentc/delete_staffenrollment/?Enrollement_id');" data-target="#deleteModal" data-toggle="modal" title="Delete"><i class="os-icon os-icon-ui-15"></i></a>
										<?php } ?>
									</td>
