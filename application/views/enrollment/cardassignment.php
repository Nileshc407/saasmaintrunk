...
// ?Enrollment_id='.$results->Enrollement_id.'&Refrence_Enrollment_id='.$results->Refrence'
$_SESSION["Edit_Enrollement_id"]=$results->Enrollement_id;
$_SESSION["Edit_Refrence_Enrollment_id"]=$results->Refrence;
?>
<div class="content-i">
			  ...
			  <h6 class="element-header">
			   ASSIGN MEMBERSHIP CARD
				...
				<?php 	} ?>
					...
					echo form_open_multipart('Enrollmentc/asign_membership_card/',$attributes); ?>
