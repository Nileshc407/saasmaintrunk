	...
	<div class="content-box">
		<div class="row">
			<div class="col-sm-12">
				...
				echo form_open_multipart('Enrollmentc/Update_StaffUserEnrollment/',$attributes); ?>
				<div class="element-wrapper">
					<h6 class="element-header">EDIT STAFF ENROLLMENT</h6>
								...
								<div class="col-sm-6" >
									<div class="form-group" id="sub_merchant">
										...
										<label class="radio-inline">
											...
											<input type="radio" name="Sub_seller_admin1" id="Sub_seller_admin12" onclick="hideshow_supervisor1(this.value);" value="0" <?php if($results->Sub_seller_admin==0){echo "checked";} ?> >No
										</label>
									</div>
								</div>
								<div class="col-sm-6">
...
$(document).ready(function()
{
	...
	$('#userEmailId').blur(function()
	{
		if( $("#userEmailId").val() != "" )
		{
			...
			$.ajax({
				  type: "POST",
				  data: {userEmailId: userEmailId, Company_id: Company_id, userId:7},
