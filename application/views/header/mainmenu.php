		...
		?>
			...
			<?php 
				...
				{					
								...
								<div class="sub-menu-w">
									...
									<div class="sub-menu-i">
										<ul class="sub-menu">									
											...
											<li> <a href="<?php echo base_url();?>index.php/Company_redemption_report/Redemption_Report">Partner Redemption Report</a> </li>									
					...
					else if($Logged_user_id == 2 && $data['Company_id'] == 1)
					{ ?>
						<li class="selected has-sub-menu">
						  <a href="<?php echo base_url();?>">
							<div class="icon-w">
						...
						<li class="has-sub-menu">
							  ...
							  <div class="sub-menu-w">
								...
								<div class="sub-menu-i">
								  <ul class="sub-menu">
									<li>
									  <a href="<?php echo base_url();?>index.php/Saas_invoice">Saas Billing Invoice</a>
									</li>
									<li>
									  <a href="<?php echo base_url();?>index.php/Reportc/Saas_invoice_report">Saas Billing Report</a>
									</li>
									<li>
										<a href="<?php echo base_url();?>index.php/Company_redemption_report/Redemption_Report">Partner Redemption Report</a> 
									</li>
								  </ul>
								</div>
							  </div>
