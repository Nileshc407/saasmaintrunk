		  ...
		  <div class="col-lg-12">
			<div class="element-wrapper">
			  <h6 class="element-header">
			   Edit Reference Email Template Master
			  </h6>
			  <div class="element-box">
				...
				echo form_open_multipart('Email_templateC/Edit_Reference_Email_template',$attributes); ?>	
				<div class="row">
				<div class="col-sm-6">					
					...
					<div class="form-group">
								...
								<input type="text" name="Email_template_name" id="Email_template_name" class="form-control" placeholder="Enter Template Name" value="<?php echo $Specific_Template_Record->Email_template_name; ?>"/>									
							</div>	
					...
					<font color="red" size="0.3px"><i>*click on box</i></font>
						...
						<div class="form-group">
								...
								<select class="form-control" name="Font_family" id="Font_family" onchange="preview_fontfamily(this.value);"  onchange="javascript:$('#Offer_description').css('font-family', $(this).val());">
					...
					<input type="hidden" name="Email_template_id" value="<?php echo $Specific_Template_Record->Email_template_id; ?>"/>
		...
		$('#Email_template_id').change(function()
	{
		...
		$.ajax({
			...
			success: function(data)
			{
				...
				$("#blah2").attr("src", data.Email_header_image);
				
				
				$("#blah").attr("src", data.Body_image);
