		  ...
		  <div class="col-lg-12">
			<div class="element-wrapper">
			  ...
			  <div class="element-box">
				...
				echo form_open_multipart('Email_templateC',$attributes); ?>	
				<div class="row">
				<div class="col-sm-6">					
					...
					<legend><span>Social Media Settings</span></legend>
						...
						<BR>
							<label class="form-check-label" style="margin-left:10px;">
								<input type="checkbox" name="Google_play_link" value="1" onclick='$("#blah4").attr("src", "<?php echo base_url()?>images/android_logo.png");$("#blah4").show();'>
								<img src="<?php echo base_url()?>images/android_logo.png" width="45px">
								
							</label>
							
							<label class="form-check-label" style="margin-left:10px;">
								<input type="checkbox" name="Ios_application_link" value="1"  onclick='$("#blah5").attr("src", "<?php echo base_url()?>images/apple_logo.png");$("#blah5").show();'>
					...
					<div class="form-group" id="multiple_social">
						...
						<BR>
							<label class="form-check-label" style="margin-left:10px;">
								<input type="checkbox" name="Facebook_share_flag" value="1"   onclick='$("#blah6").attr("src", "<?php echo base_url()?>images/facebook.gif");$("#blah6").show();'>
								<img src="<?php echo base_url()?>images/facebook.gif" width="50%">
								
							</label>
							
							<label class="form-check-label" style="margin-left:10px;">
								<input type="checkbox" name="Twitter_share_flag" value="1"   onclick='$("#blah7").attr("src", "<?php echo base_url()?>images/twitter.gif");$("#blah7").show();'>
								<img src="<?php echo base_url()?>images/twitter.gif"  width="50%">
							</label>
							
							<label class="form-check-label" style="margin-left:10px;"   onclick='$("#blah8").attr("src", "<?php echo base_url()?>images/gplus.gif");$("#blah8").show();'>
								<input type="checkbox" name="Google_share_flag" value="1">
					...
					<div class="form-group" id="multiple_social">
						<label for="">Unsubscribe Link</label>
							...
							<label class="form-check-label" style="margin-left:25px;">
								<input type="radio" name="Unsubscribe_flg" class="form-check-input"   id="Unsubscribe_flg" value="1">Yes	
								
							</label>
							
							<label class="form-check-label" style="margin-left:25px;">
								<input type="radio" name="Unsubscribe_flg"  class="form-check-input"  id="Unsubscribe_flg2"  checked value="0">No		
							</label>
