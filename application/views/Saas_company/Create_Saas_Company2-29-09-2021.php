										...
										<div class="form-row">
											...
											<div class="form-holder">
												<fieldset>
													...
													<input type="text" class="form-control" id="Company_primary_phone_no"  onkeyup="this.value=this.value.replace(/\D/g,'')" name="Company_primary_phone_no"  required placeholder="e.g. 123456789"  onchange="javascript:check_userdata(this.value,2);">
										...
										<div class="form-row">
											...
											<div class="form-holder">
														<fieldset>
															...
															<input type="text" class="form-control" id="Domain_name" name="Domain_name"  required placeholder="e.g. DeereWeb"  onchange="javascript:check_userdata(this.value,3);">
									...
									<div class="form-holder form-holder-2" >
										...
										<div class="form-row">
											<div class="form-holder" id="input8">
												...
												<select name="Country" id="Country"  style="width: 100%;" onchange='javascript:var id = $(this).children(":selected").attr("id");$("#timezone_entry").val(id);'>
