					...
					<!-- sandeep gift card 10-05-2020 -->
									...
									<div class="form-group">
									 ...
									 <div class="col-sm-8" style=" margin-top:7px;">
										...
										<div class="form-group">
									 <label for="">Enable Daily Points Consumption</label>
									 <div class="col-sm-8" style=" margin-top:7px;">
										  <div class="form-check" style="float:left;">
											<label class="form-check-label">
											<input type="radio" class="form-check-input" name="Daily_points_consumption_flag" value="1"  <?php if($record->Daily_points_consumption_flag == 1){echo "checked";} ?>>Yes</label>
										  </div>
										  
										  <div class="form-check" style="margin-left:50px;">
											<label class="form-check-label">
											<input type="radio" class="form-check-input" name="Daily_points_consumption_flag" value="0"  <?php if($record->Daily_points_consumption_flag == 0){echo "checked";} ?>>No</label>
										  </div> 
									 </div>
								    </div>
									<div class="form-group">
