...
<div class="content-i">
		  ...
		  <div class="col-sm-12">
			<div class="element-wrapper">
			  <h6 class="element-header">
				CREATE Channel Partner COMPNAY
			  </h6>
	...
	<!--
				  ...
				  <div class="form-group" id="bcname1">
					...
					<input class="form-control"  name="bcname" id="bcname"  type="text" placeholder="Enter Channel Company Name"  required="required" data-error="Please enter Channel company name">
