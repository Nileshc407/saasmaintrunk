...
<div class="content-i">
	<div class="content-box" style="min-height: 404px !IMPORTANT; margin-bottom: -100px;">
		<div class="row">
		  <div class="col-lg-12">
		  ...
		  <div class="col-sm-6">
				  <div class="form-group" id="offernm_feedback">
						...
						<!--MembershipID_validation(this.value);-->
						<input type="text" name="Membership_ID" id="Membership_ID" class="form-control" placeholder="Enter Membership ID / Phone No." required onblur="get_cust_info(this.value);"  data-error="Please Enter Valid Membership ID / Phone No." />
										...
										<div class="profile-tile-meta">
											<ul>
												...
												<li>
													...
													<input type="hidden" name="Card_id1" id="Card_id1">
												</li>
												<li>
...
<script type="text/javascript">
	...
	var Pin_no_applicable = 0;
	var Allow_merchant_pin = 0;
	var Merchant_pin = <?php echo $Merchant_pin; ?>;
	var Merchant_pin = 0000;
...
function MembershipID_validation(MembershipID)
		...
		else
		{
			...
			$.ajax({
				...
				success : function(data)
				{
					...
					{
						$("#Membership_ID").val("");
						$("#Membership_ID2").html("Membership ID not Exist");
	...
	function Get_unused_evouchers(MembershipID)
	{
		...
		$.ajax({
				type:"POST",
				data:{MembershipID:MembershipID,Company_id:Company_id,Partner_id:Partner_id,Pin_no_applicable:Pin_no_applicable,Allow_merchant_pin:Allow_merchant_pin},
				url: "<?php echo base_url()?>index.php/CatalogueC/Get_unused_Rvouchers_details",
				success : function(data)
				{
					//alert(data);
