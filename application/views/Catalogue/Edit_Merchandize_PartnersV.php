				  ...
				  <div class="form-group">
					...
					<div class="col-sm-6">	
						...
						<div class="form-group">
							...
							<input type="text" name="Partner_Redemptionratio" id="Partner_Redemptionratio"  class="form-control" placeholder="Enter redemption ratio"  onkeypress="return isNumberKey2(event)" value="<?php echo $Partner_Row->Partner_redemption_ratio;?>" data-error="Please enter redemption ratio" required   onchange="javascript:Set_ratio();" data-content="If you Modify the Redemption Ratio, it will Update the Points Value for all the Merchandizing Items of the Company !." data-toggle="popover" data-placement="top" title="Application Information">
							<div class="help-block form-text with-errors form-control-feedback"></div>
						</div>
						<div class="form-group">
								<label for=""><span class="required_info">* </span>VAT</label>
								<input type="text" class="form-control" name="Partner_vat" id="Partner_vat" data-error="Please enter vat" onkeypress="return isNumberKey2(event)" placeholder="Enter VAT" required="required" value="<?php echo $Partner_Row->Partner_vat;?>"  onchange="javascript:Set_ratio();" data-content="If you Modify the VAT, it will Update the Points Value for all the Merchandizing Items of the Company !." data-toggle="popover" data-placement="top" title="Application Information">
								<div class="help-block form-text with-errors form-control-feedback"></div>
						</div>
						<div class="form-group">
								...
								data-content="If you Modify the Markup Percentage, it will Update the Points Value for all the Merchandizing Items of the Company !." data-toggle="popover" data-placement="top" title="Application Information">
