		  ...
		  <div class="col-sm-12">
			<div class="element-wrapper">
			  <h6 class="element-header">
				EDIT MERCHANDISE PARTNER BRANCH
			  </h6>
			 ...
			 <?php
				...
				<?php  $attributes = array('id' => 'formValidate');
					echo form_open_multipart('CatalogueC/Edit_Merchandize_Partner_Branch',$attributes); ?>
				<div class="row">
					<div class="col-sm-6">	
						...
						<select class="form-control" name="Partner_id"  id="Partner_id" required="required">
							...
							<?php
								foreach($Partner_Records as $Partners)
								{
									...
									{
									?>
									<option value="<?php echo $Partners->Partner_id;?>" <?php if($Partners->Partner_id==$Branch_Row->Partner_id){echo "selected";}?>><?php echo $Partners->Partner_name;?></option>
								<?php }
								} 
							?>
						</select>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="Branch_code" id="Branch_code" data-error="Please enter branch code" placeholder="Enter Contact Branch Code" required="required"  value="<?php echo $Branch_Row->Branch_code;?>" readonly>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="Branch_name" id="Branch_name" data-error="Please enter branch name" placeholder="Enter Contact Branch Name" required="required" value="<?php echo $Branch_Row->Branch_name;?>">
							<div class="help-block form-text with-errors form-control-feedback"></div>
						</div>
						
					   <div class="form-group">
						<label for=""> <span class="required_info">*</span> Branch Address </label>								
						<textarea class="form-control"  name="Branch_address" id="Branch_address"  placeholder="Enter Branch Address"  required="required" data-error="Please enter address"><?php echo $Branch_Row->Address;?></textarea>
						<div class="help-block form-text with-errors form-control-feedback"></div>
					  </div> 
					...
					<div class="col-sm-6">	
						...
						<option value="101">India</option>
						 <?php 
								...
								{?>
									<option value="<?php echo $Country['id'];?>" <?php if($Branch_Row->Country_id == $Country['id']){echo "selected";} ?>><?php echo $Country['name'];?></option>
								<?php }
							?>
						</select>
						<div class="help-block form-text with-errors form-control-feedback"></div>
					  ...
					  <div class="form-group" id="Show_States">
						...
						<select class="form-control" name="state"  id="state" onchange="Get_cities(this.value);">
							<?php 
								...
								{?>
									<option value="<?php echo $rec->id;?>" <?php if($Branch_Row->State == $rec->id){echo "selected";} ?>><?php echo $rec->name;?></option>
								<?php }
							?>					
						</select>
					  ...
					  <div class="form-group" id="Show_Cities">
						...
						<?php 
								...
								{?>
									<option value="<?php echo $rec->id;?>" <?php if($Branch_Row->City == $rec->id){echo "selected";} ?>><?php echo $rec->name;?></option>
								<?php }
							?>	
						</select>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="zip" id="zip" onkeyup="this.value=this.value.replace(/\D/g,'')" required="required" placeholder="Enter Contact Branch Code"  value="<?php echo $Branch_Row->Zip;?>"  data-error="Please enter Zip/Postal code">
							<div class="help-block form-text with-errors form-control-feedback"></div>
						</div>
					...
					<input type="hidden" name="Branch_id" value="<?php echo $Branch_Row->Branch_id;?>">
							...
							?>
								<tr>
									<td class="row-actions">
										...
										</a> <?php  if($_SESSION['Edit_Privileges_Delete_flag']==1){ ?>
