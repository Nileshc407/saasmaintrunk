		  ...
		  <div class="col-sm-12">
			...
			<?php 		
				...
				<?php 	} ?>
					...
					echo form_open('Survey/update_surveynpsmaster',$attributes); ?>
					  <div class="form-group">
						<label for=""><span class="required_info">* </span>NPS Type Name </label>
						<input class="form-control" type="text" name="nps_type_name" id="nps_type_name" value="<?php echo $Survey_NPS->NPS_type_name ?>" placeholder="Enter nps type name" data-error="Please enter nps type name" required="required">
					  ...
					  <div class="form-group">
						...
						<textarea class="form-control" rows="3" name="description" id="description" placeholder="Enter description" data-error="Please enter description" required="required"><?php echo $Survey_NPS->NPS_type_description; ?></textarea>
					  ...
					  <div class="form-buttons-w">
						...
						<input type="hidden" name="Company_id" value="<?php echo $Survey_NPS->NPS_company_id ?>"  class="form-control"  />
						<input type="hidden" name="NPS_type_id" value="<?php echo App_string_encrypt($Survey_NPS->NPS_type_id); ?>"  class="form-control"  />
					  </div>
					<?php echo form_close(); ?>		  
				  </div>
			  </div>
				...
				<div class="element-box">
				  ...
				  <div class="table-responsive">
					<table id="dataTable1" width="100%" class="table table-striped table-lightfont">
						...
						<tbody>
					<?php
						if($Survey_NPS_details != NULL)
						{
							foreach($Survey_NPS_details as $row)
							{	
								$Encrypt_NPS_type_id = App_string_encrypt($row->NPS_type_id);
								$Encrypt_NPS_type_id = str_replace('+', 'X', $Encrypt_NPS_type_id);
								$_SESSION[$Encrypt_NPS_type_id]=$row->NPS_type_id;  
							?>
							<tr>
								<td class="row-actions">
									<a href="<?php echo base_url()?>index.php/Survey/edit_nps_survey/?NPS_type_id=<?php echo $Encrypt_NPS_type_id;?>" title="Edit"><i class="os-icon os-icon-ui-49"></i></a>
