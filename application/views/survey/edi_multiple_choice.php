			...
			<div class="element-wrapper">
			  <h6 class="element-header">
				...
				<div class="form-buttons-w">
					...
					<input type="hidden" name="Choice_id" value="<?php echo App_string_encrypt($Choice_id); ?>" />
				</div>
				<?php echo form_close(); ?>	
			  </div>
			</div>
				  ...
				  <div class="table-responsive">
					...
					<?php
						if($results != NULL)
						{
							...
							{	
								$Encrypt_Choice_id = App_string_encrypt($row->Choice_id);
								$Encrypt_Choice_id = str_replace('+', 'X', $Encrypt_Choice_id);
								$_SESSION[$Encrypt_Choice_id]=$row->Choice_id;
								?>
							<tr>
								<td class="row-actions">
									<a href="<?php echo base_url()?>index.php/Survey/edit_multiple_choice/?Choice_id=<?php echo $Encrypt_Choice_id;?>" title="Edit"><i class="os-icon os-icon-ui-49"></i></a>
