				  ...
				  <tr>
					<td style="padding-right: 30px;">
					  <div style="font-size: 11px; letter-spacing: 1px;  color: #020202; margin-bottom: 5px;">
						Outlet:<b> <?php echo $Company_name; ?></b>
					  </div>
					  <div style="font-size: 11px; letter-spacing: 1px;  color: #020202; margin-bottom: 5px;">
			...
			<div class="table-responsive">
				<table style="margin-top: 40px; width: 100%;" class="table table-striped">
				  ...
				  <?php if($Transaction_type == 12){ ?>
					...
					<tr>			   
						<td style="letter-spacing: 1px; color: #020202; font-size: 13px; ">			
						 Redeemed <?php echo $Company_details->Currency_name." (".round($Redeem_points).")"; ?>)
						
						</td>
						<td style="letter-spacing: 1px; color: #020202; font-size: 13px;  text-align: right;">
						 <?php echo number_format((($Redeem_points/$redemptionratio)),2).' ('.$Symbol_currency.')';?>
						</td>				
					</tr>
				  ...
				  <?php } else { ?>
						...
						<td style="letter-spacing: 1px; color: #020202; font-size: 13px;  text-align: right;">
							<?php 
								// echo $Topup_amount; 
								if($Transaction_type == 1){ echo $Topup_amount; }
								if($Transaction_type == 2){ echo $Purchase_amount.'('.$Symbol_currency.')'; }
								if($Transaction_type == 3){ echo $Redeem_points;}
								if($Transaction_type == 4){ echo $giftcard_purchase.'('.$Symbol_currency.')'; }
								if($Transaction_type == 10){ echo $Total_redeem_points; }
							?>
						</td>
				 <?php } ?>
				...
				<?php if($Transaction_type == 2 || $Transaction_type == 4){  ?>
				  <tr>
					...
					<td style="letter-spacing: 1px; color: #020202; font-size: 13px; ">			
						<?php
							if($Transaction_type == 2){echo "Redeemed ".$Company_details->Currency_name." "." (".round($Redeem_points).")"; }
							if($Transaction_type == 4){echo " Redeem Amount";}
						?>
					</td>
					<td style="letter-spacing: 1px; color: #020202; font-size: 13px;  text-align: right;">
						<?php 
							if($Transaction_type == 2){echo number_format((($Redeem_points/$redemptionratio)),2).' ('.$Symbol_currency.')'; }
							if($Transaction_type == 4){echo $Redeem_points;}
						?>
					</td>
				  ...
				  <?php } 
				   ...
				   if($Transaction_type == 2 && $Voucher_discount > 0){ ?>
				  <tr>
				   
					<td style="letter-spacing: 1px; color: #020202; font-size: 13px; ">			
						Voucher Discount (<?php	echo $Voucher_no;?>)
					</td>
					<td style="letter-spacing: 1px; color: #020202; font-size: 13px;  text-align: right;">
						<?php								
							echo $Voucher_discount.' ('.$Symbol_currency.')';
						?>
					</td>
				  ...
				  <?php  if(($Transaction_type == 2 && $remark3 != "" ) ){ 
						$PMCODE = explode('-',$remark3);
					?>
					<tr>			   
						<td style="letter-spacing: 1px; color: #020202; font-size: 13px;">			
							Promo Code (<?php echo $PMCODE[0].'-'.$PMCODE[1].' '.$Company_details->Currency_name; ?>)
						</td>
						<td style="letter-spacing: 1px; color: #020202; font-size: 13px; text-align: right;">
							<?php
								
								echo number_format((($PMCODE[1]/$redemptionratio)),2).' ('.$Symbol_currency.')'; 
							?>
						</td>				
					</tr>
					<?php } ?>
				  ...
				  <?php  if($Transaction_type == 2 && $GiftCardNo != "" && $GiftCardNo != 0){ ?>
					<tr>			   
						<td style="letter-spacing: 1px; color: #020202; font-size: 13px; ">			
							Gift Card (<?php echo $GiftCardNo;?>)
						</td>
						<td style="letter-spacing: 1px; color: #020202; font-size: 13px; text-align: right;">
							<?php
								echo $Giftcard_amt.' ('.$Symbol_currency.')';
							?>
						</td>				
					</tr>
					<?php } 
				  ...
				  <tr>
					...
					<td style="letter-spacing: 1px; color: #020202; font-size: 13px;  text-align: right;">
						<?php 
							if($Transaction_type == 2 || $Transaction_type == 4){echo number_format((($balance_to_pay)),2).' ('.$Symbol_currency.')';}
						?>
					</td>
				...
				<?php if($Transaction_type == 2){ ?>
					...
					<tr>			   
						<td style="letter-spacing: 1px; color: #020202; font-size: 13px; ">			
							Total Gained <?php echo $Company_details->Currency_name ?>  
						</td>
						<td style="letter-spacing: 1px; color: #020202; font-size: 13px;  text-align: right;">
							<?php 
								echo round($Loyalty_pts);
							?>
						</td>				
					</tr>
