            ...
            <div class="col-sm-7">
                <div class="element-wrapper">
                    ...
                    <div class="element-box">
						...
						<?php 
						//calculate_discount();
						if($Company_details->Discount_flag==1){ ?>
						<div class="form-group" id="Discount_div" >
                            <label for=""> <span class="required_info">*</span>Discount Amount</label>
                            <input class="form-control" required="required" placeholder="Discount Amount" type="text" id="Discount_amt" name="Discount_amt" class="form-control" value="0.00" readonly>
                            <div class="help-block form-text with-errors form-control-feedback" id="DiscountAMT"></div>
                        </div>
						<!--<div class="tooltip">Discount Details
						  <span class="tooltiptext">Basic Tooltip</span>
						</div>-->
						<div class="wrapper" id="Discount_details_div" style="display:none">  
						  <a href="#" class="show">
							 Discount Details?<br>
							 <span class="tooltip" id="Discount_details"> </span>
						  </a>
						</div> 
						<?php } ?>
						
						 <fieldset class="form-group">
					<legend><span>Redeem Points ?</span></legend>	
                            <div class="form-group">
                                
                                <div class="col-sm-3">
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input class="form-check-input" name="RedeemPoints"  id="inlineRadio29"  type="radio" value="1"  onclick='$("#Percentage").attr("required", "required"); $("#RedeemDiv1").show();$("#RedeemDiv2").show();'>Yes
                                        </label>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <label class="form-check-label">
                                            <input class="form-check-input" name="RedeemPoints" type="radio"  id="inlineRadio30" value="0"  onclick='$("#Percentage").removeAttr("required"); $("#RedeemDiv1").hide();$("#RedeemDiv2").hide();' checked>No
                                        </label>
								...
								<div class="form-group" id="RedeemDiv1" style="display:none;">
									<label for="exampleInputEmail1">Enter Percentage</label>
									<input type="text" name="Percentage" id="Percentage"  value=""  placeholder="Enter Percentage" class="form-control" onkeypress="return isNumberKey(event)" onchange="Calc_Redeem_limit(this.value);"/>								
									<div class="help-block form-text with-errors form-control-feedback" id="RedeemDiv4">Please enter Percentage upto 100% only! </div>
								</div>
							
								<div class="form-group" id="RedeemDiv2" style="display:none;">
									<label for="exampleInputEmail1">Redeem Points Limit</label>
									<input type="text" name="RedeemPointsLimit" id="RedeemPointsLimit"   placeholder="Enter Redeem Points Limit" class="form-control" disabled />								
								<br>
								  <div class="form-group">
										<label for=""> Redeem <?php echo $Company_details->Currency_name; ?></label>
										<input class="form-control" data-error="Enter bill no" required="required" placeholder="Enter redeem points" type="text" id="reedem" name="points_redeemed" onchange="javascript:cal_redeem_amt('1');" value="0" onkeyup="this.value = this.value.replace(/\D/g, '')" class="form-control" placeholder="Enter redeem points">
                        ...
                        <!--************ Promo Code Start******************-->	
						  ...
						  <fieldset class="form-group">
					<legend><span>Promo Code ?</span></legend>	
                            <div class="form-group">
                                
                                <div class="col-sm-3">
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input checked="" class="form-check-input" name="Promo_redeem_by"  id="inlineRadio2"  type="radio" value="1"  onclick='show_redeem_div(this.value, "1");$("#Promo_code").attr("required", "required"); $("#PromoDiv").show();$("#PromoDiv1").show();'>Yes
                                        </label>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <label class="form-check-label">
                                            <input class="form-check-input" name="Promo_redeem_by" type="radio"  id="inlineRadio3" value="0"  onclick='show_redeem_div(this.value, "1");$("#Promo_code").removeAttr("required"); $("#PromoDiv").hide();$("#PromoDiv1").hide();' checked>No
                                        </label>
										<div class="help-block form-text with-errors form-control-feedback" id="PromoCodeDiv"></div>
                                    </div>
                        ...
                        <!--************ Gift Card Start******************-->
							<fieldset class="form-group">
					<legend><span>Gift Card ?</span></legend>	
                        <div class="form-group">
                            
                            <div class="col-sm-9">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="Gift_redeem_by" id="inlineRadio4" value="1" onclick='show_redeem_div(this.value, "2");$("#GiftDiv1").show(); $("#GiftDiv").show();$("#GiftCardUserInfo").show();' >Yes
                                    </label>  
			 
				 
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio"  name="Gift_redeem_by" id="inlineRadio5" value="0" onclick='show_redeem_div(this.value, "2");$("#GiftDiv1").hide(); $("#GiftDiv").hide();$("#GiftCardUserInfo").hide();' checked >No
                                    </label>
                                </div>
                        ...
                        <!--************ Redeem Voucher******************-->
						<fieldset class="form-group">
					<legend><span>Redeem Voucher ?</span></legend>						
                        <div class="form-group">
                            
                            <div class="col-sm-8">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="Redeem_voucher_flag" id="Redeemid1" value="1" onclick="show_redeem_div(this.value,'3');$('#Voucherdiv').show();$('#Voucherdiv2').show();cal_redeem_amt(4);" >Yes
                                    </label>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio"  name="Redeem_voucher_flag" id="Redeemid2" value="0" onclick="show_redeem_div(this.value,'3');$('#Voucherdiv').hide();$('#Voucherdiv2').hide();$('#VoucherUserInfo').hide();$('#VoucherNumber').val('');$('#VoucherRedeemAmount').val(0);cal_redeem_amt(4);" checked >No
                                    </label>
                                </div>
                        ...
                        <div class="form-group" id="Voucherdiv" style="display:none;">
                            <label for="exampleInputEmail1">Voucher Number</label>
                            <input type="text" name="VoucherNumber" id="VoucherNumber" value="" data-error="Enter Voucher Number" placeholder="Enter Voucher Number"   
                                   class="form-control" onchange="Get_voucher_info();" />								
                            <div class="help-block form-text with-errors form-control-feedback" id="VoucherNumbermsg"></div>	

							
                        </div>
                        <div id="Voucherdiv2" style="display:none;">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Voucher Discount</label>
                                <input type="text" name="VoucherRedeemAmount"  id="VoucherRedeemAmount"     class="form-control" value="0" readonly />	
                            </div>
                        </div>
						</fieldset>
                        <!--************ Voucher End ******************-->		
...
<?php if ($Photograph == "") { ?>
  ...
  <?php } ?>										
				...
				<div class="col-md-12" id="VoucherUserInfo"  style="display:none;">
                    <div class="element-wrapper">
                        <h6 class="element-header">Voucher Details</h6>
                        <div class="element-box">	
                            <div class="profile-tile">											
                                <div class="profile-tile-meta">
                                    <ul>
                                        <li>
                                            User Name:<strong id="vouchercard_name"></strong>
                                        </li>												
                                        <li>
                                            Email ID:<strong id="vouchercard_email"></strong>
                                        </li>										
                                        <li>
                                            Phone No.:<strong id="vouchercard_phno"></strong>
                                        </li>													
                                        <li>
                                            Voucher Type:<strong id="vouchertype"></strong>
                                        </li>												
                                        <li>
                                            Voucher Discount:<strong id="vouchercard_balance"></strong>
                                        </li>
                                    </ul>								  
                                </div>								
                            </div>			
...
//***** bill no validation **********/
  $('#purchase_amt').blur(function ()
  {
	  ...
	  Calc_Redeem_limit(Percentage);
  });


function Calc_Redeem_limit(Percentage)
{
	 if(Percentage > 100){$("#Percentage").val('');}
	 var purchase_amt = $("#purchase_amt").val();
	 if(purchase_amt != '')
	 {
		 var RedeemPointsLimit = ((purchase_amt*Percentage)/100);
		$("#RedeemPointsLimit").val(RedeemPointsLimit);
		$("#reedem").val(RedeemPointsLimit);
		 var bal = '<?php echo $Current_balance; ?>';
		 if(bal < RedeemPointsLimit)
		 {
			 $("#reedem").val(bal);
...
//***** bill no validation **********/
 ...
 /*  function show_Redeem_voucher_div(div_flag)
  {
	  if(div_flag==1){$('#Voucherdiv').show();}
	  if(div_flag==0){$('#Voucherdiv').hide();}
	  
  } */
  
  function show_redeem_div(redeem_flag, div_flag)
  {
		 // alert("---redeem_flag------"+redeem_flag+"---div_flag---"+div_flag);
	var balance_to_pay = document.getElementById("balance_to_pay").value;
	
	// alert(balance_to_pay);
	...
	else 
	{
		...
		if (div_flag == 3)//Redeem Voucher
		{
			
			if (redeem_flag == 1 ){$("#Voucherdiv").show();$("#Voucherdiv2").show();}
			if (redeem_flag == 0 ){$("#Voucherdiv").hide();$("#Voucherdiv2").hide();}
...
// alert(redeemBY);
      ...
      if (redeemBY == 1 && parseInt(reedem) <= parseInt(bal))
      {
		  ...
		  // alert('reedem '+reedem);
		  // alert('EquiRedeem '+EquiRedeem);
		  // alert('parseInt '+parseInt(EquiRedeem));
      ...
      if (redeemBY == 3)
      {
		...
		if (redeemBY == 4)//Redeem Voucher
		{
			var VoucherRedeemAmount = $('#VoucherRedeemAmount').val();
			EquivalentRedeem4 = VoucherRedeemAmount;
        }
	
      //alert("EquivalentRedeem1--"+EquivalentRedeem1+"---EquivalentRedeem2---"+EquivalentRedeem2+"---EquivalentRedeem3---"+EquivalentRedeem3);
      TotalEquivalentRedeem = parseInt(EquivalentRedeem1) + parseInt(EquivalentRedeem2) + parseInt(EquivalentRedeem3) + parseInt(EquivalentRedeem4);
      ...
      if (parseInt(TotalEquivalentRedeem) > parseInt(purchase_amt))
      {
		  ...
		  if($("#reedem").val() > 0)
		  {
			  $('#RedeemPoints').html('Sorry, You can not Redeem ' + reedem + ' due to Equi. Redeem Amount is more than Purchase Amount');
			$("#reedem").val(0);
			cal_redeem_amt('1');
			 return false;
		  }
		  ...
		  $("#VoucherNumber").val('');
		  $('#VoucherNumbermsg').html(" Sorry, You can not Redeem voucher due to Voucher discount is more than Purchase Amount");
          //$("#gift_reedem").addClass("form-control has-error");
	  ...
	  // var Final_discount_amt = $("#Discount_amt").val();
	  var Final_discount_amt = 0;
	  
      balance_to_pay.value = Math.round(purchase_amt - Final_discount_amt - redeem_amt1.value);
// alert('Xbalance_to_pay '+balance_to_pay.value);
	  ...
	  // alert('balance_to_pay '+balance_to_pay.value);
	  // alert('TotalEquivalentRedeem '+TotalEquivalentRedeem);
  }
  function allow()
  {
      bal = '<?php echo $Current_balance; ?>';
      var val3 = parseInt(document.getElementById("reedem").value);
      var RedeemPointsLimit = parseInt(document.getElementById("RedeemPointsLimit").value);
	  ...
	  else if (val3 > RedeemPointsLimit)
      {
          document.getElementById("redeem_amt").value = "0";
          document.getElementById("reedem").value = "0";
          cal_redeem_amt(1);
          ...
          //alert('Insufficient Current Points Balance !');
           ...
           $("#RedeemPoints").html("Redeem Points Limit exceeds !!!");
          $("#reedem").addClass("form-control has-error");
 ...
 function Get_voucher_info()
  {
      ...
      if ($('#VoucherNumber').val() == "") {
          $('#VoucherNumber').html(" Enter Voucher number ");
          $("#VoucherNumber").addClass("form-control has-error");
      } else if (VoucherNumber != "" && Company_id != "")
      {
          $.ajax({
              type: "POST",
              data: {VoucherNumber: VoucherNumber, MemberCardID: MemberCardID, Company_id: Company_id},
              url: "<?php echo base_url() ?>index.php/Transactionc/Get_voucher_info",
              success: function (data)
              {
				  // alert(data);
				  $('#VoucherUserInfo').hide();
                  if (data == 0)
                  {
                      $('#VoucherNumber').val("");
					   $('#VoucherRedeemAmount').val(0);
                      cal_redeem_amt(4);
						$('#VoucherNumbermsg').html(" Enter valid Voucher number ");
                      $("#VoucherNumber").addClass("form-control has-error");
                  } else
                  {
                      ...
                      if ((json[0].Card_balance) != 0 && MemberCardID == json[0].MembershipID)
                      {
						$('#VoucherUserInfo').show();
                         $('#vouchercard_name').html(json[0].User_name);
                          $('#vouchercard_email').html(json[0].Email);
                          $('#vouchercard_phno').html(json[0].Phone_no);
                          $('#vouchercard_balance').html(json[0].Card_balance);
						  
						  if(json[0].Discount_percentage > 0)
						  {
							   $('#vouchertype').html('Discount Voucher');
								var purchase_amt = $('#purchase_amt').val();
							   var VoucherRedeemAmount = ((purchase_amt * json[0].Discount_percentage)/100);
							   
							   $('#VoucherRedeemAmount').val(VoucherRedeemAmount);
							  $('#vouchercard_balance').html(json[0].Card_balance+' %');
								
						  }
						  else
						  {
							  $('#vouchertype').html('Revenue Voucher');
							   var purchase_amt = $('#purchase_amt').val();
							   var VoucherRedeemAmount = json[0].Card_balance;
                          ...
                          $('#VoucherNumbermsg').html("");
                          $("#VoucherNumber").removeClass("has-error");
						  cal_redeem_amt(4);

                      }  else
                      {
						  // alert('Card_value '+json[0].Card_value);
						  // alert('Discount_percentage '+json[0].Discount_percentage);
						  // alert('Card_balance '+json[0].Card_balance);
						  // alert('Update_user_id '+json[0].Update_user_id);
						  $("#VoucherNumber").val(VoucherNumber);
                          $('#VoucherNumbermsg').html("");
                          $("#VoucherNumber").removeClass("has-error");
						  
						  if(((json[0].Card_value!=0 || json[0].Discount_percentage!=0) && json[0].Card_balance==0 ) || json[0].Update_user_id!=0 )
						  {
							  $('#VoucherNumber').val("");
								$('#VoucherRedeemAmount').val(0);
								$('#VoucherNumbermsg').html(" Enter valid Voucher number ");
  ...
  {
    var Company_id = '<?php echo $Company_id; ?>';
    var Outlet_id = '<?php echo $Logged_user_enrollid; ?>';
    var Tier_id = '<?php echo $Member_Tier_id; ?>';
	var purchase_amt = $('#purchase_amt').val();
	
        $.ajax({
            type: "POST",
            data: {Company_id: Company_id, Outlet_id: Outlet_id, Tier_id: Tier_id,grandTotal: purchase_amt},
            url: "<?php echo base_url() ?>index.php/Transactionc/calculate_discount",
            success: function (data)
            {
				var response2 = JSON.parse(data);
				var Error_flag = response2.Error_flag;
				var Discount_Amount = response2.Discount_Amount;
				var Discount_details = response2.Discount_details;
                ...
                if (Discount_Amount > 0)
                {
					...
					$("#Discount_details").empty();
					
					var html="";
					
					$.each(Discount_details, function( key, value ) 
					{
						// html +='Discount Code : '+value.Discount_code+', Amount : '+value.Discount_amt+', ';
						html += value.disacount_offer_details+' , ';
					});
					
					$("#Discount_details").append(html);
					
					cal_redeem_amt('1');
                } 
				else
				{
					$('#Discount_details_div').hide();
