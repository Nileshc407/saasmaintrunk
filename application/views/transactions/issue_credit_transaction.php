        ...
        <div class="row">
            <div class="col-sm-7">
                <div class="element-wrapper">
                    <h6 class="element-header"><?php if($Daily_points_consumption_flag==1 || $Enable_company_meal_flag==1){echo 'Meal Topup';}else{echo "WALLET Top Up";} ?></h6>
                    <div class="element-box">
                       
                        <?php
                          $attributes = array('id' => 'formValidate');
                          echo form_open('Transactionc/issue_credit_transaction', $attributes);
                        ?>
                        ...
                        <div class="form-group">
                            <label for=""> <span class="required_info">*</span><?php if($Daily_points_consumption_flag==1 || $Enable_company_meal_flag==1){echo 'Meal Topup';}else{echo "Top Up Amount";} ?></label>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" data-error="Enter Bonus Points Issued" required="required" placeholder="<?php if($Daily_points_consumption_flag==1 || $Enable_company_meal_flag==1){echo 'Enter Meal Topup';}else{echo "Enter Amount";} ?>" type="text" id="topup_amt" name="topup_amt"  onkeyup="this.value=this.value.replace(/\D/g,'')" class="form-control" >
                        ...
                        <div class="profile-tile">
                            ...
                            <div class="profile-tile-meta">
                                <ul>
                                    ...
                                    <br>
                                    <li>
                                        <?php //echo $Company_details->Currency_name; ?>Wallet Balance:<strong><?php echo $Wallet_balance; ?></strong>
                                    </li>
                                  <!-- <li>
                                   ...
                                   <strong class="p-3">No. of Times :</strong>
                                    <hr>-->
                                   <!-- <li>
                                        <?php //if($Daily_points_consumption_flag==1 || $Enable_company_meal_flag==1){ echo 'Meal Topup Points'; } else { echo "Issue Bonus $Currency_name"; } ?>:<strong><?php //echo $Topup_count; ?></strong>
                                    </li>-->
                                   <!-- <li>
  ...
  $('#manual_bill_no').blur(function ()
  {
      ...
      } else
      {
          $.ajax({
              ...
              url: "<?php echo base_url() ?>index.php/Transactionc/check_waller_credit_bill_no",
              success: function (data)
              {
                  if (data == 1)
                  {
