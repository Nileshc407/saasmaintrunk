                ...
                <div class="element-wrapper">
                    ...
                    <div class="element-box">
                        ...
                        <?php
                          ...
                          echo form_open('Transactionc/issue_wallet_credit', $attributes);
                        ?>
						<div class="col-sm-8">
                ...
                <div class="element-wrapper">                
                    <div class="element-box">
                        <h5 class="form-header">
                            <?php if($Daily_points_consumption_flag==1 || $Enable_company_meal_flag==1){echo 'Meal Topup';}else{echo "Wallet Top-Up";} ?>
                        </h5>                  
                            ...
                            <table id="dataTable1" width="100%" class="table table-striped table-lightfont">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Name</th>
                                        <th>Membership ID</th>
                                       <th><?php if($Daily_points_consumption_flag==1 || $Enable_company_meal_flag==1){echo 'Meal Topup';}else{echo "Top-Up Amount";} ?></th>
                                ...
                                <tbody>
                                      <?php foreach ($results as $row) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo number_format($row->Wallet_amount,2); ?></td>
                                        </tr>
                                      <?php } ?>
                                </tbody>
                            </table>
