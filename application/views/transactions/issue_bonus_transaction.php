            ...
            <div class="col-sm-7">
                <div class="element-wrapper">
                    ...
                    <div class="element-box">
                        ...
                        <div class="form-group">
                            <label for=""> <span class="required_info">*</span><?php if($Daily_points_consumption_flag==1 || $Enable_company_meal_flag==1){echo 'Meal Topup Points';}else{echo "Issue Bonus $Currency_name";} ?>  For</label>
                        ...
                        <?php } ?>
                        <div class="form-group">
                            <label for=""> <span class="required_info">*</span><?php if($Daily_points_consumption_flag==1 || $Enable_company_meal_flag==1){echo 'Meal Topup Points';}else{echo "ISSUE Bonus $Currency_name";} ?></label>
                            
                            <input class="form-control" data-error="Enter Bonus Points Issued" required="required" placeholder="<?php if($Daily_points_consumption_flag==1 || $Enable_company_meal_flag==1){echo 'Enter Meal Topup Points';}else{echo "Enter Bonus $Currency_name";} ?>" type="text" id="topup_amt" name="topup_amt"  onkeyup="this.value=this.value.replace(/\D/g,'')" class="form-control" >
