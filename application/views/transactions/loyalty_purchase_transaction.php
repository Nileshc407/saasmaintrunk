                ...
                <div class="element-wrapper">
                    ...
                    <div class="element-box">
						...
						<div class="form-group" id="Discount_div"  style="display:none">
                            ...
                            <input class="form-control" required="required" placeholder="Discount Amount" type="hidden" id="Discount_amt" name="Discount_amt" class="form-control" value="0.00" readonly>
