                ...
                <div class="element-wrapper">
                    ...
                    <div class="element-box">
                        ...
                        <?php
                          ...
                          echo form_open('Transactionc/redeem', $attributes);
                        ?>
						<div class="col-sm-8">
                ...
                <div class="element-wrapper">                
                    <div class="element-box">
                        <h5 class="form-header">
                            <?php if($Daily_points_consumption_flag==1 || $Enable_company_meal_flag==1){echo 'Adjustment';}else{echo "Debit";} ?> Transaction
                        </h5>                  
                            ...
                            <table id="dataTable1" width="100%" class="table table-striped table-lightfont">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Name</th>
                                        <th>Membership ID</th>
                                       <th>Adjust/Debit <?php echo $Company_details->Currency_name; ?></th>
                                       <th>Remark</th>
                                ...
                                <tbody>
                                      <?php
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo round($Total_Redeem_Points); ?></td>
