			...
			<table class="table table-bordered table-hover">
				...
				?>
					<tr>
						...
						<td class="text-center"><?php echo App_string_decrypt($shipping->Cust_address); ?></td>							
						...
						<td class="text-center"><?php echo App_string_decrypt($shipping->Cust_phnno); ?></td>							
						<td class="text-center"><?php echo App_string_decrypt($shipping->Cust_email); ?></td>							
