			...
			<?php $attributes = array('id' => 'formValidate');
				...
				<?php 	} ?>
					...
					<div class="form-group">
						...
						<textarea class="form-control" rows="3" id="Merchandise_item_description" name="Merchandise_item_description"  placeholder="Enter item Description"></textarea>
					</div>
							...
							<div class="row">
								...
								<div class="col-xs-6 col-md-6">
									<div class="thumbnail">
										...
										<img src="<?php echo base_url(); ?>images/no_image.jpeg" id="no_image3" class="img-responsive" style="width: 38%;">
								...
								<div class="col-xs-6 col-md-6">
									<div class="thumbnail">
										...
										<img src="<?php echo base_url(); ?>images/no_image.jpeg" id="no_image4" class="img-responsive" style="width: 38%;">
					...
					<div class="form-group">
							...
							<div class="form-group has-feedback" >
										...
										<label class="radio-inline">
											<input type="radio" name="show_item"  value="1">&nbsp;Yes

										</label>
										&nbsp;&nbsp;		
										<label class="radio-inline">
											<input type="radio" name="show_item"  value="0"  checked  >&nbsp;No
...
{
	if($('#Company_merchandize_item_code').val() != "" && $('#Merchandize_item_name').val() != "" && $('#Main_group_id').val() != "" && $('#Menu_group_id').val() != "" && $('#Sub_group_id').val() != "" )
	{
	...
	$('#seller_id').change(function()
	{
		...
		if(seller_id==438 || seller_id==439 )
		{
