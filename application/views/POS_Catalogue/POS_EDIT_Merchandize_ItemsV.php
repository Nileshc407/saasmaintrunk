			...
			<?php $attributes = array('id' => 'formValidate');
				...
				<?php 	} ?>
					...
					<div class="form-group">
						...
						<textarea class="form-control" rows="3" id="Merchandise_item_description" name="Merchandise_item_description"  placeholder="Enter item Description"><?php echo $Merchandize_Item_Row->Merchandise_item_description; ?></textarea>
					</div>
					...
					<div class="form-group">
					  ...
					  <div class="form-group">
						...
						<select class="form-control" multiple name="Outlet_id[]" ID="Outlet_id" required>
							<?php
								if($Get_Brand_outlets != NULL){
									foreach($Get_Brand_outlets as $Rec)
									{
					...
					<div class="form-group">
								...
								<div class="col-xs-6 col-md-6">
									<div class="thumbnail">
										...
										<?php if($Merchandize_Item_Row->Item_image1 != ""){ ?>
											<img src="<?php echo $Merchandize_Item_Row->Item_image1; ?>" id="no_image1" class="img-responsive" style="width: 40%;">
										<?php }else{ ?>
								...
								<div class="col-xs-6 col-md-6">
									<div class="thumbnail">
										...
										<?php if($Merchandize_Item_Row->Item_image2 != ""){ ?>
											<img src="<?php echo $Merchandize_Item_Row->Item_image2; ?>" id="no_image2" class="img-responsive" style="width: 40%;">
										<?php }else{ ?>
								...
								<div class="col-xs-6 col-md-6">
									<div class="thumbnail">
										...
										<?php if($Merchandize_Item_Row->Item_image3 != ""){ ?>
											<img src="<?php echo $Merchandize_Item_Row->Item_image3; ?>" id="no_image3" class="img-responsive" style="width: 40%;">
										<?php }else{ ?>
								...
								<div class="col-xs-6 col-md-6">
									<div class="thumbnail">
										...
										<?php if($Merchandize_Item_Row->Item_image4 != ""){ ?>
											<img src="<?php echo $Merchandize_Item_Row->Item_image4; ?>" id="no_image4" class="img-responsive" style="width: 40%;">
										<?php }else{ ?>
						...
						<div class="form-group">
							<label for=""><span class="required_info">*</span> Show Item</label>
							<div class="form-group has-feedback" >
										
										<label class="radio-inline">
											<input type="radio" name="show_item"  value="1" <?php if($Merchandize_Item_Row->show_item==1){echo 'checked';} ?>  >&nbsp;Yes

										</label>
										&nbsp;&nbsp;		
										<label class="radio-inline">
											<input type="radio" name="show_item"  value="0"  <?php if($Merchandize_Item_Row->show_item==0){echo 'checked';} ?>  >&nbsp;No
							...
							<div>						
								<fieldset class="form-group" id="Item_type_block">
						...
						<div class='row' id="Item_type_block2">
							<div class="col-md-4">
						...
						<div class="row"   id="Item_type_block3">
							<div class="col-md-4">
							</div>
													...
													<?php
														/* foreach($Merchandize_Category_Records as $Merchandize_Category) {
															...
															foreach($Merchandize_Category_Records as $POS_menu_group) {
																	...
																	{
																		$childs=$this->Catelogue_model->Get_Merchandize_Parent_Category_details($POS_menu_group['Merchandize_category_id']);
																		if($Selected_Merchandize_category_id == $POS_menu_group['Merchandize_category_id']){
																		echo'<option selected value="'.$POS_menu_group['Merchandize_category_id'].'" style="font-weight:bold;">'.$POS_menu_group['Merchandize_category_name'].'</option>';
																		}
																		else
																		{
							...
							<div  id="Side_item_block"  <?php if($Merchandize_Item_Row->Merchandize_item_type!=118){echo 'style="display:none;"';} ?> >
								...
								<div class="row">
									<div class="col-md-6">
										...
										<?php echo $Main_or_side_item_code[1]; ?>		
												<div class="form-group">
													...
													foreach($Merchandize_Category_Records as $POS_menu_group) {
															...
															if(!$POS_menu_group['Parent_category_id']) 
															{
																...
																if($Main_or_side_item_code[1] == $POS_menu_group['Merchandize_category_id']){
																echo'<option selected value="'.$POS_menu_group['Merchandize_category_id'].'" style="font-weight:bold;">'.$POS_menu_group['Merchandize_category_name'].'</option>';
																}
																else
																{
																...
																foreach($childs as $row) {
																	if($row->Merchandize_category_id == $Main_or_side_item_code[1])
																	{
																		echo'<option selected value="'.$row->Merchandize_category_id.'" style="margin-left: 20px;">--'.$row->Merchandize_category_name.'</option>';
																	}
																	else{
												...
												<div class="form-group">
													...
													foreach($Merchandize_Category_Records as $POS_menu_group) {
															...
															if(!$POS_menu_group['Parent_category_id']) 
															{
																...
																if($Main_or_side_item_code[2] == $POS_menu_group['Merchandize_category_id']){
																echo'<option selected value="'.$POS_menu_group['Merchandize_category_id'].'" style="font-weight:bold;">'.$POS_menu_group['Merchandize_category_name'].'</option>';
																}
																else
																{
																...
																foreach($childs as $row) {
																	if($row->Merchandize_category_id == $Main_or_side_item_code[2])
																	{
																		echo'<option selected value="'.$row->Merchandize_category_id.'" style="margin-left: 20px;">--'.$row->Merchandize_category_name.'</option>';
																	}
																	else{
												...
												<div class="form-group">
													...
													foreach($Merchandize_Category_Records as $POS_menu_group) {
															...
															if(!$POS_menu_group['Parent_category_id']) 
															{
																...
																if($Main_or_side_item_code[3] == $POS_menu_group['Merchandize_category_id']){
																echo'<option selected value="'.$POS_menu_group['Merchandize_category_id'].'" style="font-weight:bold;">'.$POS_menu_group['Merchandize_category_name'].'</option>';
																}
																else
																{
																...
																foreach($childs as $row) {
																	if($row->Merchandize_category_id == $Main_or_side_item_code[3])
																	{
																		echo'<option selected value="'.$row->Merchandize_category_id.'" style="margin-left: 20px;">--'.$row->Merchandize_category_name.'</option>';
																	}
																	else{
												...
												<div class="form-group">
													...
													foreach($Merchandize_Category_Records as $POS_menu_group) {
															...
															if(!$POS_menu_group['Parent_category_id']) 
															{
																...
																if($Main_or_side_item_code[4] == $POS_menu_group['Merchandize_category_id']){
																echo'<option selected value="'.$POS_menu_group['Merchandize_category_id'].'" style="font-weight:bold;">'.$POS_menu_group['Merchandize_category_name'].'</option>';
																}
																else
																{
																...
																foreach($childs as $row) {
																	if($row->Merchandize_category_id == $Main_or_side_item_code[4])
																	{
																		echo'<option selected value="'.$row->Merchandize_category_id.'" style="margin-left: 20px;">--'.$row->Merchandize_category_name.'</option>';
																	}
																	else{
												...
												<div class="form-group">
													...
													foreach($Merchandize_Category_Records as $POS_menu_group) {
															...
															if(!$POS_menu_group['Parent_category_id']) 
															{
																...
																if($Main_or_side_item_code[5] == $POS_menu_group['Merchandize_category_id']){
																echo'<option selected value="'.$POS_menu_group['Merchandize_category_id'].'" style="font-weight:bold;">'.$POS_menu_group['Merchandize_category_name'].'</option>';
																}
																else
																{
																...
																foreach($childs as $row) {
																	if($row->Merchandize_category_id == $Main_or_side_item_code[5])
																	{
																		echo'<option selected value="'.$row->Merchandize_category_id.'" style="margin-left: 20px;">--'.$row->Merchandize_category_name.'</option>';
																	}
																	else{
												...
												<div class="form-group">
													...
													foreach($Merchandize_Category_Records as $POS_menu_group) {
															...
															if(!$POS_menu_group['Parent_category_id']) 
															{
																...
																if($Main_or_side_item_code[6] == $POS_menu_group['Merchandize_category_id']){
																echo'<option selected value="'.$POS_menu_group['Merchandize_category_id'].'" style="font-weight:bold;">'.$POS_menu_group['Merchandize_category_name'].'</option>';
																}
																else
																{
																...
																foreach($childs as $row) {
																	if($row->Merchandize_category_id == $Main_or_side_item_code[6])
																	{
																		echo'<option selected value="'.$row->Merchandize_category_id.'" style="margin-left: 20px;">--'.$row->Merchandize_category_name.'</option>';
																	}
																	else{
												...
												<div class="form-group">
													...
													foreach($Merchandize_Category_Records as $POS_menu_group) {
															...
															if(!$POS_menu_group['Parent_category_id']) 
															{
																...
																if($Main_or_side_item_code[7] == $POS_menu_group['Merchandize_category_id']){
																echo'<option selected value="'.$POS_menu_group['Merchandize_category_id'].'" style="font-weight:bold;">'.$POS_menu_group['Merchandize_category_name'].'</option>';
																}
																else
																{
																...
																foreach($childs as $row) {
																	if($row->Merchandize_category_id == $Main_or_side_item_code[7])
																	{
																		echo'<option selected value="'.$row->Merchandize_category_id.'" style="margin-left: 20px;">--'.$row->Merchandize_category_name.'</option>';
																	}
																	else{
												...
												<div class="form-group">
													...
													foreach($Merchandize_Category_Records as $POS_menu_group) {
															...
															if(!$POS_menu_group['Parent_category_id']) 
															{
																...
																if($Main_or_side_item_code[8] == $POS_menu_group['Merchandize_category_id']){
																echo'<option selected value="'.$POS_menu_group['Merchandize_category_id'].'" style="font-weight:bold;">'.$POS_menu_group['Merchandize_category_name'].'</option>';
																}
																else
																{
																...
																foreach($childs as $row) {
																	if($row->Merchandize_category_id == $Main_or_side_item_code[8])
																	{
																		echo'<option selected value="'.$row->Merchandize_category_id.'" style="margin-left: 20px;">--'.$row->Merchandize_category_name.'</option>';
																	}
																	else{
												...
												<div class="form-group">
													...
													foreach($Merchandize_Category_Records as $POS_menu_group) {
															...
															if(!$POS_menu_group['Parent_category_id']) 
															{
																...
																if($Main_or_side_item_code[9] == $POS_menu_group['Merchandize_category_id']){
																echo'<option selected value="'.$POS_menu_group['Merchandize_category_id'].'" style="font-weight:bold;">'.$POS_menu_group['Merchandize_category_name'].'</option>';
																}
																else
																{
																...
																foreach($childs as $row) {
																	if($row->Merchandize_category_id == $Main_or_side_item_code[9])
																	{
																		echo'<option selected value="'.$row->Merchandize_category_id.'" style="margin-left: 20px;">--'.$row->Merchandize_category_name.'</option>';
																	}
																	else{
												...
												<div class="form-group">
													...
													foreach($Merchandize_Category_Records as $POS_menu_group) {
															...
															if(!$POS_menu_group['Parent_category_id']) 
															{
																...
																if($Main_or_side_item_code[10] == $POS_menu_group['Merchandize_category_id']){
																echo'<option selected value="'.$POS_menu_group['Merchandize_category_id'].'" style="font-weight:bold;">'.$POS_menu_group['Merchandize_category_name'].'</option>';
																}
																else
																{
																...
																foreach($childs as $row) {
																	if($row->Merchandize_category_id == $Main_or_side_item_code[10])
																	{
																		echo'<option selected value="'.$row->Merchandize_category_id.'" style="margin-left: 20px;">--'.$row->Merchandize_category_name.'</option>';
																	}
																	else{
...
<?php
				...
				<div class="element-wrapper">											
					...
					<th class="text-center">Show Item</th>
					<th class="text-center">Stamp Item</th>
					...
					?>
						...
						<tr>
							...
							<td><?php echo $row->Billing_price; ?></td>
							<td><?php if($row->show_item==1){echo "Yes";}else{echo "No";} ?></td>
							<td><?php if($row->Stamp_item_flag==1){echo "Yes";}else{echo "No";} ?></td>
...
//******* sandeep ********20-03-2020*********
// alert();
		var Rec_seller = '<?php echo $SellerID;?>';
		if(Rec_seller==438 || Rec_seller==439 )
		{
			$("#Item_type_block").show();
			$("#Item_type_block2").show();
			$("#Item_type_block3").show();
		}
		else
		{
			$("#Item_type_block").hide();
			$("#Item_type_block2").hide();
			$("#Item_type_block3").hide();
		}
	$('#seller_id').change(function()
	{
		...
		$.ajax({
			...
			success:function(opData2){
				...
				for(let k = 0;k <= 10; k++)
				{
					$('#Main_or_side_item_code'+k).html(opData2);
				} 
			}
		});
		...
		$.ajax({
			type:"POST",
			data:{seller_id:seller_id,Company_id:Company_id},
			url:'<?php echo base_url()?>index.php/POS_CatalogueC/get_seller_opt_cond_groups',
			success:function(opData3){
				$('#Optional_Condiment_Group').html(opData3);
			}
		});
		...
		$.ajax({
			type:"POST",
			data:{seller_id:seller_id,Company_id:Company_id},
			url:'<?php echo base_url()?>index.php/POS_CatalogueC/get_seller_req_cond_groups',
			success:function(opData4){
				$('#Required_Condiment_Group').html(opData4);
			}
		});
		...
		$.ajax({
			type:"POST",
			data:{seller_id:seller_id,Company_id:Company_id},
			url:'<?php echo base_url()?>index.php/POS_CatalogueC/get_outlet_by_subadmin',
			success:function(opData4){
