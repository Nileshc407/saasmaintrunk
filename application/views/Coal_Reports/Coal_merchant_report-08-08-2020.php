							...
							<?php } ?>  
							  <div class="form-group">
								...
								<?php								
									...
									{
									if($transaction->Trans_type_id==1 || $transaction->Trans_type_id==2 || $transaction->Trans_type_id==3 || $transaction->Trans_type_id==4 || $transaction->Trans_type_id==10 || $transaction->Trans_type_id==12)
										{ ?>
