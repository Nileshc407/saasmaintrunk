							  ...
							  <div class="form-group">
								...
								<select class="form-control" name="transaction_type_id" id="transaction_type_id" required="required" data-error="Please select transaction type">
									...
									<?php	
										...
										$transactionTypes = [1,2,3,4,7,8,13,14,15,19,26];
					  ...
					  <div class="table-responsive">
						<table id="dataTable1" width="100%" class="table table-striped table-lightfont">
							<thead>
								...
								<th>Loyalty <?php echo $Company_details->Currency_name; ?></th>
								<th>Redeemed <?php echo $Company_details->Currency_name; ?></th>
								<?php
									if($Enable_company_meal_flag==1){echo '<th>Meal Topup</th>';}else{echo '<th>Credit-Topup '.$Company_details->Currency_name.'</th>';}
								?>
								...
								<tr>
									...
									<?php
									if($Enable_company_meal_flag==1){echo '<th>Total Meal Topup</th>';}else{echo '<th>Total Credit-Topup '.$Company_details->Currency_name.'</th>';}
								?>
							...
							foreach($Trans_Records as $row)
							{
								...
								if($report_type==2)
								{
									...
									?>
										...
										<td><?php echo $row->Total_Credit_topup_Points;?></td>
