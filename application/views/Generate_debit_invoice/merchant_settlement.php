        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="element-wrapper">
                    <h6 class="element-header">Generated Merchant Debit Invoice</h6>
                    <div class="element-box">					
                        ...
                        <?php
                          ...
                          echo form_open('Settlement/Merchant_debit_settlement', $attributes);
                        ?>   
							<div class="row">
								<div class="col-sm-6">
