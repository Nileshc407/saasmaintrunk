        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="element-wrapper">
                    <h6 class="element-header">Generate Debit Transaction Invoice</h6>
                    <div class="element-box">					
                        ...
                        <?php
                          ...
                          echo form_open('Generate_debit_trans_invoice', $attributes);
                        ?>   
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										<label for=""><span class="required_info">*</span> Company Name</label>									
										<select class="form-control" data-error="Enter Company Name" required="required"  name="Company_id" name="Company_id" >
                        ...
                        <div class="table-responsive">
                            <table id="dataTable1" width="100%" class="table table-striped table-lightfont">
								...
								<?php foreach ($InvoiceDetails as $row) { ?>
                                        <tr>
											<td>											
												<a href="<?php echo base_url()?>index.php/Generate_debit_trans_invoice/DownloadInvoice/?Bill_id=<?php echo $row->Bill_id;?>&Seller_id=<?php echo $row->Seller_id;?>&Bill_no=<?php echo $row->Bill_no;?>&flag=0" title="Invoice">
														
													<i class="icon-feather-download"></i>	Invoice												
												</a>
												<br>
												<a href="<?php echo base_url()?>index.php/Generate_debit_trans_invoice/DownloadInvoice/?Bill_id=<?php echo $row->Bill_id;?>&Seller_id=<?php echo $row->Seller_id;?>&Bill_no=<?php echo $row->Bill_no;?>&flag=1" title="Annexure">
													<i class="icon-feather-download"></i>Annexure
												</a>
											</td>
											...
											<?php if($row->Settlement_amount < $row->Bill_amount) { ?>
