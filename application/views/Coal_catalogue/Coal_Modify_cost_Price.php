		...
		<div class="row">
			...
			<?php $attributes = array('id' => 'formValidate');
				...
				<div class="element-wrapper">
					<h6 class="element-header">MODIFY MERCHANDISE ITEMS</h6>
				...
				<?php 	} ?>
							<div class="row">
								...
								<div class="col-sm-6">
								  <div class="form-group">
									...
									<select class="form-control" name="Partner_id" id="Partner_id" data-error="Please select merchandise partner">
								  ...
								  <div class="form-group">
										...
										<select class="form-control select2" multiple="true" name="partner_branches[]" id="partner_branches">
										<?php
								  ...
								  <!--<div class="form-group">
									...
									<div class="col-sm-8" style=" margin-top:7px;">
									  <div class="form-check" style="float:left;">
										...
										<input class="form-check-input" name="Merchant_flag" id="Merchant_flag" type="radio" value="1" onclick="Merchant_toggle(this.value);" <?php if($Merchandize_Item_Row->Merchant_flag==1){echo "checked";} ?>>Yes</label>
									  </div>
									  
									  <div class="form-check" style="margin-left:50px;">
										<label class="form-check-label">
										<input class="form-check-input" name="Merchant_flag" id="Merchant_flag" type="radio" value="0" onclick="Merchant_toggle(this.value);" <?php if($Merchandize_Item_Row->Merchant_flag==0){echo "checked";} ?>>No</label>
									  </div> 
									</div>
								  </div>-->
								...
								<?php if($Merchandize_Item_Row->Merchant_flag==1){ ?>
								  <div class="form-group" id="Seller_Admin_list">
									<label for=""><span class="required_info">* </span>Link to Merchant</label>
								...
								<?php } ?>
								  ...
								  <div class="form-group" id="Select_tier">
									...
									<?php										
										foreach($Merchandize_Item_Tiers as $Merchandize_Item_Tiers)
										{
											echo "<option value='".$Merchandize_Item_Tiers->Tier_id."' selected>".$Merchandize_Item_Tiers->Tier_name."</option>";
										}
									?>
									</select>
								  </div>
								  ...
								  <div class="form-group">
									...
									<input type="text" class="form-control" name="VAT" id="VAT"  value="<?php echo $Merchandize_Item_Row->VAT;?>" onchange="Get_Calculation();Get_Calculation_small();Get_Calculation_medium();Get_Calculation_large();Get_Calculation_extra_large();" readonly />
								  </div>

								  <div class="form-group">
									<label for=""><span class="required_info">* </span>Partner Margin</label>
									<input type="text" class="form-control" name="margin" id="margin" value="<?php echo $Merchandize_Item_Row-> Markup_percentage;?>" onchange="Get_Calculation();Get_Calculation_small();Get_Calculation_medium();Get_Calculation_large();Get_Calculation_extra_large();" readonly />
								  </div>
									...
									<?php } ?>
										<div class="form-group">
											...
											<div class="col-sm-8" style=" margin-top:7px;">
											  <div class="form-check" style="float:left;">
												<label class="form-check-label">
												<input class="form-check-input" type="radio" name="Size_flag"  id="Size_flag" value="1" onclick="Size_toggle(this.value)" <?php if($Merchandize_Item_Row->Size_flag==1){echo "checked";} ?>>Yes</label>
											  </div>
											  
											  <div class="form-check" style="margin-left:50px;">
												<label class="form-check-label">
												<input class="form-check-input" type="radio" name="Size_flag" id="Size_flag" value="0" onclick="Size_toggle(this.value)" <?php if($Merchandize_Item_Row->Size_flag==0){echo "checked";} ?>>No</label>
											  </div> 
											</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-8" style=" margin-top:7px;">
											  <div class="form-check" style="float:left;">
												<label class="form-check-label">
												<input class="form-check-input" type="radio" name="Dimension_flag"  id="Dimension_flag" value="1" onclick="Dimension_toggle(this.value)" <?php if($Merchandize_Item_Row->Dimension_flag==1){echo "checked";} ?> >Yes</label>
											  </div>
											  
											  <div class="form-check" style="margin-left:50px;">
												<label class="form-check-label">
												<input class="form-check-input" type="radio" name="Dimension_flag" id="Dimension_flag" value="0" onclick="Dimension_toggle(this.value)" <?php if($Merchandize_Item_Row->Dimension_flag==0){echo "checked";} ?> >No</label>
											  </div> 
											</div>
										</div>
						...
						<?php if($Merchandize_Item_Row->Size_flag==0){?>
							<div id="default_block">
								...
								<div class="row">
									<div class="col-sm-3">
										<div class="form-group">
											...
											<input class="form-control"  placeholder="Enter cost price"  type="text" name="Cost_price" id="Cost_price" onkeypress="return isNumberKey2(event);" onchange="Get_Calculation()" value="<?php echo $Merchandize_Item_Row-> Cost_price;?>">
										</div>
									</div>
									<div class="col-sm-3">
										<div class="form-group">
								...
								<div id="dimension_block">
									<div class="row">
										<div class="col-sm-3">
											Dimension 
											<div class="form-group">
												<input class="form-control" type="text" name="Length" id="Length"  placeholder="Length"  onkeypress="return isNumberKey2(event);" value="<?php echo $Length; ?>">	
											</div>
										</div>
										...
										<div class="col-sm-3">
											&nbsp;
											<div class="form-group">
												<input class="form-control" type="text" name="Width" id="Width"  placeholder="Width" onkeypress="return isNumberKey2(event);" value="<?php echo $Width; ?>">
											</div>
										</div>
										<div class="col-sm-2">
										&nbsp;
											<div class="form-group">
												<input class="form-control" type="text" name="Height" id="Height" placeholder="Height" onkeypress="return isNumberKey2(event);" value="<?php echo $Height; ?>">
											</div>
										</div>
										<div class="col-sm-4">
										&nbsp;
								...
								<?php } 
								if($Merchandize_Item_Row->Weight_flag==1){?>
								<div class="form-group" id="weight_block">
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												<label for="">Weight</label>
												<input class="form-control" type="text" name="Weight" id="Weight" placeholder="Enter weight" onkeypress="return isNumberKey2(event);" value="<?php echo $Merchandize_Item_Row->Item_Weight; ?>"/>
											</div>
										</div>
										<div class="col-sm-6">
										&nbsp;
							...
							<div id="small_block"  style="display:none;">
								...
								<fieldset class="form-group">
									...
									<div class="row">
										...
										Small Cost Price
											<div class="form-group">
												<input type="text" name="small_Cost_price" id="small_Cost_price" class="form-control" placeholder="Enter Cost Price "  onkeypress="return isNumberKey2(event);" onchange="Get_Calculation_small()" value=""/>	
											</div>
										</div>
										<div class="col-sm-4">
										Billing Price
											<div class="form-group">
												<input type="text" name="small_Billing_price" id="small_Billing_price"  placeholder="" class="form-control" readonly  value="" />
											</div>
										</div>
										<div class="col-sm-4">
										Redeemable Points
											<div class="form-group">
												<input type="text" name="small_Points" id="small_Points" placeholder="" class="form-control" readonly  value="" />
											</div>
										</div>
									</div>
									<div id="weight_block_small" style="display:none;">
										<div class="row">
											<div class="col-sm-6">
												<div class="form-group">
												Small Item Weight
													<input type="text" name="Small_Weight" id="Small_Weight" placeholder="Enter Weight" class="form-control" value=""  onkeypress="return isNumberKey2(event);" />
												</div>
											</div>
											<div class="col-sm-6">
											&nbsp;
											<select class="form-control" name="Small_Weight_unit" id="Small_Weight_unit"  >
												<option  value="">Select small item weight unit</option>
													<?php
													foreach($Code_decode_Records as $Rec)
													{
														if($Rec->Code_decode_type_id==3)//Weight
									...
									<!--------------SMALL ITEM DMENSION--------------->
									<!--------------SMALL ITEM DMENSION----END-------->
									<div id="dimension_block_small" style="display:none;">
										<div class="row">
											<div class="col-sm-3">
												Small Item Dimension 
												<div class="form-group">
													<input type="text" name="Small_Length" id="Small_Length" class="form-control" placeholder="Length"  onkeypress="return isNumberKey2(event);" value=""  />	
												</div>
											</div>
											...
											<div class="col-sm-3">
												&nbsp;
												<div class="form-group">
													<input type="text" name="Small_Width" id="Small_Width"  placeholder="Width" class="form-control"   value=""    onkeypress="return isNumberKey2(event);"/>
												</div>
											</div>
											<div class="col-sm-2">
											&nbsp;
												<div class="form-group">
													<input type="text" name="Small_Height" id="Small_Height" placeholder="Height" class="form-control" value=""  onkeypress="return isNumberKey2(event);" />
												</div>
											</div>
											<div class="col-sm-4">
												&nbsp;
								...
								<div class="row" id="medium_block">
									<div class="col-sm-4">
										...
										<label for="">Medium Cost Price</label>
											<input type="text" name="medium_Cost_price" id="medium_Cost_price" class="form-control" placeholder="Enter Cost Price "  onkeypress="return isNumberKey2(event);" onchange="Get_Calculation_medium()"   value=""  />	
										</div>
									</div>
									<div class="col-sm-4">
										<div class="form-group">
										<label for="">Billing Price</label>
											<input type="text" name="medium_Billing_price" id="medium_Billing_price"  placeholder="" class="form-control" readonly  value=""/>
										</div>
									</div>
									<div class="col-sm-4">
										<div class="form-group has-feedback">
										<label for="">Redeemable Points</label>
											<input type="text" name="medium_Points" id="medium_Points" placeholder="" class="form-control" readonly  value=""/>
										</div>
									</div>
								</div>
								<!--------------Medium ITEM WEIGHT------------>
								<div class="form-group" id="weight_block_medium" style="display:none;">
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
											Medium Item Weight
												<input type="text" name="Medium_Weight" id="Medium_Weight" placeholder="Enter Weight" class="form-control"  onkeypress="return isNumberKey2(event);"  value="" />
											</div>
										</div>
										<div class="col-md-6">
										&nbsp;
										<select class="form-control" name="Medium_Weight_unit" id="Medium_Weight_unit"  >
											<option  value="">Select Medium Item Weight Unit</option>
												<?php
												foreach($Code_decode_Records as $Rec)
												{
													if($Rec->Code_decode_type_id==3)//Weight
								...
								<!--------------Medium ITEM DMENSION----END-------->
								<div class="form-group" id="dimension_block_medium"  style="display:none;">
									<div class="row">
										<div class="col-sm-3">
											Medium Item Dimension 
											<div class="form-group">
												<input type="text" name="Medium_Length" id="Medium_Length" class="form-control" placeholder="Length" value=""   onkeypress="return isNumberKey2(event);" />	
											</div>
										</div>
										...
										<div class="col-sm-3">
											&nbsp;
											<div class="form-group">
												<input type="text" name="Medium_Width" id="Medium_Width"  placeholder="Width" class="form-control"  value=""  onkeypress="return isNumberKey2(event);"/>
											</div>
										</div>
										<div class="col-sm-2">
										&nbsp;
											<div class="form-group">
												<input type="text" name="Medium_Height" id="Medium_Height" placeholder="Height" class="form-control"  value=""  onkeypress="return isNumberKey2(event);" />
											</div>
										</div>
										<div class="col-sm-4">
										&nbsp;
								...
								<div class="row" id="large_block">
									<div class="col-sm-4">
										<div class="form-group has-feedback">
											Large Cost Price
											<input type="text" name="large_Cost_price" id="large_Cost_price" class="form-control" placeholder="Enter Cost Price "  onkeypress="return isNumberKey2(event);" onchange="Get_Calculation_large()"  value=""  />	
										</div>
									</div>
									<div class="col-sm-4">
										Billing Price
										<div class="form-group has-feedback">
											<input type="text" name="large_Billing_price" id="large_Billing_price"  placeholder="" class="form-control" readonly  value=""/>
										</div>
									</div>
									<div class="col-sm-4">
										Redeemable Points
										<div class="form-group has-feedback">
											<input type="text" name="large_Points" id="large_Points" placeholder="" class="form-control" readonly  value=""/>
										</div>
									</div>
								</div>
								<!--------------Large ITEM WEIGHT------------>
									...
									<div class="row">
										<div class="col-sm-6">
											...
											<label for="">Large Item Weight</label>
												<input type="text" name="Large_Weight" id="Large_Weight" placeholder="Enter Weight" class="form-control"  value=""   onkeypress="return isNumberKey2(event);" />
											</div>
										</div>
										<div class="col-sm-6">
										&nbsp;
										<select class="form-control" name="Large_Weight_unit" id="Large_Weight_unit"  >
											<option  value="">Select large item weight unit</option>
											<?php
												foreach($Code_decode_Records as $Rec)
												{
													if($Rec->Code_decode_type_id==3)//Weight
								...
								<!--------------Large ITEM DMENSION--------------->
								<!--------------Large ITEM DMENSION----END-------->
								<div class="form-group" id="dimension_block_large"  style="display:none;">
									<div class="row">
										<div class="col-sm-3">
											Large Item Dimension 
											<div class="form-group has-feedback">
												<input type="text" name="Large_Length" id="Large_Length" class="form-control" placeholder="Length" value=""  onkeypress="return isNumberKey2(event);" />	
											</div>
										</div>
										<div class="col-sm-3">
											&nbsp;
											<div class="form-group has-feedback">
												<input type="text" name="Large_Width" id="Large_Width"  placeholder="Width" class="form-control"  value=""   onkeypress="return isNumberKey2(event);"/>
											</div>
										</div>
										<div class="col-sm-2">
										&nbsp;
											<div class="form-group has-feedback">
												<input type="text" name="Large_Height" id="Large_Height" placeholder="Height" class="form-control" value=""   onkeypress="return isNumberKey2(event);" />
											</div>
										</div>
										<div class="col-sm-4">
											&nbsp;
								...
								<div class="row" id="elarge_block" >
									<div class="col-sm-4">
										<div class="form-group">
											...
											<input type="text" name="elarge_Cost_price" id="elarge_Cost_price" class="form-control" placeholder="Enter Cost Price "  onkeypress="return isNumberKey2(event);" onchange="Get_Calculation_extra_large()" value="" />	
										</div>
									</div>
									<div class="col-sm-4">
										<div class="form-group">
										<label for="">Billing Price</label>
											<input type="text" name="elarge_Billing_price" id="elarge_Billing_price"  placeholder="" class="form-control" readonly  value="" />
										</div>
									</div>
									<div class="col-sm-4">
										<div class="form-group">
										<label for="">Redeemable Points</label>
											<input type="text" name="elarge_Points" id="elarge_Points" placeholder="" class="form-control" readonly  value=""/>
										</div>
									</div>
								</div>
								<!--------------Large ITEM WEIGHT------------>
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group has-feedback">
												...
												<input type="text" name="eLarge_Weight" id="eLarge_Weight" placeholder="Enter Weight" class="form-control"  value="" onkeypress="return isNumberKey2(event);" />
											</div>
										</div>
										<div class="col-sm-6">
										&nbsp;
											<select class="form-control" name="eLarge_Weight_unit" id="eLarge_Weight_unit"  >
												<option  value="">Select extra large item weight unit</option>
											<?php
												foreach($Code_decode_Records as $Rec)
												{
													if($Rec->Code_decode_type_id==3)//Weight
								...
								<!--------------Large ITEM DMENSION----END-------->
								<div class="form-group" id="edimension_block_large" style="display:none;">
									<div class="row">
										<div class="col-sm-3">
											Extra Large Item Dimension 
											<div class="form-group has-feedback">
												<input type="text" name="eLarge_Length" id="eLarge_Length" class="form-control" placeholder="Length" value=""   onkeypress="return isNumberKey2(event);" />	
											</div>
										</div>
										<div class="col-sm-3">
											&nbsp;
											<div class="form-group has-feedback">
												<input type="text" name="eLarge_Width" id="eLarge_Width"  placeholder="Width" class="form-control" value=""    onkeypress="return isNumberKey2(event);"/>
											</div>
										</div>
										<div class="col-sm-2">
										&nbsp;
											<div class="form-group has-feedback">
												<input type="text" name="eLarge_Height" id="eLarge_Height" placeholder="Height" class="form-control" value=""   onkeypress="return isNumberKey2(event);" />
											</div>
										</div>
										<div class="col-sm-4">
											&nbsp;
								...
								<fieldset class="form-group">
									...
									<div class="row">
										<div class="col-sm-3">
											<div class="form-group">
											<label for="">Cost Price</label>
												<input type="text" name="Cost_price" id="Cost_price" class="form-control" placeholder="Enter cost price"  onkeypress="return isNumberKey2(event);" onchange="Get_Calculation()" value=""/>	
											</div>
										</div>
										<div class="col-sm-3">
											<div class="form-group">
											<label for="">Billing Price</label>
												<input type="text" name="Billing_price" id="Billing_price"  class="form-control" readonly value="" />
											</div>
										</div>
										<div class="col-sm-3">
											<div class="form-group">
											<label for="">Redeemable Points</label>
												<input type="text" name="Points" id="Points" class="form-control" readonly value=""/>
											</div>
										</div>
									</div>
									<div class="form-group" id="dimension_block" style="display:none;">
									...
									<div id="weight_block" style="display:none;">
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group has-feedback">
												<input type="text" name="Weight" id="Weight" placeholder="Enter weight" class="form-control"  onkeypress="return isNumberKey2(event);" />
							...
							<div id="small_block">
								...
								<div class="row">
									<div class="col-sm-4">
										<div class="form-group">
											...
											<input class="form-control"  placeholder="Enter cost price"  type="text" name="small_Cost_price" id="small_Cost_price" onkeypress="return isNumberKey2(event);" onchange="Get_Calculation_small()" value="<?php echo $small_Cost_price;?>">
										</div>
									</div>
									<div class="col-sm-4">
										<div class="form-group">
								...
								<div class="form-group" id="weight_block_small" style="display:none;">
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												<label for="">Small Item Weight</label>
												<input class="form-control" type="text" name="Small_Weight" id="Small_Weight" placeholder="Enter weight" onkeypress="return isNumberKey2(event);" value=""/>
											</div>
										</div>
										<div class="col-sm-6">
										&nbsp;
								...
								<div id="dimension_block_small">
									<div class="row">
										<div class="col-sm-3">
											Small Item Dimension 
											<div class="form-group">
												<input class="form-control" type="text" name="Small_Length" id="Small_Length"  placeholder="Length" onkeypress="return isNumberKey2(event);" value="<?php echo $Length_sm; ?>"/>	
											</div>
										</div>
										...
										<div class="col-sm-3">
											&nbsp;
											<div class="form-grou">
												<input class="form-control" type="text" name="Small_Width" id="Small_Width"  placeholder="Width" onkeypress="return isNumberKey2(event);" value="<?php echo $Width_sm; ?>"  />
											</div>
										</div>
										<div class="col-sm-2">
										&nbsp;
											<div class="form-group">
												<input class="form-control" type="text" name="Small_Height" id="Small_Height" placeholder="Height" onkeypress="return isNumberKey2(event);"  value="<?php echo $Height_sm; ?>">
											</div>
										</div>
										<div class="col-sm-4">
										&nbsp;
								...
								<div id="dimension_block_small" style="display:none;">
									<div class="row">
										<div class="col-sm-3">
											Small Item Dimension 
											<div class="form-group">
												<input class="form-control" type="text" name="Small_Length" id="Small_Length"  placeholder="Length" onkeypress="return isNumberKey2(event);" value=""/>	
											</div>
										</div>
										...
										<div class="col-sm-3">
											&nbsp;
											<div class="form-grou">
												<input class="form-control" type="text" name="Small_Width" id="Small_Width"  placeholder="Width" onkeypress="return isNumberKey2(event);" value="">
											</div>
										</div>
										<div class="col-sm-2">
										&nbsp;
											<div class="form-group">
												<input class="form-control" type="text" name="Small_Height" id="Small_Height" placeholder="Height" onkeypress="return isNumberKey2(event);" value="">
											</div>
										</div>
										<div class="col-sm-4">
										&nbsp;
								...
								<div class="row" id="medium_block">
									<div class="col-sm-4">
										<div class="form-group">
											<label for="">Medium Cost Price</label>
											<input class="form-control"  placeholder="Enter cost price"  type="text" name="medium_Cost_price" id="medium_Cost_price" onkeypress="return isNumberKey2(event);" onchange="Get_Calculation_medium()"  value="<?php echo $medium_Cost_price;?>"/>
										</div>
									</div>
									<div class="col-sm-4">
										<div class="form-group">
								...
								<div class="form-group" id="weight_block_medium" style="display:none;">
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												<label for="">Medium Item Weight</label>
												<input class="form-control" type="text" name="Medium_Weight" id="Medium_Weight" placeholder="Enter weight" onkeypress="return isNumberKey2(event);" value="" />
											</div>
										</div>
										<div class="col-sm-6">
										&nbsp;
								...
								<div id="dimension_block_medium" style="display:none;">
									<div class="row">
										<div class="col-sm-3">
											Medium Item Dimension 
											<div class="form-group">
												<input class="form-control" type="text" name="Medium_Length" id="Medium_Length"  placeholder="Length"  onkeypress="return isNumberKey2(event);" value="" />	
											</div>
										</div>
										...
										<div class="col-sm-3">
											&nbsp;
											<div class="form-grou">
												<input class="form-control" type="text" name="Medium_Width" id="Medium_Width"  placeholder="Width" onkeypress="return isNumberKey2(event);" value=""/>
											</div>
										</div>
										<div class="col-sm-2">
										&nbsp;
											<div class="form-group">
												<input class="form-control" type="text" name="Medium_Height" id="Medium_Height" placeholder="Height" onkeypress="return isNumberKey2(event);"value=""/>
											</div>
										</div>
										<div class="col-sm-4">
										&nbsp;
								...
								<div class="form-group" id="weight_block_large" style="display:none;">
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												<label for="">Large Item Weight</label>
												<input class="form-control" type="text" name="Large_Weight" id="Large_Weight" placeholder="Enter weight" onkeypress="return isNumberKey2(event);" value="" >
											</div>
										</div>
										<div class="col-sm-6">
										&nbsp;
								...
								<div id="dimension_block_large" style="display:none;">
									<div class="row">
										<div class="col-sm-3">
											Large Item Dimension  
											<div class="form-group">
												<input class="form-control" type="text" name="Large_Length" id="Large_Length"  placeholder="Length"  onkeypress="return isNumberKey2(event);" value="" >	
											</div>
										</div>
										...
										<div class="col-sm-3">
											&nbsp;
											<div class="form-grou">
												<input class="form-control" type="text" name="Large_Width" id="Large_Width"  placeholder="Width" onkeypress="return isNumberKey2(event);" value=""/>
											</div>
										</div>
										<div class="col-sm-2">
										&nbsp;
											<div class="form-group">
												<input class="form-control" type="text" name="Large_Height" id="Large_Height" placeholder="Height" onkeypress="return isNumberKey2(event);" value=""/>
											</div>
										</div>
										<div class="col-sm-4">
										&nbsp;
								...
								<div class="form-group" id="eweight_block_large" style="display:none;">
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												<label for="">Extra Large Item Weight</label>
												<input class="form-control" type="text" name="eLarge_Weight" id="eLarge_Weight" placeholder="Enter weight" onkeypress="return isNumberKey2(event);"  value="">
											</div>
										</div>
										<div class="col-sm-6">
										&nbsp;
								...
								<div id="edimension_block_large" style="display:none;">
									<div class="row">
										<div class="col-sm-3">
											Extra Large Item Dimension  
											<div class="form-group">
												<input class="form-control" type="text" name="eLarge_Length" id="eLarge_Length"  placeholder="Length"  onkeypress="return isNumberKey2(event);" value=""/>	
											</div>
										</div>
										...
										<div class="col-sm-3">
											&nbsp;
											<div class="form-grou">
												<input class="form-control" type="text" name="eLarge_Width" id="eLarge_Width"  placeholder="Width" onkeypress="return isNumberKey2(event);" value=""/>
											</div>
										</div>
										<div class="col-sm-2">
										&nbsp;
											<div class="form-group">
												<input class="form-control" type="text" name="eLarge_Height" id="eLarge_Height" placeholder="Height" onkeypress="return isNumberKey2(event);"value=""/>
											</div>
										</div>
										<div class="col-sm-4">
										&nbsp;
								...
								<div class="row">
									<div class="col-xs-6 col-sm-3">
										<div class="thumbnail">
											...
											<img src="<?php echo $Merchandize_Item_Row->Item_image1; ?>" class="img-responsive" style="width: 50%;">
											<?php }else{ ?>	
							...
							<input type="hidden" name="small_Cost_payable_to_partner" id="small_Cost_payable_to_partner" class="form-control" readonly value="<?php echo $small_Cost_payable_to_partner;?>">					
							<input type="hidden" name="medium_Cost_payable_to_partner" id="medium_Cost_payable_to_partner" class="form-control" readonly value="<?php echo $medium_Cost_payable_to_partner;?>">					
							<input type="hidden" name="large_Cost_payable_to_partner" id="large_Cost_payable_to_partner" class="form-control" readonly value="<?php echo $large_Cost_payable_to_partner;?>">					
							<input type="hidden" name="elarge_Cost_payable_to_partner" id="elarge_Cost_payable_to_partner" class="form-control" readonly value="<?php echo $elarge_Cost_payable_to_partner;?>">
							<!------------------------>	
							
							<input type="hidden" name="Company_merchandise_item_id" value="<?php echo $Merchandize_Item_Row->Company_merchandise_item_id;?>">
							<input type="hidden" name="Modify_cost_price" value="1">
...
<?php } ?>
	...
	/* 	$('#Register').click(function()
	{
		...
		if( $('#Company_id').val() != "" && $('#Merchandize_category_id').val() != "" && $('#Company_merchandize_item_code').val() != "" && $('#Merchandize_item_name').val() != "" && $('#Merchandise_item_description').val() != ""  && $('#datepicker1').val() != "" && $('#datepicker2').val() != "" && $('#Partner_id').val() != "" && $('#partner_branches').val() != ""&& $('#Delivery_method').val() != "")
		{
			...
			if(Size_flag==1)
			{
				if($('#small_Cost_price').val() == "" && $('#medium_Cost_price').val() == "" && $('#large_Cost_price').val() == "")
				{
					var Title = "Application Information";
					var msg = 'Please Enter atleast one Cost Price of Small, Medium or Large';
					runjs(Title,msg);
					return false;
				}
				else
	...
	{
		var url = '<?php echo base_url()?>index.php/CatalogueC/InActive_Merchandize_Item/?Company_merchandise_item_id='+Company_merchandise_item_id;
	...
	/*
	$('#Seller_Redemptionratio').change(function()
	{
		var Seller_id = $("#Seller_id").val();
		var Seller_Redemptionratio = $("#Seller_Redemptionratio").val();
		//alert(Seller_Redemptionratio)
				$('#Seller_Redemptionratio').val(Seller_Redemptionratio);
				Get_Calculation();
				var Size_flag = $("input[name=Size_flag]:checked").val();
				if(Size_flag==1)
				{
