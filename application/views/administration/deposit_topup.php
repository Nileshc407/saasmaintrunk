            ...
            <div class="col-sm-7">
                <div class="element-wrapper">
                    ...
                    <div class="element-box">
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1"><span class="required_info">*</span> Transaction Amount</label><!--   onkeypress="return isNumberKey2(event)"-->
                            <input type="text" name="Amt_transaction" id="Amt_transaction2" value="" data-error="Enter Transaction Amount" required="required" placeholder="Enter Transaction Amount" class="form-control" />								
