				...
				<div class="row">
					...
					<div class="form-group" id="parent_block"  <?php if($Employee_flag!=1){echo  'style="display:none;"';}?> >
						...
						<div class="row"  <?php if($Comm_type <= 2 ){echo 'style="display:none;"';}?>>
							<div class="col-sm-6">
								<div class="form-group" id="send_to_key"  <?php if($Schedule_comm_for!=3){echo 'style="display:none;"';}?>>
								...
								<div class="form-group" id="send_to_worry"  <?php if( $Schedule_comm_for!=4 ){echo 'style="display:none;"';}?>>
							...
							<div class="col-sm-6"   <?php if(($Comm_type > 2 && $Schedule_comm_for < 5) ){echo  'style="display:block;"';}else{echo  'style="display:none;"';}?>>	
								<br>
						...
						<div class="form-group" id="All_membersBlock"  <?php if($Schedule_comm_for==8){echo 'style="display:block;"';}else{echo 'style="display:none;"';}?> >
						...
						<div class="form-group" id="send_to_tier" <?php if(($Comm_type==3 && $Schedule_comm_for==5) ){echo  'style="display:block;"';}else{echo  'style="display:none;"';}?>>
						<legend><span>Select Business Tier:</span></legend>
						...
						<div class="form-group" id="Business_block"   <?php if(($Comm_type==3 && $Schedule_comm_for==5) ){echo  'style="display:block;"';}else{echo  'style="display:none;"';}?>>
						<legend><span>Select Business Members:</span></legend>
						...
						<div class="form-group" id="send_to_tierInd"   <?php if(($Comm_type==4 && $Employee_flag==0 && $Schedule_comm_for==5) ){echo  'style="display:block;"';}else{echo  'style="display:none;"';}?>>
						...
						<div class="form-group" id="Ind_block2"      <?php if(($Comm_type==4 && $Employee_flag==0 && $Schedule_comm_for==5) ){echo  'style="display:block;"';}else{echo  'style="display:none;"';}?>>
						...
						<div class="form-group" id="Employee_tier_block"   <?php if(($Comm_type==4 && $Employee_flag==1 && $Schedule_comm_for==5) ){echo  'style="display:block;"';}else{echo  'style="display:none;"';}?>>
						...
						<div class="form-group" id="Employee_tier_block2"  <?php if(($Comm_type==4 && $Employee_flag==1 && $Schedule_comm_for==5) ){echo  'style="display:block;"';}else{echo  'style="display:none;"';}?>>
