		  ...
		  <div class="col-lg-12">
			<div class="element-wrapper">
			  ...
			  <div class="element-box">
				...
				<input type="hidden" name="DiXhcmscolruntbVimd" value="<?php echo App_string_encrypt($Fetch_discount_rule->Discount_id); ?>">
				...
				<?php
						...
						<tr>
									<td class="row-actions">
										<a href="<?php echo base_url()?>index.php/Administration/edit_new_discount_rule/?DiXhcmscolruntbVimd=<?php echo App_string_encrypt($row->Discount_id);?>" title="Edit">
