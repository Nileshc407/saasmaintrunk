		  ...
		  <div class="col-lg-12">
			<div class="element-wrapper">
			  ...
			  <div class="element-box">
				...
				<?php 	} ?>
					<!-----------------------------------Flash Messege-------------------------------->
					<?php if($Check_offer_sent==1)
					{
						echo '<span class="required_info" style="color:red;font-size:15px;">This Offer has sent already to Member !!!</span>'; } 
					?>
				...
				<div class="col-sm-6">
				  ...
				  <input type="hidden" name="xwcOfPfeArlcfodje" value="<?php echo App_string_encrypt($results->Offer_code); ?>"/>	
