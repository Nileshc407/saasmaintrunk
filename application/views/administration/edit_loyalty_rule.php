		  ...
		  <div class="col-lg-12">
			...
			$attributes = array('id' => 'formValidate');
				...
				<div class="row">
				  ...
				  <div class="form-group">
					<label for=""><span class="required_info" style="color:red;">* </span>Business/Merchant Name</label>
				...
				<div class="col-sm-6">
				 ...
				 <div class="form-group">
				  ...
				  <?php	} ?>
					...
					<input type="hidden" name="Loyalty_id" value="<?php echo App_string_encrypt($Loyalty_id); ?>" class="form-control" />	
				</div>	
