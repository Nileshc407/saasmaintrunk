		  ...
		  <div class="col-sm-6">
				 ...
				 <div class="form-group">
				  ...
				  <div class="form-group">
						...
						<label for=""><span class="required_info">* </span>Discount Rule Applicable For</label>	
						 ...
						 <div class="row">
							...
							<div class="col-sm-4" >	
							  <div class="form-check" >
								<label class="form-check-label">
								<input class="form-check-input" name="Discount_rule_for" id="Category_level" type="radio"  value="2" onclick="Toggle_discount(this.value);" checked>Menu Group Level</label>
							  </div> 
							 </div> 
							<div class="col-sm-4" >	 
							  <div class="form-check" >
							...
							<div class="col-sm-4" >
							  <div class="form-check" >
								<label class="form-check-label">
								<input class="form-check-input" name="Discount_rule_for" type="radio"  id="Bill_level"  value="1"   onclick="Toggle_discount(this.value);">Overall Bill Level</label>
							  </div>
							</div> 
							...
							<div class="form-group"  id="Bill_block" style="display:none;">
								<div class="col-sm-12" >
					...
					<div class="form-group" id="Bill_block2" style="display:none;">
						
						<label for=""> <span class="required_info">* </span>Criteria Value</label>
						<div class="col-sm-12" >	
							<input class="form-control" type="text" name="Criteria_value" id="Criteria_value"   class="form-control" placeholder="Enter Criteria Value"   data-error="Enter Criteria Value"  onkeypress="return isNumberKey2(event)"  >
						...
						<div class="form-group"  id="Category" >
								...
								<div class="col-sm-12" >
								<select class="form-control select2" name="Category_id[]" id="Category_id"  data-error="Please Select Menu Group" multiple>
						...
						<div class="form-group"  id="Item_Category" style="display:none;><!--style="display:none;"-->
								<label for=""><span class="required_info" >* </span>Menu Group</label>
								
								<select class="form-control" name="Item_Category_id" id="Item_Category_id"  data-error="Please Select Menu Group"  onchange="Get_items(this.value);"  >
						...
						if($results2 != NULL)
						{
							foreach($results2 as $row)
							{
								...
								foreach($Seller_details as $seller_val)
								{
									...
									$Encrypt_Discount_id = App_string_encrypt($row->Discount_id);
									$Encrypt_Discount_id = str_replace('+', 'X', $Encrypt_Discount_id);
									$_SESSION[$Encrypt_Discount_id]=$row->Discount_id;
							?>
						<tr>
									<td>
										<a href="<?php echo base_url()?>index.php/Administration/edit_new_discount_rule/?DiXhcmscolruntbVimd=<?php echo $Encrypt_Discount_id;?>" title="Edit">
...
/*****************Show Hide*****************/
	function Toggle_discount(val)
	{
		...
		{
			// $("#Item_Category").show();
			document.getElementById("Item_Category").style.display='';
