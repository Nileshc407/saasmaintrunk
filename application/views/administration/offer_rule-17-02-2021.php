					  ...
					  <div class="panel-group">
						<div class="panel panel-default">
						  ...
						  <div class="panel-body">
								...
								<select class="form-control" name="Company_merchandise_item_id[]" id="Company_merchandise_item_id" multiple>
						...
						<div class="panel panel-default">
						  ...
						  <div class="panel-body">
							<div class="form-group" id="Free_item_name_Div" style="display:block">
									...
									<select class="form-control" required name="Free_item_id" id="Free_item_id">
