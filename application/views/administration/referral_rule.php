		  ...
		  <div class="col-sm-12">
			<div class="element-wrapper">
			 ...
			 <!-----------------------------------Flash Messege-------------------------------->
				...
				echo form_open('Administration/insert_referral_rule',$attributes); ?>
<div class="row">				
				<div class="col-sm-6">
				  ...
				  <div class="form-group">
					  ...
					  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  <label class="form-check-label">
							<input type="radio"  class="form-check-input"  name="referral_rule_for" id="inlineRadio1" value="1" onclick="javascript:showhide(this.value);" checked >Enrollment</label>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							
							<label class="form-check-label"><input type="radio"  class="form-check-input"  name="referral_rule_for" id="inlineRadio2" value="2" onclick="javascript:showhide(this.value);"  >Transaction</label>
				  ...
				  <div class="form-group" id="cust">
						<label for=""><span class="required_info">*</span> Auto Topup for New Member</label>
						<input type="text" name="tonewcust" id="tonewcust" value="" class="form-control" placeholder="Enter Topup for New Member"   data-error="Please Enter Auto Topup for New Member"  required="required"  onkeypress="return isNumberKey2(event)"/>
				  ...
				  <div class="form-group">
						<label for=""><span class="required_info">*</span>Auto Topup for Referee</label>
						<input type="text" name="toRefree" id="toRefree" value="" class="form-control" placeholder="Enter Topup for Referee"   data-error="Please Enter Auto Topup for Referee"  required="required"     onkeypress="return isNumberKey2(event)"/>
					...
					<div class="form-group">
						...
						<div class="input-group">
							<input type="text" name="from_date" id="datepicker1" class="single-daterange form-control" placeholder="Rule Start Date"    required="required"  data-error="Please Select Rule Start Date"  />			
					...
					<div class="form-group">
						...
						<div class="input-group">
							<input type="text" name="to_date" id="datepicker2" class="single-daterange form-control" placeholder="Rule End Date" required="required"  data-error="Please Select Rule End Date"  />			
							<span class="input-group-addon" id="basic-addon2"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span></span>
							<div class="help-block form-text with-errors form-control-feedback"></div>
						</div>
					</div>
							...
							?>
								<tr >
									<td class="row-actions">
										...
										<a href="<?php echo base_url()?>index.php/Administration/edit_referral_rule/?rvTefiXd=<?php echo App_string_encrypt($row->refid);?>" title="Edit">
											<i class="os-icon os-icon-ui-49"></i>
										</a>
										<?php } if($_SESSION['Privileges_Delete_flag']==1){ ?>
										<a href="javascript:void(0);" onclick="delete_me('<?php echo $row->refid;?>','<?php echo $row->First_name; ?>','','Administration/delete_referral_rule/?refid');" title="Delete" class="danger" data-target="#deleteModal" data-toggle="modal" >
