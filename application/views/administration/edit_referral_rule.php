		...
		<div class="row">
		  <div class="col-lg-12">
			<div class="element-wrapper">
			  ...
			  <div class="element-box panel">
				...
				<div class="col-sm-6">
				  ...
				  <div class="form-group">
					...
					<input type="hidden" name="old_seller_id" value="<?php echo App_string_encrypt($results->Seller_id);?>">
						<input type="hidden" name="old_referral_rule_for" value="<?php echo App_string_encrypt($results->Referral_rule_for);?>">
				  ...
				  <div class="form-group" id="cust" <?php if( $results->Referral_rule_for!=1){ echo 'style="display:none;"';}?>>
						...
						<input type="text" name="tonewcust" id="tonewcust" class="form-control" placeholder="Enter Topup for New Member"  onkeypress="return isNumberKey2(event)" data-error="Please Enter Auto Topup for New Member" value="<?php if( $results->Referral_rule_for==1){echo $results->Customer_topup;}?>"/>	
						<div class="help-block form-text with-errors form-control-feedback"></div>						
					</div>
				  <div class="form-group">
			  ...
			  <input type="hidden" name="rvTefiXd" class="form-control" value="<?php echo App_string_encrypt($results->refid);?>"/>
