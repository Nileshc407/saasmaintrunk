		  ...
		  <div class="col-sm-12">
			...
			<?php 	} ?>
					...
					<?php  $attributes = array('id' => 'formValidate');
						echo form_open('Masterc/update_paymenttype',$attributes); ?>
						
					  <div class="form-group">
						<label for=""><span class="required_info">* </span>Payment Type</label>
						<input class="form-control" type="text" name="Payment_type" id="Payment_type" placeholder="Enter payment type" data-error="Please enter payment type" value="<?php echo $results->Payment_type; ?>" required="required">
					  ...
					  <div class="form-group"> 
						...
						<textarea class="form-control" rows="3" name="Payment_description" id="Payment_description" placeholder="Enter payment type description" data-error="Please enter payment type description" required="required"><?php echo $results->Payment_description; ?></textarea>
					  ...
					  <div class="form-buttons-w">
						...
						<input type="hidden" name="Payment_type_id" value="<?php echo $results->Payment_type_id; ?>" />
					  </div>
					<?php echo form_close(); ?>		  
				  </div>
				</div>
