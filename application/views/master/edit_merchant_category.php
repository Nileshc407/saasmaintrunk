			  ...
			  <div class="element-box">
			   <?php
				...
				<?php $attributes = array('id' => 'formValidate');
					echo form_open('Masterc/update_merchant_category',$attributes); ?>
				<div class="row">
					<div class="col-sm-6">
				 ...
				 <div class="form-group">
					...
					<select class="form-control" name="sellerId" id="sellerId" required="required" data-error="Please select merchant name">
					  <option value="<?php echo $results->Seller; ?>"><?php echo $Seller_details->First_name." ".$Seller_details->Last_name; ?></option>
					</select>
				  ...
				  <div class="form-group">
					...
					<input class="form-control"  name="item_type_no" id="item_type_no"  type="text"  placeholder="Enter Merchant Category Code"  required="required" data-error="Please enter merchant category code" value="<?php echo $results->Item_type_code; ?>"  readonly>
					<div class="help-block form-text with-errors form-control-feedback" id="merchant_code"></div>
				  </div> 
				  
					<div class="form-group">
					<label for=""> <span class="required_info" style="color:red;">*</span> Merchant Category Name </label>								
					<input class="form-control"  name="item_type_name" id="item_type_name"  type="text"  placeholder="Enter Merchant Category Name"  required="required" data-error="Please enter merchant category name" value="<?php echo $results->Item_category_name; ?>">
					<div class="help-block form-text with-errors form-control-feedback"></div>
				  </div> 
				  </div>
					<div class="col-sm-6">
					   ...
					   <div class="form-group">
						...
						<textarea class="form-control" rows="11" name="item_desc" id="item_desc"  type="text"  placeholder="Enter Merchant Category Description"> <?php echo $results->Item_typedesc; ?></textarea>
				  ...
				  <input type="hidden" name="Item_category_id" value="<?php echo $results->Item_category_id; ?>" />
