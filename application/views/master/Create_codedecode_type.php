		   ...
		   <div class="col-sm-12">
			<div class="element-wrapper">
			  ...
			  <div class="element-box">
				...
				echo form_open('Masterc/CodeDecodeType',$attributes); ?>
				  <div class="col-sm-8">
				  <div class="form-group">
					<label for=""> <span class="required_info">* </span> Code Decode Type </label>								
					<input class="form-control"  name="Code_decode_type" id="Code_decode_type"  type="text"  placeholder="Enter Code Decode Type" required="required" data-error="Please enter code decode type">
