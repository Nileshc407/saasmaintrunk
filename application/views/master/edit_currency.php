		  ...
		  <div class="col-sm-12">
			...
			<?php 	} ?>
					...
					<?php  $attributes = array('id' => 'formValidate');
						echo form_open('Masterc/update_currency',$attributes); ?>
						
					  <div class="form-group">
						<label for=""><span class="required_info">* </span>Currency Nation</label>
						<input class="form-control" type="text" name="Currency_nation" id="Currency_nation" placeholder="Enter currency nation" data-error="Please enter currency nation" value="<?php echo $results->Country_name; ?>" required="required">
					  ...
					  <div class="form-group">
						...
						<input class="form-control" type="text" name="Currency_name" id="Currency_name" placeholder="Enter currency name" data-error="Please enter currency name" value="<?php echo $results->Currency_name; ?>" required="required">
					  ...
					  <div class="form-group">
						...
						<input class="form-control" type="text" name="currency_symbol" id="currency_symbol" placeholder="Enter currency symbol" data-error="Please enter currency symbol" value="<?php echo $results->Symbol_of_currency; ?>" required="required">
					  ...
					  <div class="form-group">
						...
						<input class="form-control" type="text" name="dial_code" id="dial_code" placeholder="Enter dial code" data-error="Please enter dial code" value="<?php echo $results->Dial_code; ?>" required="required">
					  ...
					  <div class="form-buttons-w">
						...
						<input type="hidden" name="Country_id" value="<?php echo $results->Country_id; ?>" />
					  </div>
					<?php echo form_close(); ?>		  
				  </div>
				</div>
