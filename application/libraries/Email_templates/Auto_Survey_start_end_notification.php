					...
					<table style="WIDTH: 100%;border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class=rtable cellSpacing=0 cellPadding=0 align=left>
						<tr style="HEIGHT: 10px">
							<td style="BORDER-BOTTOM: medium none; TEXT-ALIGN: center; BORDER-LEFT: medium none; PADDING-BOTTOM: 5px; BACKGROUND-COLOR: #feffff; PADDING-LEFT: 15px; WIDTH: 100%; PADDING-RIGHT: 15px; VERTICAL-ALIGN: middle; BORDER-TOP: medium none; BORDER-RIGHT: medium none; PADDING-TOP: 5px">
											...
											<table border=0 cellSpacing=0 cellPadding=0 style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
												<tr>
													<td style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BACKGROUND-COLOR: transparent; BORDER-TOP: medium none; BORDER-RIGHT: medium none">
														<IMG style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BACKGROUND-COLOR: transparent; DISPLAY: block; BORDER-TOP: medium none; BORDER-RIGHT: medium none;border:0; outline:none; text-decoration:none;" class=rimg border=0 src="<?php echo $Base_url; ?>images/reminder.jpg" width=580 height=200 hspace="0" vspace="0">
													</td>
												</tr>
											</table>
										</td>
								...
								<strong>
									We value your suggestion(s) and feedback. Request you to please take our Latest Survey: '$Survey_name'
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size: 12px; line-height: 22px;">
										<tr>
											<td style="font-size: 12px; color: black; font-family: Helvetica; text-align: left; width: 50%; line-height: 25px; padding: 5px; border: 1px solid #eee;"><b>Survey Name:</b></td>
											
											<td style="font-size: 12px; color: black; font-family: Helvetica; text-align: left; width: 50%; line-height: 25px; padding: 5px; border: 1px solid #eee;"><b>$Survey_name</b></td>
										</tr>
										
											$Contents
										
										<tr>
											<td style="font-size: 12px; color: black; font-family: Helvetica; text-align: left; width: 50%; line-height: 25px; padding: 5px; border: 1px solid #eee;"><b>Start Date:</b></td>
											
											<td style="font-size: 12px; color: black; font-family: Helvetica; text-align: left; width: 50%; line-height: 25px; padding: 5px; border: 1px solid #eee;"><b>$Start_date</b></td>
										</tr>
										<tr>
											<td style="font-size: 12px; color: black; font-family: Helvetica; text-align: left; width: 50%; line-height: 25px; padding: 5px; border: 1px solid #eee;"><b>End Date:</b></td>
											
											<td style="font-size: 12px; color: black; font-family: Helvetica; text-align: left; width: 50%; line-height: 25px; padding: 5px; border: 1px solid #eee;"><b>$End_date</b></td>
										</tr>
										
										<tr>
											<td style="font-size: 12px; color: black; font-family: Helvetica; text-align: left; width: 50%; line-height: 25px; padding: 5px; border: 1px solid #eee;" colspan="2"><b>
											You can use from Member Website or APP and use the Take Survey.
													<p>$Survey_link</p></b>
											</td>
										</tr>
									</table>
