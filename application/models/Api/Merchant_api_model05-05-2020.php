...
/******************Nilesh Start*****************/
   ...
   {		
		...
		function Get_order_evouchers_details($Order_no,$Manual_bill_no,$CompanyId,$Card_id)
		{ 
			...
			$this->db->where(array('B.Card_id' => $Card_id,'B.Company_id'=>$CompanyId,'B.Trans_type'=>12));
		...
		function Get_online_order_details($Order_no,$Manual_bill_no,$Company_id,$Card_id)
		{ 
			...
			$this->db->where(array('T.Card_id' => $Card_id,'T.Company_id'=>$Company_id,'T.Trans_type'=>12));
		...
		function Update_Order_Status($data,$Membership_id,$Company_id,$Order_no,$Manual_bill_no)
		{
			// $this->db->where(array('Company_id' => $Company_id, 'Card_id' => $Membership_id, 'Bill_no' => $Order_no, 'Trans_type' => 12));
			$this->db->where(array('Company_id' => $Company_id, 'Card_id' => $Membership_id, 'Trans_type' => 12));
