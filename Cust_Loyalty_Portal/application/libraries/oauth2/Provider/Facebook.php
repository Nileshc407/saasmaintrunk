...
class OAuth2_Provider_Facebook extends OAuth2_Provider
{
	...
	{
		$url = 'https://graph.facebook.com/me?fields=id,name,email,last_name,age_range,link,gender,locale,picture,timezone,updated_time,verified&'.http_build_query(array(
		...
		// var_dump($user);
		// $graphObject['tagged_places']->data[0]->id;
...
//id,name,email,last_name,age_range,link,gender,locale,picture,timezone,updated_time,verified
?>
