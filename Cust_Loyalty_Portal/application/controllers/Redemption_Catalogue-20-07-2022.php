		...
		//	echo "------total_row------".$total_row."----<br>";
			...
			/*********************************XOXODAY****************************************************/
				...
				curl_setopt_array($curl, array(
				  ...
				  CURLOPT_URL => "https://stagingaccount.xoxoday.com/chef",
				  ...
				  CURLOPT_POSTFIELDS => array('product_id' => '','country_name' => 'India','currency_code' => 'INR','limit' => '20','offset' => '0','username' => '','password' => '','categories' => ''),
			...
			// echo"<br>--Merchandize_category_id-00--".$Merchandize_category_id;
				...
				// echo"<br>--filtersarray---";
				
				// print_r($filtersarray);
				
				// $filtersarray = json_encode($filtersarray);
				// print_r($filtersarray);
				// die;
				$variablesarray["data"]= array('limit'=>'500','page'=>'0','includeProducts'=>'','excludeProducts'=>'','filters'=>$filtersarray);  
				// echo"<br>--variablesarray---";
					...
					$curl = curl_init();
						curl_setopt_array($curl, array(
						  ...
						  CURLOPT_HTTPHEADER => array(
							'Authorization: Bearer ',
	...
	public function Redemption_done()
	{
		...
		$Tier_redemption_ratio = $data["Tier_details"]->Tier_redemption_ratio;
			...
			if($Current_redeem_points<=$Total_balance)
			{
				...
				$email=$User_email_id;
				$variablesarray["data"]= array('productId'=>$productId,'quantity'=>$quantity,'denomination'=>$denomination,'email'=>$email,'tag'=>"",'poNumber'=>$poNumber,'notifyAdminEmail'=>1,'notifyReceiverEmail'=>1);  
										...
										if(is_array($value1)){											
												foreach($value1 as $value2){									
													...
													$voucher_codes[] = $value2['voucherCode'];
														...
														$Paid_amount = $Total_points1 / $Tier_redemption_ratio;
														...
														$Insert_trasaction_data = array(
															...
															// 'Weight' => $this->input->post('Item_Weight'),
															// 'Weight_unit_id' => $this->input->post('Weight_unit_id'),			
															'Cost_payable_partner' => $orderTotal,			
