...
<section class="content">
    ...
    <div id="content">		
        <div class="row products cd-container" id="FilterResult">
            <!--<ul class="cd-items cd-container row list-unstyled" id="FilterResult"> -->           
<?php
  // }
?>
            <br><br>	
              ...
              if ($Redemption_Items != NULL) {
                foreach ($Redemption_Items as $product) {
                  ...
                  if ($Count_item_offer >= 1) {
                    ?>
                       <!-- <img src="<?php echo $this->config->item('base_url2') ?>images/special-offers1.png" style="height:70px;margin-bottom:-22px;z-index: 1;margin-top: -46px;">-->
      ...
      ?>
                          ...
                          <div class="text">
                              <h5 style="min-height: 35px;" ><a href="<?php echo base_url() ?>index.php/Shopping/product_details/?product_id=<?php echo urlencode($Company_merchandise_item_id); ?>"><?php echo $product['Merchandize_item_name']; ?></a></h5>
                              <p class="price">Price - <b><?php echo $Symbol_of_currency; ?></b>&nbsp;<?php echo $Billing_price; ?></p>
                          <?php
      ...
      if (array_key_exists($product['Company_merchandise_item_id'], $Wishlist_item)) {
        ...
        ?>
                                        <button type="button" class="btn btn-template-main" onclick="add_to_wishlist('<?php echo $product["Company_merchandise_item_id"]; ?>', '<?php echo preg_replace('/[^a-zA-Z0-9_ %\[\]\.\(\)%&-]/s', '', $product["Merchandize_item_name"]); ?>', '<?php echo $Billing_price; ?>');" data-toggle="tooltip" data-placement="top" title="Add to wishlist" style="padding: 8.7px 5px;">
                                            <i class="fa fa-heart-o"></i>
                                        </button>
...
<?php if ($Merchandize_category != NULL) { ?>
      ...
      echo 'style="height: 280px; overflow: auto;"';
    } ?> >
...
?>
      ...
      window.location = '<?php echo base_url() ?>index.php/Shopping/?Sort_by_points_flag=' + filter + '&Sort_by_category_flag=' + Merchandize_category + '&Sort_by_merchant_flag=' + merchant + '&Sort_by_brand_flag=' + brand + '&Sort_by_gender_flag=' + gender;
  }
