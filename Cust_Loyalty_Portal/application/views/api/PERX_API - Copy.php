                        ...
                        if($_REQUEST['Membership_id'] != "")
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    $query = "SELECT * FROM lsl_questionaire_master 
                                                INNER JOIN lsl_survey_structure_master
                                                ON lsl_survey_structure_master.Survey_id=lsl_questionaire_master.Survey_id
                                                INNER JOIN lsl_multiple_choice
                                                ON lsl_multiple_choice.Choice_id=lsl_questionaire_master.Choice_id
                                                WHERE lsl_questionaire_master.Survey_id=".$Survey_id;

                                    $query1 = "SELECT * FROM lsl_questionaire_master 
                                                INNER JOIN lsl_survey_structure_master
                                                ON lsl_survey_structure_master.Survey_id=lsl_questionaire_master.Survey_id
		...
		/*---------------------------Check for Duplicate Order No-------------------------*/                    
				...
				//echo "---transaction flag is--4<br>";
									...
									else
									{
										...
										if($_REQUEST['Bill_no'] == "")
										{
											echo json_encode(array("status" => "2085", "status_message" => "Shipping Details are blank"));
											exit;
										}
