            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Gained Points</span>
			   ...
			   <div class="col-md-8">
				  <div class="box box-solid">
					<div class="box-header with-border">
					  <h3 class="box-title">Merchandise Items</h3>
					</div><!-- /.box-header -->
					<div class="box-body">
					  <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
						  <div class="item active">
							<img src="<?php echo base_url()?>dist/images/10.png" alt="First Items">
							<div class="carousel-caption">
							  First Items
							</div>
						  </div>
						  <div class="item">
							<img src="<?php echo base_url()?>dist/images/30.png" alt="Second Items">
							<div class="carousel-caption">
							  Second Items
							</div>
						  </div>
						  <div class="item">
							<img src="<?php echo base_url()?>dist/images/4.jpg" alt="Third Items">
							<div class="carousel-caption">
							  Third Items
							</div>
						  </div>
						  <div class="item">
							<img src="<?php echo base_url()?>dist/images/8.jpg" alt="Fourth Items">
							<div class="carousel-caption">
							  <a href="">Fourth Items</a>
							</div>
						  </div>
						</div>
