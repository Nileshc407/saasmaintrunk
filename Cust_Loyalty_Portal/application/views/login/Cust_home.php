...
?>	
	...
	<section class="content">					
		...
		if($Trans_details_summary !=NULL)
		{
			...
			{
				$Total_Loyalty_pts=round($values["Total_Loyalty_pts"]);
				$Total_bonus_ponus=round($values["Total_bonus_ponus"]);
				$Total_Transfer_points=round($values["Total_Transfer_points"]);
				$Total_reddems=$values["Total_reddems"];
				$Total_purchase_amt=$values["Total_purchase_amt"];
				
				$Total_gained_points = ($Total_Loyalty_pts+$Total_bonus_ponus);
				$Total_used_points = ($Total_reddems+$Total_Transfer_points);
			}
		}
		else
		{
		...
		<?php  if($Enroll_details->Card_id == '0' || $Enroll_details->Card_id== ""){ ?> 
			...
			<div class="col-lg-2 col-xs-6">
				<div class="small-box bg-green">
					<div class="inner">
						<h3 class="text-center" style="font-size: 25px;"><?php echo round($Total_gained_points); ?></h3>
						<p class="text-center">Total Gained <?php echo $Company_Details->Currency_name; ?> </p>
					</div>
				</div>
            </div>	
			<div class="col-lg-2 col-xs-6">
				<div class="small-box bg-red">
					<div class="inner">
						<h3 class="text-center" style="font-size: 25px;"><?php echo round($Total_used_points); ?></h3>
						<p class="text-center">Total Used <?php echo $Company_Details->Currency_name; ?> </p>
					</div>
				</div>
            </div>
				<div class="col-lg-2 col-xs-6">
				...
				<div class="small-box bg-blue">
					<div class="inner">
						<h3 class="text-center" style="font-size: 25px;"><?php echo $Total_purchase_amt; ?></h3>
						<p class="text-center">Total Purchase (<?php echo $Symbol_of_currency; ?>) </p>
					</div>
				</div>
            </div>			
			<!--
			<div class="col-lg-2 col-xs-6">
				<div class="small-box bg-aqua">
					<div class="inner">
						<h3 class="text-center" style="font-size: 25px;"><?php echo round($TotalGainPoints); ?></h3>
		...
		<div class="row">			 
			...
			<div class="col-md-8">
				...
				<div class="col-md-12" >
					...
					<div class="box box-danger">
						...
						<div class="box-header with-border">
							<h3 class="box-title">Our Outlets</h3>
						</div>						
						<div class="box-body" style="min-height: 200px;">
			...
			<div class="col-md-4">
				...
				$offer='0';
				$offer_flag='0';
				foreach($LatestOffers as $row)
				{
					if($row)
					{
						$offer_flag = 1;
						$offer_description = substr($row['Offer_description1'], 0, 255);
						$offer_description .= "......";
						...
						?>
							...
							<div class="box box-success box-solid" id="offer_block">
								<div class="box-header with-border text-center">
									<h3 class="box-title text-center">Latest Offer <?php //echo $row[0]['First_name'].' '.$row[0]['Last_name']; ?></h3>
								</div>
								<div class="box-body">
				...
				?>
					...
					<div class="box box-info box-solid">
						<div class="box-body">
							<p class="text-center">
							<h6 class="text-center">Currently there are no Offers..!!</h6>
							...
							if($count > '0' )
							{
								foreach($Company_TOP3_Auction as $TOP3Auction)
								{
									...
									?>
										...
										<li class="item">
											<div class="product-info" style="margin: 0px;">
												<h6 class="text-center">Currently there are no Auctions !!!</h6>
											</div>
										</li>
