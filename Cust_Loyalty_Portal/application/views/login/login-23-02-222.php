    ...
    <div class="swiper-container parallax-slider">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="bg-img valign" data-background="<?php echo base_url() ; ?>foodassets/img/slider-2.jpg" data-overlay-dark="2">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-8 offset-lg-2 col-md-12">
                                <div class="caption">
                                    <h1>Experience Delight</h1>
									<p>We offer not just our signature services but better experience whenever you get associated with us. It is our privilege to have you as our loyal customer </p>
...
<div class="swiper-slide">
    <div class="bg-img valign" data-background="<?php echo base_url() ; ?>foodassets/img/slide.jpg" data-overlay-dark="2">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2 col-md-12">
                    <div class="caption">
                        <h1>Discover with us </h1>
                        <p>A unique rewards program which opens up a world of opportunities to earn when you experience our services at any of our wellness outlets!</p>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 wow fadeInLeft" data-wow-delay="0.2s">
                <div class="about-content">
                    <div class="about-content-text">
                        ...
                        <h2>Sign Up, Experience and Earn</h2>
						...
						Loyalty points whenever you take any of our signature service or purchase any of our products of our business outlets or just follow us
...
<div class="product-item-details"  style="padding: 30px 20px 57px 20px;">
    <h3>Purchase</h3>
    <p>Get X<?php //echo round($Loyalty_at_transaction); ?> Points when you do your 100 <?php echo $Symbol_of_currency; ?></p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="section-title">
                    <h5>Some of our Health Products</h5>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="contact-box">
                    ...
                    <p><a class="contact-info-link" href="tel:50530722233"><i class="icofont-phone"></i> <?php echo $Company_primary_phone_no; ?>,+91 8390908629</a></p>  
