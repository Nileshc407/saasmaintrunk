...
// echo "<br>localhost ".strlen("http://localhost/saas/saasfoodweb/index.php/Cust_home/export_customer_report/?pdf_excel_flag=1");
// echo "<br>saas ".strlen("https://saashosp.igainapp.in/abcwellness/index.php/Cust_home/export/?pdf_excel_flag=1");
			...
			<div class="login-box-body">			
				...
				<div class="form-group has-feedback">
					...
					<select class="form-control" name="Trans_Type" id="Trans_Type" >
						...
						{
							if($Trans['Trans_type_id']== 1 || $Trans['Trans_type_id']== 2 || $Trans['Trans_type_id']== 3 || $Trans['Trans_type_id']== 4 || $Trans['Trans_type_id']== 7 || $Trans['Trans_type_id']== 8  || $Trans['Trans_type_id']== 13 || $Trans['Trans_type_id']== 14 ||  $Trans['Trans_type_id']== 29){
		...
		<div class="box-body">
			<div class="table-responsive">
				...
				?>
					<tr>					 
						<td colspan="12" >
							<a href="<?php echo base_url()?>index.php/Cust_home/export/?pdf_excel_flag=1">
							...
							<a href="<?php echo base_url()?>index.php/Cust_home/export/?pdf_excel_flag=2">
