		...
		if($error_code == "logout")
		{
			...
			<script>
				BootstrapDialog.show({
						...
						message: 'Profile Updated Successfuly.. And Your Email Id has Changed..Please Login Again..',
						buttons: [{
							label: 'OK',
								action: function(dialog) {
									window.location='<?php echo base_url()?>index.php/Cust_home/logout';
								}
							}]
						});
			</script>
...
<?php
	$attributes = array('id' => 'myProfile');
	echo form_open_multipart('Cust_home/updateprofile',$attributes); ?>
		<div class="row">
            <div class="col-md-3">
					...
					<div class="box-body box-profile">	
						...
						<ul class="list-group list-group-unbordered">
							...
							<li class="list-group-item"> 
								...
								?>
								<br><br><br><br><br><b id="profile">Profile Status</b><br>
							</li>
							<li class="list-group-item">
						...
						<div class="box box-primary">
							<div class="box-body">
								...
								<div class="form-group has-feedback">
									<label for="inputName" class="col-sm-5 control-label"><span class="required_info">* &nbsp;</span>First Name</label>
								...
								<div class="form-group has-feedback">
									 <label for="inputName" class="col-sm-5 control-label"><span class="required_info">* &nbsp;</span>Last Name</label>
								...
								<div class="form-group has-feedback" id="has-feedbackEmail"> 
									<label for="inputEmail" class="col-sm-5 control-label"><span class="required_info">* &nbsp;</span>Email</label>                      
								...
								<div class="form-group has-feedback" id="has-feedbackPhno">
									<label for="inputName" class="col-sm-5 control-label" style="width:100%;"><span class="required_info">* &nbsp;</span>Phone No
								...
								<div class="form-group has-feedback">
									...
									<input type="text" name="Experience" class="form-control" id="Experience" value="<?php echo $Enroll_details->Experience?>" placeholder=" Experience" onkeyup="this.value=this.value.replace(/\D/g,'')" maxlength='2'>
								</div>
								<div class="form-group has-feedback">
									<label for="currentAddress" class="col-sm-5 control-label"><span class="required_info">* &nbsp;</span>Address</label>
									<textarea class="form-control" id="currentAddress" rows="4" cols="50" name="currentAddress" placeholder="Address" required><?php echo App_string_decrypt($Enroll_details->Current_address); ?></textarea>
								</div>
					...
					<div class="col-md-6">				
						<div class="box box-primary">
							...
							<!----------------------AMIT 17-11-2017-------START------------------->
								...
								<div class="form-group has-feedback">
									<label for="startDate" class="col-sm-5 control-label">Gender(Male/Female)</label>
					...
					<div class="modal-content">
					  ...
					  <div class="modal-body">
						  <div class="form-group has-feedback" id="has-feedback11">
							  ...
							  <input type="password" class="form-control" onkeyup="this.value=this.value.replace(/\D/g,'')" name="old_pin" id="old_pin" placeholder="Old Pin" maxlength='4'>
					    ...
					    <div class="form-group has-feedback" id="has-feedback21">
                          ...
                          <input type="password" class="form-control" name="new_pin" onkeyup="this.value=this.value.replace(/\D/g,'')"  id="new_pin" placeholder="New Pin"  maxlength='4'>
					    ...
					    <div class="form-group has-feedback" id="has-feedback31">
                          ...
                          <input type="password" class="form-control" name="confirm_pin"  onkeyup="this.value=this.value.replace(/\D/g,'')" id="confirm_pin" placeholder="Confirm Pin"  maxlength='4'>
...
function Change_password(old_Password,new_Password,confirm_Password)
{
	...
	else 
	{
		...
		({
			type: "POST",
			data:{old_Password:old_Password,new_Password:new_Password,confirm_Password:confirm_Password,[csrfName]:csrfHash},
			url: "<?php echo base_url()?>index.php/Cust_home/changepassword",
			success: function(data)
			{
				if(data == 1)
				{
					window.location='<?php echo base_url()?>index.php/Cust_home/logout?ch=1';
					/* 
					BootstrapDialog.show({
					closable: false, 
					title: 'Application Information',
...
function Change_hobbies()
{
	...
	$.ajax({
		...
		type: 'post',
	   data:{new_hobbies:checkValues,[csrfName]:csrfHash
...
function Change_pin(old_pin,new_pin,confirm_pin)
{
	...
	else 
	{
		...
		({
			type: "POST",
			data:{ old_pin:old_pin,new_pin:new_pin,confirm_pin:confirm_pin,[csrfName]:csrfHash},
...
{	
	...
	else
	{
		$.ajax({
			type: "POST",
			data: {old_Password: old_Password,[csrfName]:csrfHash},
...
$('#old_pin').blur(function()
{
	...
	else
	{
		$.ajax({
			type: "POST",
			data: { old_pin: old_pin,[csrfName]:csrfHash},
