					...
					<div class="col-md-4">
						<div class="box box-widget widget-user-2">
							<div class="widget-user-header bg-green">
								...
								<h5 class="widget-user-desc"><?php echo App_string_decrypt($Merchant['Current_address']); ?></h5>
							</div>
							
							<div class="box-footer no-padding">
								<ul class="nav nav-stacked">
									<li><a href="javascript:void(0);"><strong>City</strong> <span class="pull-right"><?php if($Merchant['City_name']==''){echo '-';}echo $Merchant['City_name']; ?></span></a></li>
									<li><a href="javascript:void(0);"><strong>District</strong> <span class="pull-right"><?php if($Merchant['District']==''){echo '-';} echo $Merchant['District']; ?></span></a></li>
									<li><a href="javascript:void(0);"><strong>State</strong> <span class="pull-right"><?php if($Merchant['State_name']==''){echo '-';}echo $Merchant['State_name']; ?></span></a></li>
									<li><a href="javascript:void(0);"><strong>Phone Number</strong> <span class="pull-right"><?php  if($Merchant['Phone_no']==''){echo '-';}echo App_string_decrypt($Merchant['Phone_no']); ?></span></a></li>
