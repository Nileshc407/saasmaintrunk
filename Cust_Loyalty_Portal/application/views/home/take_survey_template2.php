					...
					<div class="tab-content" id="tab12">			
											...
											<div class="checkRadioContainer">
												...
												?>											
													<div class="form-group">
														<textarea class="form-control" id="textbox_<?php echo $Question_id; ?>" rows="4" cols="50" name="<?php echo $Question_id; ?>" ></textarea>
													</div>
												<?php 
												}
						...
						<div class="tab-pane" role="tabpanel" id="complete">
							...
							<ul class="list-inline pull-left">
								...
								?>
								<input type="text" name="Survey_id" value="<?php echo $survey_id; ?>" />
								<input type="text" name="Company_id" value="<?php echo $gv_log_compid; ?>" />
								<input type="text" name="Enroll_id" value="<?php echo $Enrollment_id; ?>" />
								<input type="text" name="Survey_data" value="<?php echo $Survey_data1; ?>" />							
							</ul>
						</div>
