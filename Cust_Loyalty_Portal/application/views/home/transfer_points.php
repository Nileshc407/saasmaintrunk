...
<h1>Transfer <?php echo $Company_Details->Currency_name; ?> </h1>
</section>
                ...
                <!-- form start -->
                  <div class="box-body">
					<div class="form-group has-feedback">
                      <label for="exampleInputEmail1" id="lab">Enter To Membership ID</label>
					  <span class="required_info" style="color:red;font-size:0.8em;"><br>(Enter Membership ID or Phone No. without Country Code)</span>
					  ...
					  <span class="glyphicon" id="glyphicon3" aria-hidden="true" style="margin-top:19px;"></span>
...
$('#Membership_id').blur(function()
{
	...
	if(Membership_id != "" && Company_id != "")
	{
		$.ajax({
			type: "POST",			 
			data: {Membership_id: Membership_id, Company_id:Company_id, Login_Enrollement_id:Login_Enrollement_id,[csrfName]:csrfHash},
