...
<?php echo form_open_multipart('Cust_home/merchantoffers'); ?>			
	...
	<?php 
                ...
                <div class="box-header with-border">
                  <h3 class="box-title">Outlet Campaigns</h3>                 
                </div>         		
				<div class="row">	
					<?php 
					if($SellerLoyaltyOffers != NULL){
						foreach($SellerLoyaltyOffers as $LTY_Offers) 
					{
							...
							<div class="widget-user-header" id="offerDiv">					
								<div class="widget-user-image">
									...
									<h5 style="line-height: 1.5em; height: 3em;       
										overflow: hidden;" class="widget-user-desc"><?php echo App_string_decrypt($LTY_Offers[0]['Current_address']); ?></h5>	
								</div>
							</div>							
							<div class="box-footer no-padding">
								<ul class="nav nav-stacked">
									
									<li><a href="javascript:void(0);"><strong>City</strong> <span class="pull-right"><?php if($LTY_Offers[0]['city_name']==''){echo '-';} echo $LTY_Offers[0]['city_name']; ?></span></a></li>
									<li><a href="javascript:void(0);"><strong>District</strong> <span class="pull-right"><?php if($LTY_Offers[0]['District']==''){echo '-';}echo $LTY_Offers[0]['District']; ?></span></a></li>
									<li><a href="javascript:void(0);"><strong>State</strong> <span class="pull-right"><?php if($LTY_Offers[0]['state_name']==''){echo '-';}echo $LTY_Offers[0]['state_name']; ?></span></a></li>
									<li><a href="javascript:void(0);"><strong>Phone Number</strong> <span class="pull-right"><?php if($LTY_Offers[0]['Phone_no']==''){echo '-';}echo App_string_decrypt($LTY_Offers[0]['Phone_no']); ?></span></a></li>	
					...
					<div class="box box-widget widget-user-2">
						<div class="widget-user-header" id="offerDiv">
							<div class="widget-user-image">
								...
								<h5 style="line-height: 1.5em; height: 3em; overflow: hidden;" class="widget-user-desc" ><?php echo App_string_decrypt($Referral_Offers[0]['Current_address']); ?></h5>	
							</div>
						</div>							
						<div class="box-footer no-padding"> 
							<ul class="nav nav-stacked">
								<li><a href="javascript:void(0);"><strong>City</strong> <span class="pull-right"><?php if($Referral_Offers[0]['city_name']==''){echo '-';}echo $Referral_Offers[0]['city_name']; ?></span></a></li>
								<li><a href="javascript:void(0);"><strong>District</strong> <span class="pull-right"><?php if($Referral_Offers[0]['District']==''){echo '-';}echo $Referral_Offers[0]['District']; ?></span></a></li>
								<li><a href="javascript:void(0);"><strong>State</strong> <span class="pull-right"><?php if($Referral_Offers[0]['state_name']==''){echo '-';}echo $Referral_Offers[0]['state_name']; ?></span></a></li>
								<li><a href="javascript:void(0);"><strong>Phone Number</strong> <span class="pull-right"><?php echo App_string_decrypt($Referral_Offers[0]['Phone_no']); ?></span></a></li>	
		...
		<?php 
			...
			?>
			 <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Outlet Communication Offers</h3>                 
                </div>         		
			<div class="row">
			<?php 
				foreach($SellerCommunicationOffers as $COMM_Offers) 
					...
					<div class="box box-widget widget-user-2">
						<div class="widget-user-header" id="offerDiv">
							<div class="widget-user-image">
								...
								<h5 style="line-height: 1.5em; height: 3em; overflow: hidden;" class="widget-user-desc"><?php echo App_string_decrypt($COMM_Offers[0]['Current_address']); ?></h5>	
							</div>
						</div>						
						<div class="box-footer no-padding">  
							<ul class="nav nav-stacked">	
								<li><a href="javascript:void(0);"><strong>City</strong> <span class="pull-right"><?php if($COMM_Offers[0]['city_name']==''){echo '-';}echo $COMM_Offers[0]['city_name']; ?></span></a></li>
								<li><a href="javascript:void(0);"><strong>District</strong> <span class="pull-right"><?php if($COMM_Offers[0]['District']==''){echo '-';}echo $COMM_Offers[0]['District']; ?></span></a></li>
								<li><a href="javascript:void(0);"><strong>State</strong> <span class="pull-right"><?php if($COMM_Offers[0]['state_name']==''){echo '-';}echo $COMM_Offers[0]['state_name']; ?></span></a></li>
								<li><a href="javascript:void(0);"><strong>Phone Number</strong> <span class="pull-right"><?php if($COMM_Offers[0]['Phone_no']==''){echo '-';}echo App_string_decrypt($COMM_Offers[0]['Phone_no']); ?></span></a></li>								
	...
	<?php   } 
			if($LTY_Offers_flag==0 && $Referral_Offers_flag==0 && $COMM_Offers_flag==0 )
			{
			?>
			 <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">No Offers Yet !!!</h3>                 
                </div> 
			<?php   } ?>
	</section>	
