						...
						<div class="box box-widget widget-user-2">
							...
							<div class="box-footer no-padding">
								<ul class="nav nav-stacked">
									...
									<li><a href="javascript:void(0);"><strong>Phone Number</strong> <span class="pull-right"><?php echo App_string_decrypt($LTY_Offers[0]['Phone_no']); ?></span></a></li>	
					...
					<div class="box box-widget widget-user-2">
						...
						<div class="box-footer no-padding">  
							<ul class="nav nav-stacked">	
								...
								<li><a href="javascript:void(0);"><strong>Phone Number</strong> <span class="pull-right"><?php echo App_string_decrypt($COMM_Offers[0]['Phone_no']); ?></span></a></li>								
