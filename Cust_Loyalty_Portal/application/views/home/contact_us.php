...
{  
		...
		{ 
			...
			for(var i=0;i<msg.length;i++)
			{
				...
				{ ?>
					var message ="&nbsp&nbsp Sorry, There is no any user online Please contact on Call center Number, Or Support Email - <?php echo '<b><u>'.App_string_decrypt($support_email).'</u></b>'; ?>";
		<?php	}
				?>
				}
