...
// echo 'Expiry_license '.$_SESSION['Expiry_license'];
?>	
			 ...
			 <div class="row products cd-container" id="FilterResult">
				...
				if($Redemption_Items != NULL)
				{
					...
					?>
						...
						<?php if($product['Merchandize_item_type']== 43 ) {
											...
											<div class="product" style="height:450px;">
												...
												<div class="text">
													<h5 style="line-height: 1.5em; height: 3em;       
														overflow: hidden;">
															<a href="<?php echo base_url()?>index.php/Redemption_Catalogue/Merchandize_Item_details/?Company_merchandise_item_id=<?php echo urlencode($Company_merchandise_item_id); ?>"> <?php echo $product['Merchandize_item_name']; ?> </a> </h5>
														<p class="price"><?php  
									...
									<div class="col-md-3 ">
										<br>
											<div class="product" style="height:450px;">
												...
												<div class="text">
														<h5 style="line-height: 1.5em; height: 3em;       
														overflow: hidden;"><a href="<?php echo base_url()?>index.php/Redemption_Catalogue/Merchandize_Item_details/?Company_merchandise_item_id=<?php echo urlencode($Company_merchandise_item_id); ?>"> <?php echo $product['Merchandize_item_name']; ?> </a> </h5>
														<p class="price"><?php  
														if($product['Size_flag'] == 1) 
														{ 
															$Get_item_price = $ci_object->Redemption_Model->Get_item_details($Company_id,$product['Company_merchandize_item_code']);	
