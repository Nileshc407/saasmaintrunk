...
<?php $this->load->view('header/loader');?>
 <?php echo form_open_multipart('Cust_home/readnotifications');  ?>
              ...
              <div class="box box-solid">                
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class="active"><a href="<?php echo base_url()?>index.php/Cust_home/readnotifications"><i class="fa fa-envelope-o"></i> Read<span class="label label-primary pull-right"><?php echo $ReadNotificationsCount->Read_noty;?></span></a></li>                    
