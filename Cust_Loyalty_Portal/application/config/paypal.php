 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'akshym_api1.miraclecartes.com' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? '4HLAUKQPFH38B7YH' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'AWPyFQFM9zGd4YI1vON52H9uMk7mAqQjcQghGR1Sg1xZjjCSa4n93i52' : 'PRODUCTION_SIGNATURE_GOES_HERE';
 ...
 */
$config['DeveloperEmailAccount'] = 'akshaym@miraclecartes.com';
