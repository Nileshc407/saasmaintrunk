   ...
   public function merchant_selected_item_list($MerchandiseCatId,$limit,$start)
  {
   ...
   function insert_cust_notification($data,$insert_flag)
	...
	{	  
		...
		$edit_query = "SELECT Pyament_expiry_date FROM igain_saas_company_billing_payment_details WHERE Company_id='".$Company_id."' AND Payment_status='".$Status."' order by Payment_id desc LIMIT 1";
