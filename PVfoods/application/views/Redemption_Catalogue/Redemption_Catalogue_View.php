...
<section class="content">
	...
	<?php //echo form_error('Company_merchandize_item_code'); ?>
								...
								<div class="col-md-3 "><br>
									<div class="product" style="height:450px;">
										...
										<div class="text">
											...
											<div class="text">
													<button type="button" class="btn btn-template-main" onclick="add_to_cart('<?php echo $product['Company_merchandize_item_code']; ?>','<?php echo $product['Delivery_method']; ?>',location_<?php echo $product['Company_merchandise_item_id']; ?>.value,'<?php echo $product['Merchandize_item_name']; ?>','<?php echo $Billing_price_in_points; ?>','<?php echo $Item_size; ?>',<?php echo $product['Company_merchandise_item_id']; ?>,<?php echo $product['Item_Weight']; ?>,<?php echo $product['Weight_unit_id']; ?>);get_item_list();" style="margin-left: -6px;">
										...
										<br>
											<div class="product" style="height:450px;">
												...
												<?php } ?>
													...
													<div class="text">
															<button type="button" class="btn btn-template-main" onclick="add_to_cart('<?php echo $product['Company_merchandize_item_code']; ?>','<?php echo $product['Delivery_method']; ?>',location_<?php echo $product['Company_merchandise_item_id']; ?>.value,'<?php echo $product['Merchandize_item_name']; ?>','<?php echo $Billing_price_in_points; ?>','<?php echo $Item_size; ?>',<?php echo $product['Company_merchandise_item_id']; ?>,<?php echo $product['Item_Weight']; ?>,<?php echo $product['Weight_unit_id']; ?>);get_item_list();">
																<i class="fa fa-shopping-cart"></i> <?php echo ('Add to cart'); ?>
															</button>		
													</div>	
												</div>	
...
function add_to_cart(Company_merchandize_item_code,Delivery_method,location,Merchandize_item_name,Points,Item_size,Company_merchandise_item_id,Item_Weight,Weight_unit_id)
{
		...
		else
		{
			...
			{	
				...
				$.ajax({
				type: "POST",
				// data: { Company_merchandize_item_code:Company_merchandize_item_code, Delivery_method:Checked_Delivery_method, location:location, Points:Points,Current_redeem_points:Current_redeem_points,Total_balance:Total_balance,Size:Item_size,Item_Weight:Item_Weight,Weight_unit_id:Weight_unit_id,item_id:Company_merchandise_item_id },
