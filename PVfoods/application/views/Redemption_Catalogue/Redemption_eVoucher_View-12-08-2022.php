...
// echo"<br>---Redemptionratio---".$Company_Details->Redemptionratio;
...
// echo"<br>---Gift_payment_balance---".$Company_Details->Gift_payment_balance;
...
// echo"--voucher_result-------".print_r($voucher_result['code'])."------<br>";
													...
													<div class="product" style="height:450px;">
														<div class="image">
															<a href="JavaScript:void(0);">
																<img src="<?php echo $value1['imageUrl']; ?>" alt=""  style="height:150px;">
															</a>
															<br>
															<br>
															<p><?php echo $value1['name']; ?></p>
															<p>
															<a href="javascript:void(0);" data-toggle="modal" data-target="#myModal_DS_<?php echo $value1['productId'];?>">| Description |</a>
															<a href="javascript:void(0);" data-toggle="modal" data-target="#myModal_TC_<?php echo $value1['productId'];?>"> T & C |</a>
															
															<?php if($value1['redemptionInstructions']) { ?>
															<a href="javascript:void(0);" data-toggle="modal" data-target="#myModal_HTU_<?php echo $value1['productId'];?>"> How to Use |</a>
															<?php } ?>
																	  ...
																	  <div class="modal-dialog">
																		...
																		<div class="modal-content">
																		  ...
																		  <div class="modal-body text-left">
																			<p><?php echo html_entity_decode($value1['description']); ?></p>
																		  </div>
																...
																<div id="myModal_TC_<?php echo $value1['productId'];?>" class="modal fade" role="dialog">
																		<div class="modal-dialog">
																			...
																			<div class="modal-content">
																			  ...
																			  <div class="modal-body text-left">
																				<p><?php echo html_entity_decode($value1['termsAndConditionsInstructions']); ?></p>
																			  </div>
																			  <div class="modal-footer">
																				<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
																			  </div>
																...
																<div id="myModal_HTU_<?php echo $value1['productId'];?>" class="modal fade" role="dialog">
																	<div class="modal-dialog">
																		...
																		<div class="modal-content">
																			...
																			<div class="modal-body text-left">
																				<p><?php echo html_entity_decode($value1['redemptionInstructions']); ?></p>
																			</div>
																			<div class="modal-footer">
																				<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
																			</div>
																...
																// print_r($value1['valueDenominations']);
																	// $smallest_price= min($value1['valueDenominations']); 
																	$first_price= explode(",",$value1['valueDenominations']); 
																	$smallest_price=$first_price[0];
																	// echo"---smallest_price----".$smallest_price."---<br>";
															...
															<p class="text-center">
																...
																<div class="qty mt-5">
																	...
																	<button type="submit" class="btn btn-template-main" onclick="RemoveQty(<?php echo $value1['productId'];?>);" style="    background: #05083b;border-color: #05083b;">
																	...
																	<button type="submit" class="btn btn-template-main" onclick="AddQty(<?php echo $value1['productId'];?>);" style="    background: #05083b;border-color: #05083b;">
															...
															$Billing_price_in_points = $smallest_price * $Redemptionratio;
															
															
															// $Billing_price_in_points_tier = $Billing_price_in_points * $Tier_redemption_ratio;
															
															$Billing_price_in_points_tier = $Billing_price_in_points * $Redemptionratio;
															
															//echo"---Billing_price_in_points----".$Billing_price_in_points."---<br>";
															//echo"---Billing_price_in_points_tier----".$Billing_price_in_points_tier."---<br>";
															...
															<?php if($Billing_price_in_points != $Billing_price_in_points_tier)
															{
																...
																?>
																<del>Equivalent <?php echo $Company_Details->Currency_name; ?> : <b id="new_changed_points_<?php echo $value1['productId'];?>"><?php 
																// echo ($smallest_price * $Company_Details->Redemptionratio); 
																echo ($smallest_price * $Redemptionratio); 
																?></b></del> 
																<br>
															...
															{ ?>
																		Equivalent <?php echo $Company_Details->Currency_name; ?> : <b id="new_changed_points_<?php echo $value1['productId'];?>">
																		<?php 
																		// echo ($smallest_price * $Company_Details->Redemptionratio); 
																		echo ($smallest_price * $Redemptionratio); 
																		?></b>
														...
														<div class="text">
															<h5>
																...
																<div class="text">
																	...
																	<button type="submit" class="btn btn-template-main" onclick="Redeem_done('<?php echo $value1['imageUrl'];?>','<?php echo $value1['name'];?>','<?php echo $value1['productId'];?>',28,'<?php echo $product['Merchandize_item_name']; ?>',<?php echo $value1['productId'];?>);get_item_list();" style="margin-left: -6px;">
...
<script>				
		function AddQty(pId){
			...
			if(Price_value1 <= Gift_payment_balance){		
				...
				ShowPopup("you can not purchase more than "+Gift_payment_balance);
			}
                    ...
                    <li onclick="hide_catagory();" style="line-height:0px;">
					  ...
					  <div id="sortby_category" style="display:none">
                        ...
                        <ul <?php if( count($Merchandize_category) > 4 ) { echo 'style="height: 180px; overflow: auto;"'; } ?> >
                            ...
                            <?php } ?>
							 <?php */ ?>
							<ul style="min-height: 350px; overflow: auto;" >
								<li>
									<div class="form-group">
									<label style="text-transform: capitalize;">
										<input type="radio" name="Sort_cat" id="Sort_cat0" class="flat-red" value="" onclick="Sort_by_category(this.value);">&nbsp;&nbsp;
										All
									</label>
									</div>
								</li>
								...
								// echo"--Category_filter--".$Category_filter."---<br>";
								if($filter_response['data']){
							
									foreach($filter_response as $key => $value ){							
									
										// echo"--orderTotal-------".print_r($value['getFilters']['data'])."------<br>";							
											foreach($value['getFilters']['data'] as $value1){
											
												
												// echo"--value1-------".print_r($value1['filterGroupName'])."------<br>";
												
												
												if($value1['filterGroupCode']=='voucher_category'){
													
													// echo"--experience_category------------<br>";
													
													// echo"--value1-------".print_r($value1)."------<br>";
													
													foreach($value1['filters'] as $kay => $category){
														
															
														// echo"--key--".$kay."---category----".$category['filterValue']."---<br>";
														// echo"--key--".$kay."---filterValueCode----".$category['filterValueCode']."---<br>";
														
														?>
														<li>
															<div class="form-group">
															<label style="text-transform: capitalize;">
																<input type="radio" name="Sort_cat" id="Sort_cat<?php echo $category['filterValueCode']; ?>" class="flat-red" value="<?php echo $category['filterValueCode']; ?>" <?php if($Category_filter == $category['filterValueCode']){echo "checked=checked";}?> onclick="Sort_by_category(this.value);">&nbsp;&nbsp;
																<?php echo $category['filterValue']; ?>
															</label>
															</div>
														</li>
														<?php
...
function Sort_by_category(Merchandize_category)
{
	...
	<?php
		...
		<?php }
	?>
	window.location='<?php echo base_url()?>index.php/Redemption_Catalogue/eVoucher_catalogue?Sort_by_points_flag='+filter+'&Sort_by_category_flag='+Merchandize_category+'&Sort_by_merchant_flag='+merchant+'&Sort_by_brand_flag='+brand+'&Sort_by_gender_flag='+gender;
}	
