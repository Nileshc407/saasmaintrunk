...
$Comp_regdate=$Company_details->Comp_regdate;
$Gift_catalogue_flag=$Company_details->Gift_catalogue;
...
//------------------------AMIT KAMBLE 29-06-2022------------------------------------------
    //--------------License Expiry Check-----------------
		 ...
		 {
			$FetchedSaasCompany = $ci_object->Igain_model->Get_saas_company_payment_details($data['Company_id']);
		...
		<aside class="main-sidebar" style="position:fixed;">
			<section class="sidebar">
				<ul class="sidebar-menu">
					...
					<li class="treeview" <?php if($this->router->fetch_method()=="My_Vouchers"){ echo "style='background: #376172;'";} ?>>
					<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
						<a href="<?php echo base_url(); ?>index.php/Cust_home/My_Vouchers">
				...
				?>
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
							...
							<?php if($Company_License_type == 120) {//Enhance{ 
							if($Gift_catalogue_flag == 1) { ?>
							<li>
							...
							<?php }else if($Gift_catalogue_flag == 2){ ?>
							<li>
								<a href="<?php echo base_url()?>index.php/Gift_Catalogue">
									<i class="fa fa-shopping-cart"></i>
									<span>eVoucher Gift Card</span></i>
								</a>
							</li>
						...
						<?php if(($this->router->fetch_class()=="Redemption_Catalogue" || $this->router->fetch_method()=="eVoucher_catalogue") || ($this->router->fetch_class()=="Gift_Catalogue")){ ?>
						<ul style="margin-right:15px;line-height:2.3;">
							...
							<?php }else if($Gift_catalogue_flag == 2){ ?>
							<li <?php if($this->router->fetch_class()=="Gift_Catalogue"){ echo "style='background: #376172;'";} ?>>
								<a href="<?php echo base_url()?>index.php/Gift_Catalogue">
									<i class="fa fa-shopping-cart"></i>
									<span>eVoucher Gift Card</span>
								</a>
				...
				<?php if($Company_License_type != 121) { ?>
					...
					<?php if($Survey_analysis == 1) {//Enhance{ ?>
