...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = '/Email_body_images'; // Relative to domain name
	$config['upload_path'] = 'lslloyaltyapppc/Email_body_images'; // Physical path. [Usually works fine like this]
