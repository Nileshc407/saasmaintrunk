...
class Transfer_publisher extends CI_Controller {
    ...
    function To_publisher() {
        ...
        if ($this->session->userdata('cust_logged_in')) {
            ...
            if ($_POST['From_publisher'] == NULL && $_POST['From_beneficiary_id'] == NULL) {

                $this->load->view('front/transferpublisher/from_publisher', $data);
				
            } else {

                $data['From_publisher'] = $_POST['From_publisher'];
                $data['From_beneficiary_id'] = $_POST['From_beneficiary_id'];
				...
				$theHTMLResponse = $this->load->view('front/transferpublisher/to_publisher', $data, true);				
                ...
                if ($FromBeneficiaryID != "" && $Beneficiary_company_id != "") {
                    ...
                    if (strcmp($Beneficiary_membership_id, $FromBeneficiaryID) == 0) {
                        ...
                        $To_Beneficiary_name = $To_get_Beneficiary_members->Beneficiary_name;
						 ...
						 $data['To_get_Beneficiary_members']=$To_get_Beneficiary_members;
            ...
            if ($_POST == NULL) {
                ...
                if ($Transfer_miles > 0 && $Equivalent > 0 && $Publisher_current_balance >= $Transfer_miles) {
                    ...
                    if ($TransferFlag == 0) {
						...
						$this->session->set_flashdata("error_transfer","Transaction Successfully.");
						redirect('Transfer_publisher/From_publisher');
						
                    } else {

                       $this->session->set_flashdata("error_transfer","Transaction Un-successfully.");
						redirect('Transfer_publisher/From_publisher');
                    }
                } else {
            ...
            if ($_POST == NULL) {
                ...
                if ($FromBeneficiaryID != "" && $Beneficiary_company_id != "") {
                    ...
                    if (strcmp($Beneficiary_membership_id, $FromBeneficiaryID) == 0) {
                        ...
                        echo json_encode(array("status" => '2001', "status_message" => 'Invalid Identifier'));
                    }
                } else {
            ...
            if ($_POST == NULL) {
                ...
                if ($FromBeneficiaryID != "" && $enrollID != "") {
                    ...
                    if ($FromBeneficiaryID == $Register_beneficiary_id) {
						...
						// echo"---status_message----".$return_result->status_message."-<br>"; 
						
                       /*  print_r($return_result);
                        print_r($return_result->status_message);
                        die; */

                        $VoucherStatus = "Pending";
                        if ($return_result->status == 1001 && $return_result->status_message != "" ) {
