        ...
        <div class="row">
			...
			<div class="col-md-12 clearfix text-center">
				...
				<div class="box">
					...
					<script>
						var email='<?php echo App_string_decrypt($Enroll_details->User_email_id); ?>';
						var Bill_no='<?php echo $Bill_no; ?>';
						var Manual_billno='<?php echo $Manual_billno; ?>';
						
						if(Manual_billno != "")
						{
							var Manual_billno1 =  'The POS Bill No. is <b>'+Manual_billno+' </b>';
						}
						else
						{
							var Manual_billno1 = "";
						...
						BootstrapDialog.show({
							...
							message: 'Thank you for your Purchase.  A Confirmation Email has been sent to '+email+' <br> <br> The Online Order No. is <b>'+Bill_no+'</b> <br>'+Manual_billno1+' ',
							buttons: [{
								label: 'OK',
