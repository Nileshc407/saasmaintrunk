...
<body>
	...
	<div class="container">
		<div class="row">
				<script>					
					$(window).load(function(){
						$('#myModal_take').modal('show');
					}); 			
				</script>
					<!-- Modal -->
					<div class="modal fade" id="myModal_take" role="dialog">
						<div class="modal-dialog">						
						  <!-- Modal content-->
						  <div class="modal-content">
							<div class="modal-header">
							...
							<div class="modal-body">
							  <p>We value your feedback as it helps us to serve you better. So please do answer all the Questions!!</p>
							  <img src="<?php echo $this->config->item('base_url2')?>SurveyImages/sticksurvey.gif" alt="Survey" class="img-responsive" />						  
							</div>
							<div class="text-center">
							  <p id="my_div" class="hide" >Take Survey and Earn Points</p>			 
							</div>						
							<div class="panel-body text-center">
								<input type="button"  class="btn btn-default" data-dismiss="modal" value="Take Survey" />
							</div>
						  </div>					  
						</div>
					</div>
											...
											<div class="checkRadioContainer">
												...
												?>											
													<div class="form-group">
														<textarea class="form-control" id="textbox_<?php echo $Question_id; ?>" rows="4" cols="50" name="<?php echo $Question_id; ?>" placeholder="Address" ></textarea>
													</div>
												<?php 
												}
										...
										<div class="tab-pane" role="tabpanel" id="<?php echo $Question_id ?>">
											...
											<div class="checkRadioContainer">
												...
												{ 
													?>											
													<div class="form-group">
														<textarea class="form-control" id="textbox_<?php echo $Question_id; ?>" onchange="increase_bar(<?php echo $Question_id; ?>);" rows="4" cols="50" name="<?php echo $Question_id; ?>" placeholder="Address" ></textarea>
...
{
	//alert('---Q_id----'+Q_id);	
	// var checkbox_count = $("[type='checkbox']:checked").length;
	// alert('---checkbox_count----'+checkbox_count);
