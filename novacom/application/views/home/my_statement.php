			...
			<div class="login-box-body">			
				...
				<div class="form-group has-feedback">
					...
					<select class="form-control" name="Trans_Type" id="Trans_Type" >
						...
						{
							if($Trans['Trans_type_id'] == 2 || $Trans['Trans_type_id'] == 12 || $Trans['Trans_type_id'] == 8 || $Trans['Trans_type_id'] == 1 || $Trans['Trans_type_id'] == 13 || $Trans['Trans_type_id'] == 10)
							{
		...
		<div class="box-body">
			<div class="table-responsive">
				...
				<?php 
					...
					{ 
						...
						?>
							...
							<th>Item Size</th>				  
							<th>Qty</th>-->
							<th>Purchase Amt(<?php echo $Symbol_currency; ?>)</th>
					...
					if($Transaction_Reports != "")
					{
						foreach($Transaction_Reports as $Trans_RPT)
						{
							if($Redeemption_report ==0 )
							{
								...
								?>
									<tr>							  
										<td><span><?php echo $Trans_RPT->TransactionType; ?></span></td>
								...
								?>						
									<tr>							
										...
										<td><span><?php echo $Trans_RPT->TransactionType; ?></span></td>
										<?php /*<td><div class="sparkbar" data-color="#00a65a" data-height="20"><?php echo $Trans_RPT->Item_name; ?></div></td>
							...
							else
							{
								...
								{ ?>
									<tr>							 
										...
										<td><div class="sparkbar" data-color="#00a65a" data-height="20"><?php  echo round($Trans_RPT->TotalQuantity); ?></div></td>
				...
				{ ?>
					<tr>					 
						<td colspan="12" >
							<?php /*<a href="<?php echo base_url()?>index.php/Cust_home/export_customer_report/?report_type=<?php echo $Report_type; ?>&start_date=<?php echo $From_date; ?>&end_date=<?php echo $To_date; ?>&Merchant=<?php echo $Merchant; ?>&Trans_Type=<?php echo $Trans_Type; ?>&Enrollment_id=<?php echo $Enroll_details->Enrollement_id; ?>&membership_id=<?php echo $Enroll_details->Card_id; ?>&pdf_excel_flag=1&Redeemption_report=<?php echo $Redeemption_report; ?>">
