...
<head>
 ...
 <!--------------------------------------------------------------------------------------->	
	<?php /*<link rel="shortcut icon" href="<?php echo $this->config->item('base_url2')?>images/logo_igain.ico" type="image/x-icon"> */ ?>
			...
			<div class="panel panel-info col-md-12 col-xs-12 ">
				...
				<div class="panel-body">
					<div class="row">
						...
						<img id="no_image" class="profile-user-img img-responsive img-circle" style="height: 100px;" src="<?php echo $this->config->item('base_url2').'images/No_Profile_Image.jpg' ; ?>">
				...
				<div class="panel-footer">
					<div class="row">
						<?php /*<div class="col-xs-12  col-md-5"><strong>Copyright &copy; 2019-2020 <a href="http://www.miraclecartes.com" target="_blank">Miracle Smart Card Pvt. Ltd</a>.</strong> All rights reserved.</div> */?>
						<div class="col-xs-12  col-md-5"><strong>Copyright &copy; 2019-2020 <a href="<?php echo $partner_Company_Website; ?>" target="_blank"><?php echo $partner_Company_name; ?></a></strong> All rights reserved.</div>
						<div class="col-md-2">
						</div>
