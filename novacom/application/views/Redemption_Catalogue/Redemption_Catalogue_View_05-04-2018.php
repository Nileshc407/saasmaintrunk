...
<section class="content">
	...
	<div id="content">
		...
		<!--<div class="row">	
			...
			<button type="submit" class="btn btn-default" name="submit"   id="submit2"  onclick="Proceed_catalogue()" style="margin-left: auto;margin-right: auto;"><?php echo ('Proceed to Checkout'); ?><i class="fa fa-chevron-right"></i><i class="fa fa-chevron-right"></i></button>
			</div>
</section>
                ...
                <ul class="sidebar-menu2">
                   <li>
                    ...
                    <li class="treeview" style="line-height:0px;">
                        <a href="javascript:void(0);" class="filter_header" style="color: #b8c7ce; text-transform: capitalize;"><?php echo ('Points'); ?></a>
                        <ul>
                            <li>
                   ...
                   <!-- <li><hr></li> --><!--id="sortby"-->
                    <li class="treeview" onclick="hide_sort_by();" style="line-height:0px;" >
                        <a href="javascript:void(0);" class="filter_header" style="color: #b8c7ce; text-transform: capitalize;"><span class="glyphicon glyphicon-usd"></span> <?php echo ('Sort by Points'); ?></a>
