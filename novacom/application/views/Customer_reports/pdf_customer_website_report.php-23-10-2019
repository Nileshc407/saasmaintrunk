			...
			<?php 
					...
					{ 						
						...
						?>
							...
							<th>Item Size</th>-->							
							<th>Quantity</th>					  
						<?php /*	<th>Redeemed <?php echo $Company_Details->Currency_name; ?></th>	
							<th>Delivery <?php echo $Company_Details->Currency_name; ?></th>	
							<th>Voucher No</th>	 */?>
					...
					{ 
						...
						?>
							...
							<?php /*<th>Bonus <?php echo $Company_Details->Currency_name; ?></th>						  
							<th>Redeemed <?php echo $Company_Details->Currency_name; ?></th>						  
							<th>Gained <?php echo $Company_Details->Currency_name; ?></th> */ ?>
							<th>Mpesa TransID</th>
							<th>Done By</th>
						<?php /*	<th>Transfer <?php echo $Company_Details->Currency_name; ?></th>
						...
						foreach($Transaction_Reports as $Trans_RPT)
						{
							...
							{							
								...
								?>
									...
									<?php /*	<td><div class="sparkbar" data-color="#00a65a" data-height="20"><?php echo $Trans_RPT->TotalBonusPoints; ?></div></td>
								...
								?>						
									...
									<?php /*	<td><div class="sparkbar" data-color="#00a65a" data-height="20"><?php echo $Trans_RPT->BounsPoints; ?></div></td>
										...
										<?php /*<td><div class="sparkbar" data-color="#00a65a" data-height="20"><?php echo $Trans_RPT->TransferPoints; ?></div></td>										
							...
							else
							{
								...
								?>
									...
									<?php /*	<td><div class="sparkbar" data-color="#00a65a" data-height="20"><?php  echo $Trans_RPT->Item_size; ?></div></td> */ ?>
										...
										<?php /*<td><div class="sparkbar" data-color="#00a65a" data-height="20"><?php  echo $Trans_RPT->TotalItemRedeemPoints; ?></div></td>									
