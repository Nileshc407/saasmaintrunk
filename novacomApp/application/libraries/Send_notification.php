...
class Send_notification 
{
    ...
    public function send_Notification_email($Enrollment_id,$Email_content,$Seller_id,$Company_id)
    {
		...
		if($Template_type == "Enroll")
        {
			...
			ob_end_clean();			
				...
				// var_dump($myData);
				$Pwddata = base64_encode(json_encode($myData));
				$Pwddata_URL = $Base_url2. "novacom/index.php/Login/Setpassword?Pwd_data=" . $Pwddata;
				$PwddataLink = "<a href='" . $Pwddata_URL . "' target='_blank' style='color:#000;'>Click here to Set Password</a>";
    ...
    { 
                            ...
                            <td style="BORDER-BOTTOM: #dbdbdb 1px solid; BORDER-LEFT: #dbdbdb 1px solid; PADDING-BOTTOM: 0px; BACKGROUND-COLOR: #feffff; PADDING-LEFT: 0px; PADDING-RIGHT: 0px; BORDER-TOP: #dbdbdb 1px solid; BORDER-RIGHT: #dbdbdb 1px solid; PADDING-TOP: 0px">
                               <table style="WIDTH: 100%;border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class=rtable cellSpacing=0 cellPadding=0 align=left>
                                    <tr style="HEIGHT: 10px">
                                        ...
                                        Dear  '.$customer_details->First_name.' '.$customer_details->Last_name.',</P>';
			...
			Thank You for placing your Online Order.<br> Please find below the details of your Online Transaction. <br><br>
			<strong>Order Date:&nbsp;</strong> '.$Transaction_date. '<br>
			<strong>Order No:</strong> '.$Orderno. '<br>';
			if($POS_Bill_No != "") {

				$html.='<strong>POS Bill No:&nbsp; </strong> '.$POS_Bill_No. '<br>';
			}
			$html.='<strong>Order Type:&nbsp;</strong> '.$deliveryType. '<br>
			<strong>Outlet Name:&nbsp;</strong> '.$Outlet_Name. '<br></P>
				...
				<TABLE style="border: #dbdbdb 1px solid; WIDTH: 100%; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"  border=0 cellSpacing=0 cellPadding=0 align=center>';
					...
					if($Shipping_charges_flag==2) //Delivery_price
					{
						if($delivery_type==0)
						{
							...
							$Get_shipping_cost = $this->CI->Igain_model->Get_delivery_price_master_citywise($delivery_outlet_details->City);
							...
							/*******Single Weight convert into KG****/
                                   ...
                                   /*  if($Shipping_charges_flag==2)//Delivery_price
                                    ...
                                    $html .= '<TR>
                                                ...
                                                <TD style="border:#dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left>&nbsp; '.$i.'</TD>
                                            </TR>
                                            <TR>
                                                <TD style="border:#dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left ><b> Item name</b></TD>
                                                <TD style="border:#dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left  colspan="8">&nbsp;'.$Merchandize_item_name.'</TD>
                                            </TR>';
											...
											if($item["options"]['remark2'] != NULL)
											{
											 ...
											 if($Condiments_name != "") {
												...
												$html .='<TR>
                                                <TD style="border:#dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left ><b>Condiments</b></TD>
                                                <TD style="border:#dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left  colspan="8">'.$Condiments_name.'</TD>
												</TR>';
											 }
                                           ...
                                           /*  <TR>
                                                <TD style="border:#dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left ><b> Size</b></TD>
                                                 <TD style="border:#dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left>'.$size.'</TD>
                                            </TR> */
											
                                            $html .='<TR>
                                                <TD style="border:#dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left ><b> Quantity</b></TD>
                                                <TD style="border:#dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT:  4px;PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left>&nbsp; '.$item['qty'].'</TD> 
                                            </TR>';
											/*  <TR>
                                                <TD style="border:#dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left ><b>Delivery Cost('.$Symbol_of_currency.')</b></TD>
                                            ...
                                            $html .='<TR>
                                                <TD style="border-bottom:#333 4px solid;border-right: 1px #dbdbdb solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left ><b> Unit Price('.$Symbol_of_currency.')</b></TD>
                                                <TD style="border-bottom:#333 4px solid;border-right: 1px #dbdbdb solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left>&nbsp;'.$Purchase_amount.'</TD>
                                            </TR>
											
											';
                                           
                                             /* $html .='<TR>
                                                <TD style="border:#dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left ><b> Outlet Name</b></TD>
												...
												/* <TR>
													...
													<TD style="border:#dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left>'.$Voucher_array[$i-1].'</TD>
												</TR> */
												
                                           /*  $html .='<TR>
                                                <TD style="border-bottom: red 2px solid;border-right:#dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left ><b> Order Status</b></TD>
                ...
                <TD colspan="2" align=left> 
                    ...
                    <TR>
                        <TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left>                                                                  <b>Sub-Total</b>
                                ...
                                <TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left>&nbsp; '.$Symbol_of_currency.' '.$subtotal.'
                        </TD>
                    </TR>';
					if($_SESSION["Total_Shipping_Cost"] > 0) {
						...
						$html .='<TR>
							...
							<TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left>&nbsp; '.$Symbol_of_currency.' '.$_SESSION["Total_Shipping_Cost"].'
							</TD>
						</TR>';
					}
			...
			if($DiscountAmt > 0 || $VoucherDiscountAmt > 0) {
				$discountVal = $DiscountAmt + $VoucherDiscountAmt;
				$html .='<TR>
					<TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px"align=left>                                                                  <b>Total Discount Amt</b>
					</TD>
					<TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left> '.$Symbol_of_currency.' '.number_format($discountVal,2).'
					</TD>
				</TR>';
				}
			if($EquiRedeem > ($_SESSION["Total_Shipping_Cost"]+$subtotal) ) {
				
				$EquiRedeem=($_SESSION["Total_Shipping_Cost"]+$subtotal);
			} else {
			...
			<TR>
                    <TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left> 
						<b>Redeemed '.$Company_Currency.' ('.$Cust_wish_redeem_point.'  )</b>
                    </TD>
			...
			<TR>
					...
					<TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left>&nbsp;'.$Symbol_of_currency.' '.($grand_total - $mpesa_BillAmount).'
					</TD>
			</TR>';
			...
			{
				$html .='<TR>
					<TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left>                                                                                     <b>Gained '.$Company_Currency.' (<span style="color:red"> * </span> ) </b>
                    </TD>
			...
			if($delivery_type==29) {
				...
				$html .='<TR>
							...
							<TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left colspan="2"> <b>Delivery Address:</b><br>'.
								$customer_delivery_details->Contact_person.'<br>';
								if($str_arr0 != ""){$html .=''.$str_arr0.'<br>';}
								if($str_arr1 != ""){$html .=''.$str_arr1.'<br>';}
								if($str_arr2 != ""){$html .=''.$str_arr2.'<br>';}
								if($str_arr3 != ""){$html .=''.$str_arr3.'<br>';}	
								$Phone_no=App_string_decrypt($customer_delivery_details->Phone_no);
								$html .=''.$Phone_no.'
				...
				$html .='<TR >	
							...
							<TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left colspan="2"><b>';
							
							if($delivery_type ==107){
								$html .='In-Store Address:';
							...
							$html .='</b><br>';
								...
								if($delivery_type ==107){
									$html .=$Customer_name.'<br>';
								}
								$html .=$delivery_outlet_details->First_name.' '.$delivery_outlet_details->Last_name.'<br>';
								if($delivery_type ==107 && $_SESSION["TableNo"] != "" ){
									$html .='Table No:'.$Email_content['TableNo'].'<br>';
								}
								if($str_arr0 != ""){$html .=''.$str_arr0.'<br>';}
								if($str_arr1 != ""){$html .=''.$str_arr1.'<br>';}
								if($str_arr2 != ""){$html .=''.$str_arr2.'<br>';}
			...
			{
				$html .= '<TR>
				<TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left colspan="2"> 																				<b>Note<span style="color:red"> * </span> : ('.$vouchers.') this discount vouchers are used </b>					 	 </TD>                                                                                                                    
				</TR>';
			}
			 ...
			 {
				$html .= '<TR>
					<TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left colspan="2"> 																				<b>Note<span style="color:red"> * </span> : '.$total_loyalty_points.' Loyalty '.$Company_Currency.' gained will be credited in your loyalty balance when the item(s) gets delivered</b>					 	 </TD>                                                                                                                    
				</TR>';
			 }
			 /****----------Hide cahnge Ravi--24-09-2019-------********/
			 
			$html .= '</TABLE>';
			if($delivery_outlet_details->Order_preparation_time != "") {
				
				$html .='<P style="LINE-HEIGHT: 155%; BACKGROUND-COLOR: transparent; MARGIN-TOP: 0px; FONT-FAMILY: Arial, Helvetica, sans-serif; MARGIN-BOTTOM: 1em; COLOR: #666666; FONT-SIZE: 12px; mso-line-height-rule: exactly" align=left><b>The order will be ready within '.$delivery_outlet_details->Order_preparation_time.'</b></P>';
			}
			
			
			$html .= '<br>
			 <P style="LINE-HEIGHT: 155%; BACKGROUND-COLOR: transparent; MARGIN-TOP: 0px; FONT-FAMILY: Arial, Helvetica, sans-serif; MARGIN-BOTTOM: 1em; COLOR: #666666; FONT-SIZE: 12px; mso-line-height-rule: exactly" align=left> Regards,<br>'. $company_details->Company_name .' Team.
			</P>
			<br>';
			if($delivery_type==0) {
				
				$html .='<P style="LINE-HEIGHT: 155%; BACKGROUND-COLOR: transparent; MARGIN-TOP: 0px; FONT-FAMILY: Arial, Helvetica, sans-serif; MARGIN-BOTTOM: 1em; COLOR: #666666; FONT-SIZE: 12px; mso-line-height-rule: exactly" align=left>This is not a Receipt.<br>Final Receipt will be provided upon delivery of your order.</P>';
				
			} else {
				
				$html .='<P style="LINE-HEIGHT: 155%; BACKGROUND-COLOR: transparent; MARGIN-TOP: 0px; FONT-FAMILY: Arial, Helvetica, sans-serif; MARGIN-BOTTOM: 1em; COLOR: #666666; FONT-SIZE: 12px; mso-line-height-rule: exactly" align=left>This is not a Receipt.<br>Present this notification Order/Bill No to collect your Order and Final Receipt.</P>';
		...
		$html .='</td>
					...
					<tr style="HEIGHT: 20px">
						<td class="row" style="margin-left: 0px;BORDER-BOTTOM: medium none; TEXT-ALIGN: center; BORDER-LEFT: medium none; PADDING-BOTTOM: 5px; BACKGROUND-COLOR: #f5f7fa; PADDING-LEFT: 15px; WIDTH: 100%; PADDING-RIGHT: 15px; VERTICAL-ALIGN: middle; BORDER-TOP: medium none; BORDER-RIGHT: medium none; PADDING-TOP: 5px">';
		...
		{ 
            ...
            $html .= '<TR>
				   ...
				   <TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left colspan="8"><b> Condiments</b>
					...
					/* $html .='<TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left> <b>Outlet Name</b>
					</TD>'; */
			
					$html .='<TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left> <b> Order Status</b>
					</TD>
                </TR>';
            $i=1;		
			if($cart = $this->CI->cart->contents())
                ...
                foreach ($cart as $item)
                {
				   ...
				   if($item["options"]['Merchant_flag'] ==1) 
					...
					$html .= '<TR>
						...
						/* $html .='<TD style="border:#dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left>'.$merchant_name.' </TD>'; */
						
						
						$html .='<TD style="border:#dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left>'.$Voucher_status.'
						</TD>
					  </TR>  ';
						$i++;
				}
			...
			<TR>
				<TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left> 
					...
					<TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left>'.$Symbol_of_currency.' '.number_format($EquiRedeem,2).' (Eqv.) 
				</TD>
			</TR>
			<TR>
				<TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left> 
					<b>M-PESA Paid Amount ('.$Mpesa_TransID.')</b>
				</TD>
					<TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left>'.$Symbol_of_currency.' '.number_format($mpesa_BillAmount,2).' 
				</TD>
			</TR>
			...
			<TR>
			 ...
			 {
				$html .= '<TR>
					<TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left colspan="2"> 																				<b>Delivery Address</b>:<br> '.$Cust_selected_address.'				 	 </TD>                                                                                                                    
				</TR>';
			 }
			 else
			 {
				 $html .= '<TR>
					<TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left colspan="2"> 																				<b>Pick-Up</b>:<br> '.$Outlet_address.'				 	 </TD>                                                                                                                    
				</TR>';
			 }
