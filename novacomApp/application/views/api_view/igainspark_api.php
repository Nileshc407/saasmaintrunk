                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered" id="Item_row_table">
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-right" colspan="5">Total Delivery Points</td>
                                    ...
                                    <tr class="ShipAddress">
                                        ...
                                        <td>&nbsp;</td>
                                        <th class="text-center" colspan="1">Delivery Address</th>
                                        <td colspan="2">&nbsp;</td>
                                    </tr>
                                    <tr class="ShipAddress">
                                        <td>&nbsp;</td>
                                        ...
                                        <td class="text-center" colspan="3">
                                            <div class="checkbox">
                                                <label for="exampleInputEmail1">
                                                    <input type="checkbox" name="new_address" value="1" id="Same_address" onclick="Change_shipping_address();"> Delivery Address same as Current Address
                                                </label>
                                            </div>
                                        </td>
                                        <td colspan="2">&nbsp;</td>
                                    ...
                                    <tr>
                                        <td class="text-center" colspan="7">
                                            ...
                                            <input type='hidden' name="Company_username" value='joycoins'>
                                            <input type='hidden' name="Company_password" value='ZKjJ1cW7EhOq7kotI4h2Z7vSlAy+47OFNBKNxBSrmgY='>
...
<script>
		...
		// var API_URL = "<?php echo base_url(); ?>index.php/api_controller/Customer_Api/iGainSpark_api";
		var API_URL = "http://localhost/CI_IGAINSPARK_JOY/Joycoins/index.php/api_controller/Customer_api/iGainSpark_api";
        ...
        function get_notifications()
        {
            ...
            var Membership_id = "RpgmsrmyF9vF4djJrV4gNbUOva19N13lYM/Am1WOICE=";  //20180208
        ...
        {
            var Company_username = "joycoins";
            var Company_password = "ZKjJ1cW7EhOq7kotI4h2Z7vSlAy+47OFNBKNxBSrmgY=";
		...
		function Add_beneficiary()
        {
			...
			alert(Beneficiary_Identifier);
			alert(Igain_company_id);
