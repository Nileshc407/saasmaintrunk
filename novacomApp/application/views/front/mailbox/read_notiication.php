...
<body> 
   <form  name="Read_mail_search" method="POST" action="<?php echo base_url()?>index.php/Cust_home/Search_readnotifications" enctype="multipart/form-data">	
						...
						<div class="pricing-details">
							<div class="row">
								<div id="desc1">											
									...
									<a href="<?php echo base_url();?>index.php/Cust_home/readnotifications" id="active"><span id="mail_button" ><img src="<?php echo base_url(); ?>assets/icons/<?php echo $icon_src1; ?>/read.png" style="width: 17px"><?php echo $ReadNotificationsCount->Read_noty;?> Read  </span></a>
									
									<a href="<?php echo base_url();?>index.php/Cust_home/allnotifications"><span id="mail_button"><img src="<?php echo base_url(); ?>assets/icons/<?php echo $icon_src1; ?>/all.png" style="width: 17px"><?php echo $AllNotificationsCount->All_noty;?> All</span></a>
								</div>
								<div style="width:35%;">											
									...
									<a href="<?php echo base_url();?>index.php/Cust_home/readnotifications"><span id="button5" onclick="Page_refresh();"><img src="<?php echo base_url(); ?>assets/icons/<?php echo $icon_src1; ?>/refresh.png" style="width: 20px"> </span></a>
								</div>
								<div style="width:55%;">		
									<address>      
