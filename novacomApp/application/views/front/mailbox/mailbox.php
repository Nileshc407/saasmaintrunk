...
<body> 
<form  name="Mailbox_search" method="POST" action="<?php echo base_url()?>index.php/Cust_home/Search_mailbox" enctype="multipart/form-data">	
				...
				<div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: -31px;">
					<div class="pricing-table wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="0.3s"  id="front_head">
						<div class="pricing-details">
							<div class="row">
								<div id="desc1">											
									<a href="<?php echo base_url();?>index.php/Cust_home/mailbox" id="active"><span id="mail_button" ><img src="<?php echo base_url(); ?>assets/icons/<?php echo $icon_src1; ?>/un-read.png" style="width: 17px"><?php echo $NotificationsCount->Open_notify;?> Un-read </span></a>
								...
								<div style="width:35%;">											
									...
									<a href="<?php echo base_url(); ?>index.php/Cust_home/mailbox"><span id="button5" onclick="Page_refresh();"><img src="<?php echo base_url(); ?>assets/icons/<?php echo $icon_src1; ?>/refresh.png" style="width: 20px"> </span></a>
								</div>
								<div style="width:55%;">		
									<address>      
