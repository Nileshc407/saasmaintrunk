...
<html lang="en">
<head>
<title>Merchandize Catelogue</title>	
...
<body>
    ...
    ?>  
<form  name="Search_Catalogue_item" method="POST" action="<?php echo base_url()?>index.php/Redemption_Catalogue/Search_Catalogue_item" enctype="multipart/form-data">		
    <div id="application_theme" class="section pricing-section" style="min-height:520px;">
        <div class="container" >
            <div class="section-header">          
                ...
                <p id="Extra_large_font">Redemption Catalogue</p>
            </div>			
        ...
        <div class="sticky-container">
            <ul class="sticky">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: -31px;">      
                 <address style="margin-left:36px; margin-bottom:15px; margin-top: 4px"> 
						<a href="<?php echo base_url(); ?>index.php/Redemption_Catalogue"><span id="button5" onclick="Page_refresh();"><img src="<?php echo base_url(); ?>assets/icons/<?php echo $icon_src1; ?>/refresh.png" style="width: 20px"></span></a>						
                                            ...
                                            <div class="row ">
                                                <a href="<?php echo base_url()?>index.php/Redemption_Catalogue/Merchandize_Item_details/?Company_merchandise_item_id=<?php echo $product['Company_merchandise_item_id']; ?>">
                                                    <div class="col-xs-4" style="padding: 10px;">
                                                            <img src="<?php echo $product['Thumbnail_image1']; ?>" alt="" class="img-rounded img-responsive" width="60" height="60">
                                                    </div>
                                                </a>       
                                            ...
                                            <div class="row">                                                
                                                <?php  if($product['Delivery_method']==0){ ?>
                                                    ...
                                                    <div class="col-xs-6 text-right main-xs-6">
                                                        ...
                                                        <button type="button" id="button"  onclick="add_to_cart('<?php echo $product['Company_merchandize_item_code']; ?>','<?php echo $product['Delivery_method']; ?>',location_<?php echo $product['Company_merchandise_item_id']; ?>.value,'<?php echo $product['Merchandize_item_name']; ?>','<?php echo $Billing_price_in_points; ?>','<?php echo $Item_size; ?>',<?php echo $product['Company_merchandise_item_id']; ?>,<?php echo $product['Item_Weight']; ?>,<?php echo $product['Weight_unit_id']; ?>);" style="margin-left: -6px;">
...
function form_submit()
	{
		...
		document.Search_Catalogue_item.submit();
	} 
