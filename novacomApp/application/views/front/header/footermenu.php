...
<div class="footer">	
		<div class="row" id="foot1">		
			...
			<div class="col-xs-2 footer-xs" id="Footer_font">
				<a href="<?php echo base_url();?>index.php/Cust_home/merchantoffers"><img src="<?php echo base_url(); ?>assets/icons/<?php echo $foot_icon; ?>/offers.png" class="img-responsive" id="flat"><br />
