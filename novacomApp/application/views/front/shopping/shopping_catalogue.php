...
<body style="background-image:url('<?php echo base_url(); ?>assets/img/menu-smoothies.jpg')">
	...
	<script>
		/* Add to Cart */
			...
			function add_to_cart(serial,name,price,Redemption_method,Branch,Company_merchandise_item_id,Item_size,Item_Weight,Weight_unit_id,Partner_id,Partner_state,Partner_Country_id,Seller_id,Merchant_flag,Cost_price,VAT,Product_category_id,Company_merchandize_item_code,Item_image1,Item_name,Stamp_item_flag)
			{
