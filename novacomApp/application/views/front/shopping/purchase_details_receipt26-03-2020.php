					...
					<div class="pricing-table wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="0.3s" id="front_head">
						...
						<div class="pricing-details">
							...
							//	print_r($MainItemInfo); 
								...
								$Itemcategory_discount=array();
								$Total_discount=array(); */
								// $TotalDiscount=($Billdiscount1+$Itemcategory_discount1+$Total_discount1);
								// $TotalDiscount=($Billdiscount1+$Itemcategory_discount1+$Total_discount1);
										...
										<table align="center">
												<tr>
													...
													<tr>
														...
														<tr>
															<td><strong id="Medium_font">Redeemed Points</strong></td>
															<td><span id="Value_font">:&nbsp;<?php echo $REDEEM_Points; ?></span></td>												  
														</tr>
														<?php //**----------Hide cahnge Ravi--24-09-2019-------********// ?>
														<tr>
															<td><strong id="Medium_font">Total Discount Amount</strong></td>
															<td><span id="Value_font">:&nbsp;<?php echo $Symbol_of_currency." ".number_format( (float)($Total_discount_final), 2); ?></span></td>												  
														</tr>
														<tr>
