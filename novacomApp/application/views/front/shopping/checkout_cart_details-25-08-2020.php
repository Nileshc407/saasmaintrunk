			...
			<div class="accordion" id="accordion">
											...
											foreach($Prod as $v2){
												// echo"--".$Card_balance."---".$Discount_percentage."---<br>";
													if($v2['Discount_percentage'] > 0){ ?>
														...
														<option value="<?php echo $v2['Gift_card_id']."_".$v2['Discount_percentage']."_2"; ?>"><?php echo $v2['Merchandize_item_name']; ?>:<br><?php echo $v2['Discount_percentage']; ?> %
														</option>
													
													<?php } else {
													?>
														<option value="<?php echo $v2['Gift_card_id']."_".$v2['Card_balance']."_1"; ?>">									
														<?php echo $v2['Merchandize_item_name']; ?>:<br> <?php echo $Symbol_of_currency; ?> <?php echo number_format($v2['Card_balance'],2); ?>
														</option>
													<?php 
													}
											}										
				...
				<div class="item">
					...
					<div id="collapse3" class="collapse" data-parent="#accordion">
						<div class="card-body">
							<div class="point-field">
								<input type="text" name="Trans_id" id="Trans_id" onkeyup="this.value=this.value.replace(/\D/g,'')" placeholder="Enter MPESA Phone No. as XXXXXXXXX" maxlength="9" class="form-control"/>
								
								<button type="button" onclick="Call_API();" id="verfify_button" >PAY</button>
								
							</div>
								<p style="color:#322210;font-style: italic;">Enter MPESA Phone No as XXXXXXXXX preceded without country code or  '0’</p>
   ...
   <script type="text/javascript">
	...
	/* -----------setVoucher------29-05-2020--------------- */
		...
		//	console.log("--redeem_amt---"+redeem_amt);
			...
			//	console.log("--Card_balance1---"+Card_balance1);				
				var TotalGrand = Card_balance1+parseFloat(redeem_amt);
			}
			/* 25-06-2020 */
		...
		//	console.log("---new_purchase_amt2-----"+new_purchase_amt2);
			...
			/* 25-06-2020 */
				if(DiscountPercentageFlag==1){
					...
					$("#VoucherDiscountAmt").val(parseFloat(Card_balance1).toFixed(2));
	...
	// alert('<?php echo $delivery_outlet_details->goods_till_number; ?>');
		function Call_API()
		{
			...
			{
				$("#Trans_id_error").html('Enter MPESA Phone No. as XXXXXXXXX');
				return false;
			}
			...
			$.ajax({
				type: "POST",
				data: {Final_Grand_total: Final_Grand_total, goods_till_number:goods_till_number,Trans_id:Trans_id,Seller_api_url2:Seller_api_url2,payment_auth_key:payment_auth_key,dial_code:dial_code},
	...
	function setLocalStorage()
	{
		...
		var SelectedVoucher = $('.select-styled').text();
