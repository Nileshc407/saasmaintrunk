							...
							foreach($OptItem as $OptItem11)
							{
								?>
									...
									<div class="col-md-12"> 
										<div class="row">
											<div class="col-md-3" style="width:20%;">
												<input type="checkbox" id="" name="Optional_Condiments_set_<?php echo $i;?>"  onclick="Show_next_required('<?php echo '#'.$q4; ?>');Add_message('<?php echo $OptItem11->Merchandize_item_name; ?>',<?php echo $OptItem11->Company_merchandize_item_code; ?>);" value="<?php echo $OptItem11->Company_merchandize_item_code.':'.$OptItem11->Merchandize_item_name; ?>">
											</div>
											<div class="col-md-9" style="width:80%;">
												<span class="pull-left">										
													<font id="Small_font" style="float: left;">
...
function prependMe(Merchandize_item_name,textvalue,id)
{
	...
	message_set.push(Merchandize_item_name+':'+textvalue);
	//$(id).val("test msg");
}
