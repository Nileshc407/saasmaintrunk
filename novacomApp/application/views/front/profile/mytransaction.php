...
<div id="application_theme" class="section pricing-section" style="min-height: 500px;">
    <div class="container">
        <div class="section-header ">     
			...
			<p id="Extra_large_font" style="margin-left: -3%;">My Statement</span>
        </div>
          ...
          <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: -31px;">
            <div class="pricing-table wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="0.3s" id="front_head">    <div class="pricing-details">   
					<address style="margin-left:-15px; margin-bottom:10px;"> 
						<a href="<?php echo base_url(); ?>index.php/Cust_home/mytransaction"><span id="button5" onclick="Page_refresh();"><img src="<?php echo base_url(); ?>assets/icons/<?php echo $icon_src1; ?>/refresh.png" style="width: 20px"></span></a>						
				...
				<?php
				// var_dump($Delivery_Transaction_Details);
				if($Delivery_Transaction_Details!=NULL)
				{ 
					foreach($Delivery_Transaction_Details as $row) 
					{ ?>
						...
						<div class="col-md-12" style="margin-left: 43px;"> 
							...
							<div class="row" id="Lulu">
								...
								<?php */ ?>
                                    ...
                                    <div class="col-xs-10 text-left" id="detail" style="width: 80%;">
									...
									<?php } else if($row->TransType==2 || $row->TransType==12) { ?>
												<span style="margin-bottom: 0;">
													<strong id="Medium_font"> <strong id="Value_font"><?php echo $Company_Details->Currency_name; ?></strong> Earned</strong>&nbsp;<strong id="Value_font"><?php echo $row->Loyalty_pts; ?> </strong>
												</span>
