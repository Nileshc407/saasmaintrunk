    ...
    <div id="application_theme" class="section pricing-section" style="min-height: 500px;">
		<div class="container">
			<div class="section-header">
				...
				<p id="Extra_large_font" style="margin-left: -3%;">Bill Details</p>
			</div>
						...
						?>		
							<div class="row" >
								<div class="col-md-12">
									...
									<thead>
									<?php if($Trans_details->Bill_no==0)
										{ ?>
									<tr> 
								...
								<?php 	}
									...
									<tr colspan="3"> 
										...
										<span id="Value_font"><strong><?php echo $Trans_details->Bill_no; ?></strong></span></td>
									</tr>
								<?php 	}
									...
									<tr>
											...
											<td colspan="2"><span id="Value_font"><strong>  <?php echo $Trans_details->Card_id2; ?>  </strong></span><br></td>
									</tr>
								<?php 	} 
								...
								<?php 	} */	
										...
										{ ?>
										<tr>
											<td><span id="Small_font">Item Order Status </span> </td>
											<td colspan="2"><span id="Value_font"><strong>   
