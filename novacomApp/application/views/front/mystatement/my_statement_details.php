    ...
    <div id="application_theme" class="section pricing-section" style="min-height: 500px;">
		<div class="container">
			<div class="section-header">
				...
				<p id="Extra_large_font" style="margin-left: -3%;">Statement Details</p>
			</div>
						...
						?>		
							<div class="row" >
								...
								<?php 	}	
										...
										{?>
									<tr>
											<td><span id="Small_font">From  </span></td>
											<td colspan="2"><span id="Value_font"><strong> <?php echo $Trans_details->From_Beneficiary_cust_name.' ('.$Trans_details->From_Beneficiary_company_name.')'; ?>  </strong></span><br></td>
									</tr>
									<tr>
											<td><span id="Small_font">To  </span></td>
									...
									<tr>
											<td><span id="Small_font">Transferred  </span></td>
											<td colspan="2"><span id="Value_font"><strong> <?php echo $Trans_details->Transfer_points.' '.$Trans_details->form_currency; ?>  </strong></span><br></td>
									</tr>
									<tr>
											<td><span id="Small_font">Received  </span></td>
											<td colspan="2"><span id="Value_font"><strong> <?php echo $Trans_details->Topup_amount.' '.$Trans_details->To_currency; ?>  </strong></span><br></td>
									</tr>
								<?php 	} 
								...
								<?php	}
										if($Loyalty_pts+$Bonus_points !=0 && $Trans_type!=24)
										{ ?>
										<tr>
											<td><span id="Small_font"><?php echo $Company_Details->Currency_name; ?> Earned </span> </td>
								...
								<?php	} 
										if($Redeem_points+$Transfer_points !=0 && $Trans_type!=24)
										{
										?>
										<tr>
											<td><span id="Small_font"><?php echo $Company_Details->Currency_name; ?> Redeemed </span> </td>
								...
								<?php 	}
										if($Trans_type==24 || $Trans_type==25)
										{ ?>
										<tr>
