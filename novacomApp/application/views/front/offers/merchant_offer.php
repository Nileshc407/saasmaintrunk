					...
					<?php if($Next_Tier_name != "" && $Criteria_value != "" && $Tier_value_points > 0) { ?>
						<div class="row" style="margin: auto;" > 
							<span id="Medium_font" class="text-left" ><strong>Next Level</strong></span>
							 <div class="col-md-12" style="background:#fab900;    padding: 8px;">    
								...
								<table id="myTable" align="left" class="text-left">										 
									<tr>
										...
										<button type="button"  style="background:#42251bed;color:#fff;border: none;width: 50%;padding:5px;float:right;margin-top: 51px;" id="button"  data-toggle="collapse" data-target="#demo" >View Benefits</button>												
									</tr> 
								</table>	
...
<style>
button:focus{
	background-color: #42251bed !IMPORTANT;
}
	#ud
	{
