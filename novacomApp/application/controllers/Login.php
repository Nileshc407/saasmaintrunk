...
{	
    ...
    public function index()
    {
		...
		/*				
			http://localhost/novacomonline_local/novacomApp/index.php/login?username=ravip@miraclecartes.com&company_id=3&password=Ravi@2020&login_logout=0&flag=1			
			http://localhost/novacomonline/novacomApp/index.php/login?username=raviphad1988@gmail.com&company_id=3&password=Ravi@2020&login_logout=0&flag=1
			http://novacomonline.ehpdemo.online/novacomApp/index.php/login?username=ravip@miraclecartes.com&company_id=3&password=Ravi@2020&login_logout=0&flag=1
			
			http://novacomonline.ehpdemo.online/novacomApp/index.php/Cust_home/forgot_password_smart_phone?Company_id=3&flag=1&email=amitk@miraclecartes.com
			
			http://novacomonline.ehpdemo.online/novacomApp/index.php/login?username=amitk@miraclecartes.com&company_id=3&password=Amit@2020&login_logout=0&flag=1 							
			http://novacomonline.ehpdemo.online/novacomApp/index.php/login?username=ravip@miraclecartes.com&company_id=3&password=Ravi@2019&login_logout=0&flag=1&Walking_customer=0
			
			http://novacomonline.ehpdemo.online/novacomApp/index.php/login/smart_phone_login?username=ravip@miraclecartes.com&company_id=3&password=Ravi@2019&login_logout=0&flag=1&Walking_customer=0					
					
			http://novacomonline.ehpdemo.online/novacomApp/index.php/Cust_home/Create_Account_smart_phone?company_id=3&firstName=NewCustmer&last_name=Phad&userEmailId=ravip@miraclecartes&phone_no=9561970954&dob=2020-01-13&login_logout=0&flag=1			
    ...
    {      	
		...
		// http://localhost/novacomonline/novacomApp/index.php/login/new_login?username=ravip@miraclecartes.com&company_id=3&password=Ravi@2019&login_logout=0&flag=1&Walking_customer=1
		
		// http://localhost/novacomonline/novacomApp/index.php/login/new_login?username=ravip@miraclecartes.com&company_id=3&password=Ravi@2019&login_logout=0&flag=1
		
		
		// http://novacomonline.ehpdemo.online/novacomApp/index.php/login/new_login?username=ravip@miraclecartes.com&company_id=3&password=Ravi@2019&login_logout=0&flag=1&Walking_customer=1
    ...
    {      	
		$this->cart->destroy();
    	// http://localhost/CI_IGAINSPARK_JOY/Joycoins/index.php/login?username=ravip@miraclecartes.com&company_id=3&password=Ravi@2018&login_logout=0&flag=1		
        //https://joy1.igainapp.in/Joycoins/index.php/login?username=ravip@miraclecartes.com&company_id=3&password=Ravi@2018&login_logout=0&flag=1
