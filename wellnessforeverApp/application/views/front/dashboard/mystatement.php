		...
		<div class="custom-body">
			<div class="container">
				...
				<div class="item" style="padding-bottom: 1px; padding-top: 7px;">
					<h3 style="text-align:center"> Current Points : <?php echo $Current_point_balance; ?> <?php echo $Company_Details->Currency_name; ?></h3>
				</div>
				<?php
				...
				?>
						...
						<div class="item">
							...
							<ul class="foo">
								<li><span>Earned</span><b><?php echo $Loyalty_pts; ?></b></li>
