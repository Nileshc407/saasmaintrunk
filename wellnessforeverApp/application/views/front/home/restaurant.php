...
<div id="application_theme" class="section pricing-section" style="min-height:970px;" >
    <div class="container" id="top_container">
        <div class="section-header" style="margin-bottom:1px;">    
			<p><a href="<?php echo base_url(); ?>index.php/Cust_home/seller_dashboard" style="color:#ffffff;"><img src="<?php echo base_url(); ?>assets/icons/<?php echo $icon_src; ?>/cross.png" id="arrow"></a></p>
			<p id="Extra_large_font" style="margin-left: -3%;">Restaurant Near You</p>
        </div>
			...
			<div class="col-md-6 col-sm-6 col-xs-6">
				<a href="<?php echo base_url()?>index.php/Cust_home/restaurant">
					<div class="item-boxes">
						...
						<div class="center">
							<strong id="Medium_font" style="text-decoration: underline;">List View</strong>
						</div>
					</div>
				</a>
			</div>			
			<div class="col-md-6 col-sm-6 col-xs-6">
				<a href="<?php echo base_url()?>index.php/Shopping/restaurant_gmap">
					<div class="item-boxes">
						<div class="center">
							<strong id="Medium_font">Map View</strong>
						</div>
					</div>
				</a>
			</div>
					...
					?>
						...
						<div class="row pricing-tables" id="front_head">		
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<a href="<?php echo base_url()?>index.php/Shopping">
									<div class="item-boxes">
										<div class="center" style="padding: 10px;">
											<strong id="Medium_font"><?php echo $seller['First_name'].' '.$seller['Last_name']; ?> </strong>
											<p id="Small_font"><?php echo App_string_decrypt($seller['Current_address']); ?> </p>
										</div>
									</div>
								</a>
							</div>
								...
								<?php /* ?><div class="col-md-12 col-sm-12 col-xs-12" style="width:100%;">
								
										
										<div class="col-xs-3" >
											<strong id="Small_font">List View</strong>
										</div>
										<div class="col-xs-3">
											<strong id="Small_font">Map View</strong>
										</div>
										<div class="col-xs-3">
											<strong id="Small_font">Map View</strong>
										</div>
									...
									<a href="#">
										<div class="item-boxes" style="background-color:#322210">
											...
											<!--<img class="d-block w-25" style="padding: 10px;" src="<?php //echo $this->config->item('base_url2').$Photograph; ?>"  width="50">
											<h2 id="Small_font"><?php //echo $seller['First_name'].' '.$seller['Last_name']; ?> </h2> -->
										</div>
									</a> 
								</div><?php */ ?>
