					...
					<?php } */ ?>
						...
						<?php foreach(array_chunk($FetchSellerdetails, 2) as $group){ ?>
								<div class="grid-row">								
									...
									/* if($item['Enrollement_id']==130){ 
										$moreURL='https://tamarind.co.ke/restaurant.php?carnivore';
									} elseif($item['Enrollement_id']==131){
										$moreURL='https://tamarind.co.ke/restaurant.php?tamarind-mombasa';
									} elseif($item['Enrollement_id']==132){
										$moreURL='https://tamarind.co.ke/restaurant.php?tamambo-karen';
									} elseif($item['Enrollement_id']==133){
										$moreURL='https://tamarind.co.ke/index.php';
									} elseif($item['Enrollement_id']==134){
										$moreURL='https://tamarind.co.ke/restaurant.php?roast';
									} elseif($item['Enrollement_id']==135){
										$moreURL='https://tamarindtree-hotels.com/';
									} */
									
									/* <?php echo base_url(); ?>index.php/Cust_home/brands_details?Brand_id=<?php echo $item['Enrollement_id']; ?> */
									?>
										<div class="item">
											<div class="img">
												<!--<img src="<?php echo base_url(); ?>assets/images/restaurants5.png">-->
