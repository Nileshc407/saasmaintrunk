	...
	<header>
		<div class="container">
			<div class="text-center">
				<div class="back-link">
					<a href="<?php echo base_url();?>index.php/Cust_home/front_home"><span>Buy Gift Card</span></a>
				</div>
			</div>
		</div>
	</header>
		...
		<div class="details-card">
			<div class="payment-accordion">
				<div class="accordion" id="payment">
					<div class="card">
						<div class="card-header" id="paymenthead1">
							<a href="#" class="btn btn-header-link" data-toggle="collapse" data-target="#payment1"
							aria-expanded="true" aria-controls="payment1">Gift Card</a>
						</div>

						<div id="payment1" class="collapse show" aria-labelledby="paymenthead1" data-parent="#payment">
							<div class="card-body">
								<div class="form-group m-0">
									<input type="text" class="form-control" id="Gift_card_amt" name="Gift_card_amt"  class="form-control" onkeyup="this.value=this.value.replace(/\D/g,'')" onblur="Apply_due_amt(this.value);" placeholder="Enter Gift Card Amount (<?php echo $Symbol_of_currency; ?>)" required>
									<div class="line"></div>
					...
					<div class="card">
						<div class="card-header" id="paymenthead2">
							<a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#payment2"
							aria-expanded="true" aria-controls="payment2">Redeem Points</a>
						</div>

						<div id="payment2" class="collapse" aria-labelledby="paymenthead2" data-parent="#payment">
							<div class="card-body">
								...
								<div class="form-group d-flex m-0">
									...
									<button type="button" id="cal_redeem_amt_verify" onclick="cal_redeem_amt(1);" class="submit-btn">VERIFY</button>
								</div>
					...
					<?php } ?>
					<div class="card">
						<div class="card-header" id="paymenthead3">
							<a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#payment3"
							aria-expanded="true" aria-controls="payment3">MPESA</a>
						</div>

						<div id="payment3" class="collapse" aria-labelledby="paymenthead3" data-parent="#payment">
							<div class="card-body">
								<div class="form-group d-flex m-0">
									<input type="text" class="form-control" name="Trans_id" id="Trans_id" onkeyup="this.value=this.value.replace(/\D/g,'')" placeholder="Enter Phone No." maxlength="9">
									<button class="submit-btn" type="button" onclick="Call_API();" id="verfify_button">VERIFY</button>
								</div>
					...
					<div class="card">
						<div class="card-header" id="paymenthead4">
							<a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#payment4"
							aria-expanded="true" aria-controls="payment4">Credit Card</a>
						</div>

						<div id="payment4" class="collapse" aria-labelledby="paymenthead4" data-parent="#payment">
							<div class="card-body">
								<div class="form-group d-flex m-0">
									<button class="submit-btn" type="button" onclick="CreateToken(); setLocalStorage();" id="CreateToken_button">PAY NOW</button>
								</div>
								<div>
			...
			<div class="checkout-total">
				...
				<?php echo $Symbol_of_currency; ?>&nbsp;<input type='text' name='redeem_amt' id='redeem_amt' value="0.00" size='6' style="border:none;"readOnly></span></p>
				...
				<!------------------Nilesh 09-07-2020 credit card ------------------->												
					...
					<input type='text' name='Paid_by_MPESA' id='Paid_by_MPESA' value="0.00" size='6' style="border:none;"readOnly></span></p>
					...
					<input type='text' name='Paid_by_credit_card' id='Paid_by_credit_card' value="<?php echo $DPOCreditAmt; ?>" size='6' style="border:none;" readOnly></span></p>
					<?php } ?>												
				<!------------------Nilesh 09-07-2020 credit card ------------------->	
				
				<p>Total Due: <span class="float-right"><?php echo $Symbol_of_currency; ?>&nbsp;
				<input type='text' id='total_bill_amount' name='total_bill_amount' size='6' value="" style="border:none;" readOnly></span></p>
			</div>
			<!---Nilesh 09-07-2020--------------------->
			...
			<div class="checkout-btn-wrap">
				...
				<input type="submit" id="Payment" class="submit-btn" value="PROCEED" />
