	...
	<div class="custom-body">
				...
				<div class="cart_list">
						<!--<div class="item benefits-item">
							<h3>Exclusive rewards On Food</h3>
							<p>Try some new food with a special exclusive rewards on all the food in our menu.</p>
							
						</div>
						<div class="item benefits-item">
							<h3>Free Birthday Voucher</h3>
							<p>Let us wish you a happy birthday with a free Birthday Voucher delivery. </p>
							
						</div>
						<div class="item benefits-item">
							<h3>Offers And Special Promotions</h3>
							<p>Try some new food with a exclusive rewards on all the food in our menu.</p>
						...
						<div class="item benefits-item" style="padding: 10px">
							<h3>Burger Soda Offer</h3>							
								<div class="item" style="padding: 10px">
									<div class="img">
										<img src="<?php echo base_url(); ?>assets/images/Posts-01.jpg">
									</div>											
								</div>
						</div>
						<div class="item benefits-item" style="padding: 10px">
							<h3>Single Mocha & Full Java Breakfast </h3>							
								<div class="item" style="padding: 10px">
									<div class="img">
										<img src="<?php echo base_url(); ?>assets/images/Post-02.jpg">
									</div>											
								</div>
						</div>
						<div class="item benefits-item" style="padding: 10px">
							<h3>Breakfast Sandwich Combo</h3>							
								<div class="item" style="padding: 10px">
									<div class="img">
										<img src="<?php echo base_url(); ?>assets/images/Post-03.jpg">
									</div>											
								</div>
						</div>
						<div class="item benefits-item" style="padding: 10px">
							<h3>Quarter Chicken & Chips</h3>							
								<div class="item" style="padding: 10px">
									<div class="img">
										<img src="<?php echo base_url(); ?>assets/images/Post-04.jpg">
									</div>											
								</div>
						</div>
						<div class="item benefits-item" style="padding: 10px">
							<h3>Single Mocha & Full Java Breakfast</h3>							
								<div class="item" style="padding: 10px">
									<div class="img">
										<img src="<?php echo base_url(); ?>assets/images/Post-05.jpg">
									</div>											
								</div>
						</div>
