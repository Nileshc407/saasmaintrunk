	...
	<div class="container">
		<div class="row">
			...
			<div class="col-12 d-flex justify-content-between align-items-center hedMain">
				...
				<div class="leftRight"><button onclick="location.href = '<?php echo base_url(); ?>index.php/Cust_home/front_home';"><img src="<?php echo base_url(); ?>assets/img/qrcode-scan.svg"></button></div>
			</div>
		</div>
	</div>
</header>
			...
			<div class="col-12">
                ...
                <div class="cardMain mb-4">
                    <ul class="benefitsHldr">
                        ...
                        <li>Try some new food with a exclusive rewards on all the food in our menu.</li>
                    </ul>
                </div>
