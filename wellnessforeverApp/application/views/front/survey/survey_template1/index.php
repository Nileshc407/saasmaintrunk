...
?>
	...
	?>
			...
			<form id="sign-form" class="sign-form" action="<?php echo base_url(); ?>index.php/Cust_home/getsurveyquestionApp" method="POST" onSubmit="return checkForm(this)">
				...
				?>	
					<li id="Submitbtn">		
						<input type="text" name="Survey_data" value="<?php echo App_string_encrypt($survey_id); ?>" />
						
						<input type="text" name="smartphone_flag" value="<?php echo App_string_encrypt($smartphone_flag); ?>" />
						<input type="text" name="From_survey_mail" value="<?php echo App_string_encrypt($From_survey_mail); ?>" />
