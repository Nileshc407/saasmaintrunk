																		...
																		<br>
																			...
																			<form action="" method="post">
																				<div class="form-group mt-3"> 
																					...
																					<button type="button" class="redBtn w-100 text-center mt-3"  Onclick="insert_bidding('<?php echo $i; ?>','<?php echo App_string_encrypt($auction['Auction_id']);?>','<?php echo App_string_encrypt($Min_BId_Value); ?>','<?php echo App_string_encrypt($bid['Bid_value']); ?>','<?php echo App_string_encrypt($auction['Prize']); ?>','<?php echo App_string_encrypt($auction['Auction_name']); ?>');"   >Bid Now</button>
																				</div>	
