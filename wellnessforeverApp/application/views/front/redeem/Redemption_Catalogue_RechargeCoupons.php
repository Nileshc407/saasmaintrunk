...
<body>
	...
	?> 
	<form  name="Search_recharge_coupons" method="POST" action="<?php echo base_url()?>index.php/Redemption_Catalogue/Search_recharge_coupons" enctype="multipart/form-data">	
    <div id="application_theme" class="section pricing-section" style="min-height:520px;">
        <div class="container" >
            <div class="section-header">          
                ...
                <p id="Extra_large_font">Recharge Coupons</p>
            </div>			
            <div class="row pricing-tables">                
                ...
                <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: -31px;">
                   ...
                   <address style="margin-left:36px; margin-bottom:15px; margin-top: 4px"> 
						<a href="<?php echo base_url(); ?>index.php/Redemption_Catalogue/RechargeCoupons"><span id="button5" onclick="Page_refresh();"><img src="<?php echo base_url(); ?>assets/icons/<?php echo $icon_src1; ?>/refresh.png" style="width: 20px"></span></a>						
								...
								<!--		 </a> -->
										...
										<div class="row">                                                
											<?php  if($product['Delivery_method']==0){ ?>
												 ...
												 <?php /* ?>  <div class="col-xs-3 main-xs-3">
...
<script> 
	function form_submit()
	{
		...
		document.Search_recharge_coupons.submit();
	} 
						...
						if(data.cart_success_flag == 1)
						{
							...
							else
							{
								...
								$('#alert_div_'+Company_merchandise_item_id).hide(); 
									...
									window.location.href = "<?php echo base_url(); ?>index.php/Redemption_Catalogue/RechargeCoupons";
								},4000);
							}
						}
						else
