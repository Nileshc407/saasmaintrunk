...
<html lang="en">
  ...
  <body>         
	...
	echo form_open_multipart('Redemption_Catalogue/filters'); ?>
    <!-- Start Pricing Table Section -->
    <div id="application_theme" class="section pricing-section" style="min-height: 550px;">
      <div class="container" >
        <div class="section-header">    
            <p><a href="<?php echo base_url(); ?>index.php/Redemption_Catalogue" ><img src="<?php echo base_url(); ?>assets/icons/<?php echo $icon_src; ?>/cross.png" id="arrow"></a></p>
                                     ...
                                     <?php 
                                        ...
                                        foreach($Gender_flag as $Gender) {
                                            ...
                                            if($Gender->Gender_flag==2)
                                            {
                                             ...
                                             //echo "-----Sort_by_gender_flag-----------".$Sort_by_gender_flag;
                                            //echo "--------Gender_flag--------".$Gender->Gender_flag;
                                           /*  if($Gender->Gender_flag == $Sort_by_gender_flag)
                                            {
