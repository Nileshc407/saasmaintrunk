	...
	<div class="container">
		<div class="row">
			...
			<div class="col-12 d-flex justify-content-between align-items-center hedMain">
				...
				<div class="leftRight" style="width: 60px;"><button onclick="javascript:myFunction:Select_delected();"><img src="<?php echo base_url(); ?>assets/img/delet-icon.svg"></button> <button onclick="location.href = '<?php echo base_url();?>index.php/Cust_home/mailbox';" ><img src="<?php echo base_url(); ?>assets/img/close-icon.svg"></button></div>
			</div>
		</div>
	</div>
</header>
