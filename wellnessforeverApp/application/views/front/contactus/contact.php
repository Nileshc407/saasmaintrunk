			...
			<div class="col-12 contactWrapper">
                <div class="row">
                    <div class="col-6 pr-2">
						<?php //echo $Phone_no;  ?>
                        <a class="cf w-100" href="tel: +254 719 547940">
                    ...
                    <div class="col-6 pl-2">
                        <a class="cf w-100" href="mailto:<?php echo $User_email_id;  ?>">
                            <div class="cardMain text-center">
                ...
                <div class="cardMain mb-4 p-3">
                    <p>
						<i class="mr-2">
							...
							<?php /* echo substr($Phone_no, 0, 3).' '.substr($Phone_no, 3, 2).' '.substr($Phone_no,5,2).' '.substr($Phone_no,7,2).' '.substr($Phone_no,9,2); */  ?>
					</p>
                    <p><i class="mr-2"><img src="<?php echo base_url(); ?>assets/img/phone-icon.svg"></i>  +971 990 999999
						<?php /* echo substr($Phone_no, 0, 3).' '.substr($Phone_no, 3, 2).' '.substr($Phone_no,5,2).' '.substr($Phone_no,7,2).' '.substr($Phone_no,9,2);  */ ?></p>
