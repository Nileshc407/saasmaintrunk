	...
	<div class="container">
		<div class="row">
			...
			<div class="col-12 d-flex justify-content-between align-items-center hedMain">
				...
				<div><h1>Redemption Catalogue</h1></div>
				...
				if($Redemption_Items != NULL)
				{
					...
					?>
						...
						<?php if($product['Merchandize_item_type']== 43 || $product['Merchandize_item_type']== 269 ) 
						{
							...
							$Item_id = App_string_encrypt($Company_merchandise_item_id, $key, $iv);	
						...
						?>
									...
									<div class="cardMain m-4">
										<div class="card">
											<a href="#">
												<img src="<?php echo $product['Thumbnail_image1']; ?>" alt="" class="img-fluid">
											</a>
										</div>
											
										<div class="CurrPoints">
											<h5 class="text-center dark-bg p-2">
													<a href="#"> <?php echo $product['Merchandize_item_name']; ?> </a> </h5>
												<p class="text-center dark-bg p-2" style="color:#000;"><?php  
												...
												<div class="form-group"  id="<?php echo $product['Company_merchandise_item_id']; ?>">
													<label for="exampleInputEmail1" style="color:#000;"><h5><?php echo ('Partner Location'); ?> : </h5></label>
											...
											<div class="text">
													<button type="submit" class="redBtn w-100 text-center" onclick="add_to_cart('<?php echo $product['Company_merchandize_item_code']; ?>','<?php echo $product['Delivery_method']; ?>',location_<?php echo $product['Company_merchandise_item_id']; ?>.value,'<?php echo $product['Merchandize_item_name']; ?>','<?php echo $Billing_price_in_points; ?>','<?php echo $Item_size; ?>',<?php echo $product['Company_merchandise_item_id']; ?>,<?php echo $product['Item_Weight']; ?>,<?php echo $product['Weight_unit_id']; ?>);get_item_list();" style="margin-left: -6px;">
						...
						<?php } else { // Coupons and Gift Card Itms 
							...
							?>	
									<div class="cardMain m-4">
												...
												<div class="CurrPoints">
													<h5 class="text-center dark-bg p-2">
														<a href="#"> <?php echo $product['Merchandize_item_name']; ?> </a> 
													</h5>
														<p class="text-center dark-bg p-2"><?php  
														if($product['Size_flag'] == 1) 
														{ 
															$Get_item_price = $ci_object->Redemption_Model->Get_item_details($Company_id,$product['Company_merchandize_item_code']);	
															$Billing_price_in_points = $Get_item_price->Billing_price_in_points;
												...
												<input type="hidden" class="txt_csrfname" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>">
													...
													<div class="text">
															<button type="submit" class="redBtn w-100 text-center" onclick="add_to_cart('<?php echo $product['Company_merchandize_item_code']; ?>','<?php echo $product['Delivery_method']; ?>',location_<?php echo $product['Company_merchandise_item_id']; ?>.value,'<?php echo $product['Merchandize_item_name']; ?>','<?php echo $Billing_price_in_points; ?>','<?php echo $Item_size; ?>',<?php echo $product['Company_merchandise_item_id']; ?>,<?php echo $product['Item_Weight']; ?>,<?php echo $product['Weight_unit_id']; ?>);get_item_list();">
																<i class="fa fa-shopping-cart"></i> <?php echo ('Add to cart'); ?>
															</button>		
													</div>	
												</div>	
...
?>
	<script>
		...
		// runjs(Title,msg);	
		alert(<?php echo $this->session->flashdata('Redeem_flash'); ?>);
		ShowPopup("<?php echo $this->session->flashdata('Redeem_flash'); ?>");
                            ...
                            <li>
                                <div class="form-group">
									<label style="text-transform: capitalize;">
										...
										<?php echo ('Gift Card / Event Voucher'); ?>
									</label>
								</div>
							</li>		
							<li>		
...
function add_to_cart(Company_merchandize_item_code,Delivery_method,location,Merchandize_item_name,Points,Item_size,Company_merchandise_item_id,Item_Weight,Weight_unit_id)
{
	...
	var csrfHash = $('.txt_csrfname').val(); 
		...
		else
		{
			...
			// var Current_redeem_points=document.getElementById("Total_Redeem_points2").innerHTML;
			...
			{	
				...
				data: { Company_merchandize_item_code:Company_merchandize_item_code, Delivery_method:Checked_Delivery_method, location:location,Current_redeem_points:Current_redeem_points,Size:Item_size,Item_Weight:Item_Weight,Weight_unit_id:Weight_unit_id,item_id:Company_merchandise_item_id,[csrfName]:csrfHash},
...
function ShowPopup(x)
{
	...
	$('#popup_info').css('background-color','#06d7bc !IMPORTANT');
	//$('#popup_info2').html(x);
	//$('#popup_info3').html(x);
	//$('#popup3').show();
	//$('#popup2').show();
