      ...
      <tr>
        <td align="center" style="padding:0;">         
          ...
          <?php if($Facebook_share_flag ==1) { ?>
            <a href="$facebook_link" style="text-decoration:none;"><img src="http://novacomonline.ehpdemo.online/images/facebook_1.webp" width="40" height="40" alt="f" style="display:inline-block;color:#cccccc;"></a> 
          <?php  } ?>
          <?php if($Twitter_share_flag ==1) { ?>
          <a href="$twitter_link" style="text-decoration:none;"><img src="http://novacomonline.ehpdemo.online/images/twitter_1.webp" width="40" height="40" alt="t" style="display:inline-block;color:#cccccc;"></a>
          <?php  } ?>
          <?php if($Google_share_flag ==1) { ?>
          <a href="$googlplus_link" style="text-decoration:none;"><img src="http://novacomonline.ehpdemo.online/images/twitter_1.webp" width="40" height="40" alt="t" style="display:inline-block;color:#cccccc;"></a>
          <?php  } ?>
          <?php if($Linkedin_share_flag ==1) { ?>
          <a href="$linkedin_link" style="text-decoration:none;"><img src="http://novacomonline.ehpdemo.online/images/twitter_1.webp" width="40" height="40" alt="t" style="display:inline-block;color:#cccccc;"></a>
          <?php  } ?>
          ...
          <?php if($Unsubscribe_flg ==1) { ?>
           <p style="margin:0;font-size:14px;line-height:20px;"> <a class="unsub" href="#" style="color:#cccccc;text-decoration:underline;">Unsubscribe</a></p>
          <?php  } ?>
				$email_footer
