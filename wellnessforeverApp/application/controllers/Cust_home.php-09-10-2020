    ...
    function Create_Account_smart_phone() {
		...
		else 
		{
			...
			if($matchepwd != 0){
				...
				echo json_encode(array("status" => "1000", "Status" => 'Password and confirm Password not match'));
				exit;
				...
				exit;
                   ...
                   // echo "---Currentyear-----".$Currentyear."---<br>";
                    ...
                    if ($YearDiff < 18 ) {
                        echo json_encode(array("status" => "1000", "Status" => 'Must be 18+ to be eligible for Loyalty'));
                        exit;
                     }                  
                ...
                if ($first_name != "" && $email != "" && $Company_id != "" && $Phone_no != "" && $password != "") {
				    ...
				    echo json_encode(array("status" => "1000", "Status" => 'Invalid provided data '));
					exit;
