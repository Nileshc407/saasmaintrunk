            ...
            <div style="position: relative;color: #333333;-webkit-box-flex: 0;flex: 0 0 100%;max-width: 100%;width: 100%;min-height: 1px;padding-right: 15px;padding-left: 15px;">
                <div style="position: relative;box-shadow: 0px 0px 15px 0px rgba(0,0,0,0.10);padding: 10px 0px;border-radius: 8px;background: #fff;width: 100%;">
                    ...
                    <div style="position: relative;margin: 0;padding: 0 10px;">
                        ...
                        <div style="font-size: 14px;padding-bottom: 15px;color: #333;">$Description</div>
                        <ul style="position: relative;margin: 0;padding: 0;color: #333333;list-style: none;">
                            <li style="margin: 0 0 10px 0;padding: 0;display: flex;width: 100%;"><span style="font-family: 'gothambold';margin-right: 8px;">Voucher Code:</span> $Voucher_no</li>
                            <li style="margin: 0 0 10px 0;padding: 0;display: flex;width: 100%;"><span style="font-family: 'gothambold';margin-right: 8px;">Valid Date: </span> $Valid_till</li>
                        </ul>
                        <div style="font-size: 14px;padding-bottom: 15px;padding-top: 15px;">We look forward to your next visit.</div>
                        <div style="font-size: 14px;padding-bottom: 10px;">Thank you</div>
                        <div style="font-size: 12px;padding-bottom: 15px;">*Terms and Conditions Apply</div>
                    </div>
