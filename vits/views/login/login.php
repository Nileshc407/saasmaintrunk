...
// header("Content-Security-Policy: img-src 'self' saashosp.igainapp.in");
// header("Content-Security-Policy: default-src 'self' img-src");
// header("Content-Security-Policy: font-src maxcdn.bootstrapcdn.com");
...
?>
        <nav class="navbar navbar-b navbar-trans navbar-expand-lg" id="mainNav"><?php if(!isset($_REQUEST['User_login'])){ ?>
            <div class="container">
                <a class="navbar-brand js-scroll" href="<?php echo base_url() ; ?>index.php/login">
                    <p class="white-logo"></p>
                    <p class="black-logo"></p>
                    <img src="<?php echo  $this->config->item('base_url2').''.$Company_logo;?>" class="white-logo" alt="logo" style="width:145px;height:55px;">
                    <img src="<?php echo  $this->config->item('base_url2').''.$Company_logo;?>" class="black-logo" alt="logo" style="width:145px;height:55px;">
                </a>
    ...
    <div class="swiper-container parallax-slider">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="bg-img valign" data-background="<?php echo $this->config->item('base_url2')?>SAAS/Login_portal_images/slider-1vits.png" data-overlay-dark="2">
                    <div class="container">
                        <div class="row">
...
<div class="swiper-slide">
    <div class="bg-img valign" data-background="<?php echo $this->config->item('base_url2')?>SAAS/Login_portal_images/slider-2vits.png" data-overlay-dark="2">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2 col-md-12">
                    <div class="caption">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 wow fadeInLeft" data-wow-delay="0.2s">
                <div class="about-content">
                    <div class="about-content-text">
						...
						Loyalty points whenever you purchase of our business outlets or refer new members or share 
...
<section id="menu" class="shop-area section-padding" style="background-image: url(<?php echo $this->config->item('base_url2')?>SAAS/Login_portal_images/banner-bg-vits.png) !important;">
    <div class="container">
...
<div class="product-item-details"  style="padding: 30px 20px 57px 20px;">
    <h3>Purchase</h3>
    <p>Get Cashback Points when you Spend <?php //echo $Symbol_of_currency; ?></p>
    ...
    <div class="product-shop-item">
        <div class="product-item-content">
            ...
            <div class="product-item-details">
                <h3>Refferal</h3>
                <p>Refer your friend to join our program and Earn Points</p>
    ...
    <div class="product-shop-item">
        <div class="product-item-content">
            ...
            <div class="product-item-details"  style="padding: 30px 20px 57px 20px;">
                ...
                <p>Earn Points when you share on Social Media</p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="section-title">
                    <h5> Happy Members</h5>
                    <h2>VITS PASSPORT PLUS MEMBERSHIP</h2>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="gallery-container">
                ...
                <div class="col-lg-4 col-md-6 gallery-grid-item all lunch dessert">
                    <div class="gallery-item">
                        <img src="<?php echo $this->config->item('base_url2')?>SAAS/Login_portal_images/gallery-1-vits.png" alt="image">
                        <div class="gallery-img-overlay">
                            <div class="gallery-content">
                                <!--<div class="info">
                                    <h6>Breakfast</h6>
                                </div>-->
                                <a href="<?php echo $this->config->item('base_url2')?>SAAS/Login_portal_images/gallery-1-vits.png" class="popimg"> 
                ...
                <div class="col-lg-4 col-md-6 gallery-grid-item all dinner breakfast">
                    <div class="gallery-item">
                        <img src="<?php echo $this->config->item('base_url2')?>SAAS/Login_portal_images/gallery-2-vits.png" alt="image">
                        <div class="gallery-img-overlay">
                            <div class="gallery-content">
                                 <!--<div class="info">
                                    <h6>Lunch</h6>
                                </div>-->
                                <a href="<?php echo $this->config->item('base_url2')?>SAAS/Login_portal_images/gallery-2-vits.png" class="popimg"> 
                                    <span class="icon"><i class="icon-pictures"></i></span>
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 gallery-grid-item all lunch dessert">
                    <div class="gallery-item">
                        <img src="<?php echo $this->config->item('base_url2')?>SAAS/Login_portal_images/gallery-3-vits.png" alt="image">
                        <div class="gallery-img-overlay">
                            <div class="gallery-content">
                                <!-- <div class="info">
                                    <h6>Evening Snacks</h6>
                                </div>-->
                                <a href="<?php echo $this->config->item('base_url2')?>SAAS/Login_portal_images/gallery-3-vits.png" class="popimg"> 
                                    <span class="icon"><i class="icon-pictures"></i></span>
                                </a>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="contact-box">
                    ...
                    <p><a class="contact-info-link" href="mailto:info@example.com"><i class="icofont-envelope"></i><?php echo $Company_contactus_email_id; ?></a></p>
                </div>
            </div>
			<!--
            <div class="col-lg-4 col-md-6">
