	...
	<div>
		...
		<div style="background: #FEFDF8;border-radius: 36px 36px 0 0;">
			<div style="padding: 40px 25px 25px;">
				<h2 style="font-weight: 900; color: #030303; font-size: 20px; margin: 0 0 20px 0;">Online Order</h2>
			
				<h3 style="font-weight: 700; color: #030303; font-size: 20px; margin: 0 0 15px 0;">Dear $Customer_name,</h3>
				
				<p style="font-weight: 600; font-size: 14px; margin:0 0 18px 0; color: #86869d; line-height: 24px;">Thank you for placing your order online. Your Bill details: </p>
