...
class Shopping extends CI_Controller 
{
	...
	{  
		...
		{	
			...
			else
			{
				...
				// $Sort_by_merchant=$_SESSION['sellerID'];
				// echo"---sellerID--".$sellerID."---<br>";
			...
			if ($cart = $this->cart->contents())
			{
				...
				///**************** sandeep discount logic 27-01-2020 ***************************		
					...
					// print_r($DisOpt12);
						...
						{
							// echo "---TotalDiscountAmt------".$TotalDiscountAmt;
						...
						// echo "DiscountAmt-11-".$data["DiscountAmt"];
    ...
    public function CheckoutPayment()
	{
		...
		{						
			...
			if($data['Address_type'] =="" || $data['Address_type'] =='undefined'){
				
				$data['Address_type']= 108; //Current_address
				
			} else {
				
				// $data['Address_type']=$data['Address_type']; //Select Address
			}
		...
		/********** mpesa trans_id confirmation 05-10-2019 ***********************/
			...
			{
				$input_args3 = Array ('TransID' => $Mpesa_TransID ,'BalanceDue' => number_format($Bill_Amount_Due,2),'MpesaPaidAmount' => number_format($Mpesa_Paid_Amount,2),'BillRefNumber' => $bill);
							...
							if ($cart = $this->cart->contents())
							{
										...
										/**********Get Merchandize item name************/					
											...
											//***** sandeep ******** 24-03-2020 ****************
												...
												if($_SESSION['Redeemed_discount_voucher'] != "")
												{
													...
													$redeemed_VoucherDiscountAmt = $_SESSION['VoucherDiscountAmt'];
												}
											//***** sandeep ******** 24-03-2020 ****************
								...
								//****************** 28-08-2019 sandeep ***********************************
									...
									if($Combo_meal_flag == 0){
										...
										/* 'Voucher_no' =>$Voucher_no, */
										$Item_details[] =  json_decode(json_encode(array( 'Item_code' =>$Company_merchandize_item_code , 'Item_qty' => $item['qty'], 'Item_rate' => number_format($item['price'],2) ,  'Condiments' =>$Condiments_details )));
...
/************************************************Akshay Start***********************************************/
	...
	public function restaurant_gmap()
	{
		if($this->session->userdata('cust_logged_in'))
		{
			$session_data = $this->session->userdata('cust_logged_in');
		...
		// echo"---sellerID--".$sellerID."---<br>";
			...
			/**************Ravi Gmap- 21-11-2019*************** use only for google Map **/
				...
				$Cust_lat = $latlong_details->Latitude;
				$Cust_long= $latlong_details->Longitude;
				$data['Page_header']= "Restaurent";
				$data["Seller_details"] = $this->Igain_model->FetchSellerdetails_google_map($session_data['Company_id'],$Cust_lat,$Cust_long,$sellerID);		
				// var_dump($data["Seller_details"]);
				// $this->load->view('front/shopping/select_outlet_gmap', $data);
				$this->load->view('front/shopping/restaurent_gmap', $data);
