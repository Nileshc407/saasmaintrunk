			...
			if ($cart = $this->cart->contents())
			{
				foreach ($cart as $item)
				{
					...
					///**************** sandeep discount logic 27-01-2020 ***************************
						...
						$DiscountResult = $this->Igain_model->get_discount_value($Itemcategory_id,$ItemCode,$Item_price,$data['Company_id'],$BrandOutlet_Id,$data['enroll'],$Tier_id,0,0);
