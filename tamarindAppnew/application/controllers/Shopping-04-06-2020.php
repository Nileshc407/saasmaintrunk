			...
			if ($cart = $this->cart->contents())
			{
				foreach ($cart as $item)
				{
					...
					///**************** sandeep discount logic 27-01-2020 ***************************
						...
						$DiscountResult = $this->Igain_model->get_discount_value($Itemcategory_id,$ItemCode,$Item_price,$data['Company_id'],$BrandOutlet_Id,$data['enroll'],$Tier_id,0);
				...
				///**************** sandeep discount logic 27-01-2020 ***************************		
					...
					$DiscountResult12 = $this->Igain_model->get_discount_value($Itemcategory_id,$ItemCode,$Item_price,$data['Company_id'],$BrandOutlet_Id,$data['enroll'],$Tier_id,$order_sub_total);
									...
									foreach ($cart as $item)
									{
										...
										******************17-03-2020*******/
										/**********Get Merchandize item name************/					
											...
											// echo "<br><br><b>COD_Amount--------- </b>".$COD_Amount;
				...
				/************* online order api call 28-08-2019 sandeep *********************/
					if($delivery_outlet_details->Seller_api_url != "" || $delivery_outlet_details->Seller_api_url != NULL)
					{
						...
						//***** 18-03-2020 ************/
							...
							$_SESSION['Redeem_points'] ="";
							$_SESSION['Redeem_amount'] ="";
							$_SESSION['mpesa_BillAmount'] ="";
							
							$Discount_codes="";
							
							$sess_array = array('Discount_code' => "",'Discount_amt' => "");
							$this->session->set_userdata('Discount_details', $sess_array);
