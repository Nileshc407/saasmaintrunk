	 ...
	 */
		...
		if($Required_Condiments_set != NULL)
		{
			...
			//	$Condiments_name6 = $Condiments_set->condiments_name;
				...
				$reqCondiments = array("Item_code"=>$code7,"Item_qty"=>1,"Item_rate"=>$price7,"ParentItem_code"=>$_REQUEST["Item_code"]); //"Item_name"=>$name7,
	...
	//	print_r($Required_CondimentsCode); echo "<br>";
		...
		if($Condiments_set6_optional != NULL)
		{
			...
			//	$Condiments_name6 = $Condiments_set->condiments_name;
				...
				$OptionalCondiments = array("Item_code"=>$code6,"Item_qty"=>1,"Item_rate"=>$price6,"ParentItem_code"=>$_REQUEST["Item_code"]); //"Item_name"=>$name6,
