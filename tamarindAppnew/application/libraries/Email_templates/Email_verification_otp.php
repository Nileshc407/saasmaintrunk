	...
	<div>
		...
		<div style="background: #FFFFFF; border-radius: 36px 36px 0 0; min-height: 450px;">
			<div style="padding: 40px 25px 25px;">
				<h2 style="font-weight: 900; color: #030303; font-size: 20px; margin: 0 0 20px 0;">Email Verification</h2>
				<h3 style="font-weight: 700; color: #030303; font-size: 20px; margin: 0 0 15px 0;">Dear $Customer_name,</h3>
				<p style="font-weight: 600; font-size: 14px; margin:0 0 18px 0; color: #86869d; line-height: 24px;">A request has been made to verify your email address from your $Company_name App<br><br>Below is a verification code</p>
				<p style="font-weight: 600; font-size: 14px; margin:0 0 18px 0; color: #86869d; line-height: 24px;">$pin<br>Kindly enter this code to complete the process</p>
			</div>
		</div>
	</div>
</body>
