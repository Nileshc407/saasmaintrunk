							...
							foreach($Merchandize_category as $key=>$MerchandizeCat)
							{
								...
								if($Category_filter == $MerchandizeCat->Merchandize_category_id)
									{ 
										...
										$opt .= "<li><a 
									 onclick='show_category_items(".$MerchandizeCat->Merchandize_category_id.");'><button type='button' class='btn activeMe' style='background: #322010;padding:3px 10px;white-space: pre-wrap; height:60px;width:100px;font-size: 10px;'>".$MerchandizeCat->Merchandize_category_name."</button></a></li>";

									 }else{
								
								$opt .= "<li><a 
									 onclick='show_category_items(".$MerchandizeCat->Merchandize_category_id.");'><button type='button' class='btn btn-default' style='background: #322010;padding:3px 10px;white-space: pre-wrap; height:60px;width:100px;font-size: 10px;'>".$MerchandizeCat->Merchandize_category_name."</button></a></li>";
									 }
