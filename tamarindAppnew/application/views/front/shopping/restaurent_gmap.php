    ...
    <div id="application_theme" class="section pricing-section" style="min-height:520px;">
      <div class="container">
            <div class="section-header">          
				<p><a href="<?=base_url()?>index.php/Cust_home/seller_dashboard" style="color:#ffffff;"><img src="<?php echo base_url(); ?>assets/icons/<?php echo $icon_src; ?>/cross.png" id="arrow"></a></p>
				<p id="Extra_large_font">Restaurant GMap</p>
            </div>
						...
						<div class="row">		
							<div class="col-xs-4 main-xs-6 text-left" style="width:50%">
								<a href="<?php echo base_url()?>index.php/Cust_home/restaurant">
										...
										<strong id="Medium_font" style="padding: 6px;">List View</strong>
							...
							<div class="col-xs-4 main-xs-6 text-right" style="width:50%">
								<a href="<?php echo base_url()?>index.php/Shopping/restaurant_gmap">
										...
										<strong id="Medium_font" style="padding: 6px;text-decoration: underline;">Map View</strong>
