									...
									<div class="col-md-12" style="display:none;"> 
										<div class="row">
											<div class="col-md-3" style="width:20%;">
												<input type="radio" checked name="Main_Required_Que_set" onclick="Show_next_required('<?php echo '#'.$q0; ?>');" value="<?php echo $lp1->Company_merchandize_item_code; ?>">
											</div>
						...
						{ 
							...
							?>	
									<div class="col-md-12"> 
										<div class="row">
											<div class="col-md-3" style="width:20%;">
												<input type="radio" id="" name="Main_Required_Que_set"  onclick="Show_next_required('<?php echo '#'.$q0; ?>');" value="<?php echo $lp1->Company_merchandize_item_code; ?>">
											</div>
											<div class="col-md-9" style="width:80%;">
												<span class="pull-left">										
													<font id="Small_font" style="float: left;">
							...
							{ 
								...
								?>
									...
									<div class="col-md-12"> 
										<div class="row">
											<div class="col-md-3" style="width:20%;">
												<input type="radio" name="Main_Required_Condiments_set"  onclick="Show_next_required('<?php echo '#'.$q1; ?>');" value="<?php echo $lp1->Company_merchandize_item_code.':'.$lp1->Merchandize_item_name; ?>">
											</div>
											<div class="col-md-9" style="width:80%;">
												<span class="pull-left">										
													<font id="Small_font" style="float: left;">
							...
							foreach($ReqItem as $reqItem11)
							{
								...
								?> 	
									<div class="col-md-12"> 
										<div class="row">
											<div class="col-md-3" style="width:20%;">
												<input type="radio" name="Required_Condiments_set_<?php echo $i;?>"  onclick="Show_next_required('<?php echo '#'.$q2; ?>');" value="<?php echo $reqItem11->Company_merchandize_item_code.':'.$reqItem11->Merchandize_item_name.':'.$reqItem11->Billing_price; ?>">
											</div>
											<div class="col-md-9" style="width:80%;">
												<span class="pull-left">										
													<font id="Small_font" style="float: left;">
							...
							foreach($sideItem as $AsideItem)
							{
								?>
									...
									<div class="col-md-12"> 
										<div class="row">
											<div class="col-md-3" style="width:20%;">
												<input type="radio" id="" name="Side_Condiments_set_<?php echo $i;?>"  onclick="Show_next('<?php echo '#'.$q3; ?>');" value="<?php echo $AsideItem["Item_code"].':'.$AsideItem["Item_name"].":".$AsideItem["Item_qty"].':'.$AsideItem["Item_rate"]; ?>">
											</div>
											<div class="col-md-9" style="width:80%;">
												<span class="pull-left">										
													<font id="Small_font" style="float: left;">
							...
							foreach($OptItem as $OptItem11)
							{
								?>
									...
									<div class="col-md-12"> 
										<div class="row">
											<div class="col-md-3" style="width:20%;">
												<input type="checkbox" id="" name="Optional_Condiments_set_<?php echo $i;?>"  onclick="Show_next_required('<?php echo '#'.$q4; ?>');" value="<?php echo $OptItem11->Company_merchandize_item_code.':'.$OptItem11->Merchandize_item_name; ?>">
											</div>
											<div class="col-md-9" style="width:80%;">
												<span class="pull-left">										
													<font id="Small_font" style="float: left;">
						...
						foreach($Menuitem as $lp2)
						{
							?>
								...
								<div class="col-md-12"> 
										<div class="row">
											<div class="col-md-3" style="width:20%;">
												<input type="checkbox" id="" name="Main_Optional_Condiments_set"  onclick="Show_next_required('<?php echo '#'.$q4; ?>');" value="<?php echo $lp2->Company_merchandize_item_code.":".$lp2->Merchandize_item_name; ?>">
											</div>
											<div class="col-md-9" style="width:80%;">
												<span class="pull-left">										
													<font id="Small_font" style="float: left;">
