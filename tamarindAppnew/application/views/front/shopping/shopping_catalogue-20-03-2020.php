			...
			<div class="container">
						...
						<div class="section-header">    
							...
							<?php } else { ?>
									<p></p>
							<?php } ?>	
								<p id="Extra_large_font" style="margin-left: -3%;">Order Online</p>
						</div>
					
					
				
				
				<div class="scrolling-wrapper-flexbox" style="background:#332005;color: #fff;padding:4px;min-width: 330px;" id="Mcategory">
					...
					<?php foreach ($Merchandize_category as $MerchandizeCat) { 
						...
						?>
							...
							<span class="mr-5" style="width: 8rem;"> 
								<small>							
			...
			<?php	
				$p = 0;
					...
					<div class="col-xs-6 m-1">
					  <div class="card border border-dark p-1" style="width:160px; height:auto;">
						<div class="card-body">
							...
							?>
								<strong id="Medium_font" style="height: 22px;display: block;"><?php echo substr($itemName, 0, 25)."..."; ?></strong>
								<?php if($product['Combo_meal_flag'] ==1 ) { ?>
									<strong id="Value_font" style="height: 22px;display: block;"><?php echo substr($product['Merchandise_item_description'], 0, 50)."..."; ?></strong>
								<?php } else { ?> 
								
								<strong id="Small_font" style="height: 22px;display: block;"></strong>
