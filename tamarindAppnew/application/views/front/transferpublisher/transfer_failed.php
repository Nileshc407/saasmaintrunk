                                ...
                                <div class="pricing-table wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="0.3s" id="front_head">
                                        ...
                                        <div class="pricing-details">
                                                <div class="row">
                                                        ...
                                                        <br>
                                                            <strong id="Large_font" style="color:#FF0000;">You have entered Invalid Data for Transfered</strong>
                                                        </div>
                                                </div>
                                        </div><hr>
                                        ...
                                        <div class="pricing-details">
                                                <div class="row">
                                                        <div class="col-xs-4 main-xs-6" >
                                                                <button type="button" id="button1" class="b-items__item__add-to-cart" onclick="window.location.href='<?php echo base_url(); ?>index.php/Transfer_publisher/From_publisher'" >Transfer</button>
                                                        </div>

                                                        <div class="col-xs-4 main-xs-6" >									 
                                                                        <button type="button" id="button1" class="b-items__item__add-to-cart"  onclick="window.location.href='<?php echo base_url(); ?>index.php/Cust_home/front_home'"> Go To Home</button>
                                                        </div>
                                                </div>
                                        </div>
