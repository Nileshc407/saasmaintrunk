	...
	<header>
		<div class="container">
			<div class="text-center">
				<div class="back-link">
					<a href="<?php echo base_url(); ?>index.php/Cust_home/Vouchers_giftcard"><span>Value Vouchers</span></a>
				</div>
			</div>
		</div>
	</header>
		<div class="custom-body">
			...
			<?php if($MyValueVouchers) { ?>
			<div class="login-box">
					<p class="md-font">Provide Voucher code to cashier upon final payment</p>
				<?php foreach($MyValueVouchers as $discount) {?>
					<div class="discount-box bg-primary">
						...
						<div class="disc-content">
							<p>Value Voucher</p>
							<dt><?php echo $discount->Card_value; ?></dt>
							<div class="code mt-3">
