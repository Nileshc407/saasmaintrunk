                ...
                <div class="element-wrapper">
                    ...
                    <div class="element-box">
                        ...
                        <?php
                          ...
                          echo form_open('Coal_Transactionc/loyalty_purchase_transaction_ci', $attributes);
                        ?>
  ...
  function loyalty_program_info()
  {
      ...
      if (Lpid != "") {
          ...
          $.ajax({
              ...
              url: "<?php echo base_url() ?>index.php/Coal_Transactionc/get_loyalty_program_details",
              success: function (data)
              {
                  $('#lp_info').html(data);
              }
  ...
  function cal_redeem_amt(redeemBY)
  {
      ...
      if (redeemBY == 2)
      {
          ...
          if (calc_redeem_amt > purchase_amt)
          {
              //alert('here...');
              $("#promo_reedem").val(0);
              $("#PromoCode").html("Sorry, Your Promo Code equivalnt Redeem amountis more than Purchase Amount----4-----");
              // var Title = "In-valid Data Validation";
              // var msg='Sorry, Your Promo Code equivalnt Redeem amountis more than Purchase Amount !';
              // runjs(Title,msg);
              return false;
          }
