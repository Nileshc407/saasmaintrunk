        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="element-wrapper">
                    <h6 class="element-header">Perform Loyalty Transaction</h6>
                    <div class="element-box">
                        ...
                        <?php
                          ...
                          echo form_open('Coal_Transactionc/loyalty_transaction', $attributes);
                        ?>
						<div class="col-sm-8">
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                if($Current_balance_enroll < 0) {
									
									$Current_balance_enroll = 0;
                                }
                                ?>
                                <input class="form-control"  type="text" value="<?php echo $Current_balance_enroll; ?>" readonly >
                            <?php if ($Threshold_Merchant >= $Current_balance_enroll) { ?>
                                  <div class="help-block form-text with-errors form-control-feedback">
								...
								<?php foreach ($results as $row) { ?>
                                        <tr>
                                            <td class="row-actions">
                                                <a href="javascript:void(0);" onclick="receipt_details('<?php echo $row->Bill_no; ?>',<?php echo $row->Seller; ?>,<?php echo $row->Trans_id; ?>);" title="Receipt" >
												<i class="os-icon os-icon-ui-49" id="receipt_details"></i></a>
                                            </td>
