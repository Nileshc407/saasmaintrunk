		...
		<div class="row">
		  <div class="col-sm-12">
			...
			<?php $attributes = array('id' => 'formValidate');
					...
					$Count_mobile_template = $this->General_setting_model->Company_template_count($Company_details->Company_id);
					
					$General = $this->General_setting_model->get_type_name_by_id('frontend_settings','General', 'value',$Company_details->Company_id);
					$General_info_data = json_decode($General, true);
					
					$Small_font = $this->General_setting_model->get_type_name_by_id('frontend_settings','Small_font', 'value',$Company_details->Company_id);
					$Small_font_data = json_decode($Small_font, true);
					
					$Medium_font = $this->General_setting_model->get_type_name_by_id('frontend_settings','Medium_font', 'value',$Company_details->Company_id);
					$Medium_font_data = json_decode($Medium_font, true);
					
					$Large_font = $this->General_setting_model->get_type_name_by_id('frontend_settings','Large_font', 'value',$Company_details->Company_id);
					$Large_font_data = json_decode($Large_font, true);
					
					$Extra_large_font = $this->General_setting_model->get_type_name_by_id('frontend_settings','Extra_large_font', 'value',$Company_details->Company_id);
					$Extra_large_font_data = json_decode($Extra_large_font, true);
					
					$Value_font = $this->General_setting_model->get_type_name_by_id('frontend_settings','Value_font', 'value',$Company_details->Company_id);
					$Value_font_data = json_decode($Value_font, true);
					
					$Footer_font = $this->General_setting_model->get_type_name_by_id('frontend_settings','Footer_font', 'value',$Company_details->Company_id);
					$Footer_font_data = json_decode($Footer_font, true);			
					
					$Button_font = $this->General_setting_model->get_type_name_by_id('frontend_settings','Button_font', 'value',$Company_details->Company_id);
					$Button_font_data = json_decode($Button_font, true);
					
					$Placeholder_font = $this->General_setting_model->get_type_name_by_id('frontend_settings','Placeholder_font', 'value',$Company_details->Company_id);
					$Placeholder_font_data = json_decode($Placeholder_font, true);
					
					$Menu_access = $this->General_setting_model->get_type_name_by_id('frontend_settings','Menu_access', 'value',$Company_details->Company_id);					
				...
				?>
							...
							<legend><span>General Configuration</span></legend>	
								...
								<?php if($General_info_data[0]['Application_image_flag'] =='yes' ) {  ?>
									<div class="form-group" id="App_iamge_div" >										
										...
										<br>
										<?php $Theme_image = $this->General_setting_model->get_type_name_by_id('frontend_settings', 'application', 'value',$Company_details->Company_id);
					...
					<div class="row">
						<?php if($Company_details->Dashboard_flag==1) { ?>
							<div class="col-sm-4">
							   ...
							   <?php $dashboard_image = $this->General_setting_model->get_type_name_by_id('frontend_settings', 'dashboard', 'value',$Company_details->Company_id);
						...
						<?php if($Company_details->Profile_flag==1) { ?>
							<div class="col-sm-4">
							   <div class="card" style="width:400px">
							   <?php $profile_image = $this->General_setting_model->get_type_name_by_id('frontend_settings', 'profile', 'value',$Company_details->Company_id);
						...
						<?php if($Company_details->Ecommerce_flag==1) { ?>
							<div class="col-sm-4">
							   <div class="card" style="width:400px">
							   <?php $shopping_image = $this->General_setting_model->get_type_name_by_id('frontend_settings', 'shopping', 'value',$Company_details->Company_id);
					...
					<div class="row">
						<?php if($Company_details->Redeem_flag==1) { ?>
							<div class="col-sm-4">
							   <div class="card" style="width:400px">
							  <?php $redeem_image = $this->General_setting_model->get_type_name_by_id('frontend_settings', 'redeem', 'value',$Company_details->Company_id);
						...
						<?php if($Company_details->Offer_flag==1) { ?>
							<div class="col-sm-4">
							   <div class="card" style="width:400px">
							   <?php $offers_image = $this->General_setting_model->get_type_name_by_id('frontend_settings', 'offers', 'value',$Company_details->Company_id);
						...
						<?php if($Company_details->Transfer_flag==1) { ?>
							<div class="col-sm-4">
							   <div class="card" style="width:400px">
							   <?php $points_image = $this->General_setting_model->get_type_name_by_id('frontend_settings', 'transfer_points', 'value',$Company_details->Company_id);
					...
					<div class="row">
						<?php if($Company_details->Transfer_accross_flag==1) { ?>
							<div class="col-sm-4">
							   <div class="card" style="width:400px">
							  <?php $transfer_across_image = $this->General_setting_model->get_type_name_by_id('frontend_settings', 'transfer_across', 'value',$Company_details->Company_id);
						...
						<?php if($Company_details->Add_membership_flag==1) { ?>
							<div class="col-sm-4">
							   <div class="card" style="width:400px">
							   <?php $Add_membership_flag = $this->General_setting_model->get_type_name_by_id('frontend_settings', 'Add_membership', 'value',$Company_details->Company_id);
						...
						<?php if($Company_details->Survey_flag==1) { ?>
							<div class="col-sm-4">
							   <div class="card" style="width:400px">
							   <?php $survey_image = $this->General_setting_model->get_type_name_by_id('frontend_settings', 'survey', 'value',$Company_details->Company_id);
					...
					<div class="row">
						...
						<div class="col-sm-4">
						   <div class="card" style="width:400px">
							  <?php $notification_image = $this->General_setting_model->get_type_name_by_id('frontend_settings', 'notification', 'value',$Company_details->Company_id);
					...
					<?php if($Company_details->Call_center_flag==1) { ?>
						<div class="col-sm-4">
						   <div class="card" style="width:400px">
						  <?php $call_center_image = $this->General_setting_model->get_type_name_by_id('frontend_settings', 'call_center', 'value',$Company_details->Company_id);
					...
					<?php if($Company_details->My_statement_flag==1) { ?>
						<div class="col-sm-4">
						   <div class="card" style="width:400px">
						  <?php $statement_image = $this->General_setting_model->get_type_name_by_id('frontend_settings', 'statement', 'value',$Company_details->Company_id);
					...
					<div class="row">
						<?php if($Company_details->Contact_flag==1) { ?>
							<div class="col-sm-4">
							   <div class="card" style="width:400px">
							   <?php $contact_image = $this->General_setting_model->get_type_name_by_id('frontend_settings', 'contact', 'value',$Company_details->Company_id);
						...
						<?php if($Company_details->Buy_miles_flag==1) { ?>
							<div class="col-sm-4">
							   <div class="card" style="width:400px">
							  <?php $Buy_miles_flag = $this->General_setting_model->get_type_name_by_id('frontend_settings', 'Buy_miles', 'value',$Company_details->Company_id);
						...
						<?php if($Company_details->Promo_code_applicable==1 || $Company_details->Auction_bidding_applicable==1 ) { ?>
							<div class="col-sm-4">
							   <div class="card" style="width:400px">
							  <?php $games_image = $this->General_setting_model->get_type_name_by_id('frontend_settings', 'games', 'value',$Company_details->Company_id);
