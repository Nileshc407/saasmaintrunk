				...
				echo form_open('TierC/update_tier',$attributes); ?>
					...
					<div class="col-sm-6">	
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="Redeemtion_limit" id="Redeemtion_limit" data-error="Please enter redeemtion limit" placeholder="Enter Redeemtion Limit" required="required" onkeyup="this.value=this.value.replace(/\D/g,'')" value="<?php echo $Redeemtion_limit; ?>">
							<div class="help-block form-text with-errors form-control-feedback"></div>
						</div>
