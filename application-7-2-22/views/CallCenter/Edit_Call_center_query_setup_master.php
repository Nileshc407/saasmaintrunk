		...
		<div class="row">
		  <div class="col-sm-12">
			...
			<?php 	$attributes = array('id' => 'formValidate');
					echo form_open_multipart('Call_center/Update_Call_center_sub_query',$attributes); ?>
					  ...
					  <div class="form-group" id="User_Type">
						...
						<?php							
						$get_Qurey_name=$ci_object->CallCenter_model->Call_center_queryTypeName($query_type_details->Query_type_id); ?>								
						<option value="<?php echo $get_Qurey_name->Query_type_id; ?>"> <?php echo $get_Qurey_name->Query_type_name; ?> 
						</option>
						</select>	
					  ...
					  <div class="form-group">
						...
						<input class="form-control" type="text" name="Sub_Query" id="Sub_Query" value="<?php echo $query_type_details->Sub_query; ?>" placeholder="Enter sub query" data-error="Please enter sub query" required="required">
					  ...
					  <div class="form-group">
						...
						<textarea class="form-control" rows="3" name="subqueryreemark" id="subqueryreemark" data-error="Please enter remarks" required="required" ><?php echo $query_type_details->Query_remarks; ?></textarea>
						<div class="help-block form-text with-errors form-control-feedback"></div>
					  </div>
					  ...
					  <div class="form-buttons-w">
						...
						<input type="hidden" name="SubQueryid" value="<?php echo $query_type_details->Query_id; ?>">
					  </div>
					<?php echo form_close(); ?>		  
				  </div>
				</div>
