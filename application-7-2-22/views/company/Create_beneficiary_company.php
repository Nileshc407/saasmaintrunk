		  ...
		  <div class="col-sm-12">
			<div class="element-wrapper">
			  <h6 class="element-header">
				CREATE LOYALTY PUBLISHERS COMPNAY
			  </h6>
			 ...
			 <?php
				...
				<?php  $attributes = array('id' => 'formValidate');
					echo form_open_multipart('Company/Create_beneficiary_company',$attributes); ?>
				<div class="row">
					<div class="col-sm-6">
					...
					<div class="form-group">
						...
						<input type="radio" name="link_flag" onclick="enable_beneficiary_company(this.value);" value="1"> Yes</label>
						<label class="radio-inline">
						<input type="radio" name="link_flag" onclick="enable_beneficiary_company(this.value);" checked value="0" > No
						</label>
						<div class="help-block form-text with-errors form-control-feedback"></div>
					</div>
						  
					<div class="form-group" id="beneficiary_company_div" style="display:none">						
						<label for=""><span class="required_info">*</span> Select <?php echo $Company_name; ?> Company</label>
						<select class="form-control" id="beneficiary_company" name="Beneficiary_company" onchange="javascript:get_company_details(this.value);" data-error="Please select Company">
						<option value="">Select Company</option>
						<?php	
						foreach($igainresults as $igainresults1)
						{ ?>
							<option	value="<?php echo $igainresults1->Company_id; ?>"><?php echo $igainresults1->Company_name; 
						}
						?>
							</option>
						</select>
						<div class="help-block form-text with-errors form-control-feedback" id="beneficiary_com_err"></div>
					</div>
						
					<div class="form-group">
						<label for="exampleInputEmail1"><span class="required_info">*</span> Loyalty Publishers Company Category</label>
						<select class="form-control" name="Publishers_Category" id="Publishers_Category" required="required" data-error="Please select category">
							<option value="">Select Publishers Category</option>
							<?php
							foreach($Publishers_Category as $Category)
							{ ?>
								<option value="<?php echo $Category->Code_decode_id; ?>"><?php echo $Category->Code_decode; ?></option>
						<?php		
							}
							?>
						</select>
				  ...
				  <div class="form-group" id="bcname1">
					<label for=""> <span class="required_info">*</span> Loyalty Publishers Company Name </label>								
					<input class="form-control"  name="bcname" id="bcname"  type="text" placeholder="Enter Publishers Company Name"  required="required" data-error="Please enter publishers company name">
					...
					<input class="form-control"  name="Company_user_name" id="Company_user_name"  type="text" placeholder="Enter Company User Name"  required="required" data-error="Please enter company user name">
					...
					<input class="form-control"  name="Company_password" id="Company_password"  type="password" placeholder="Enter Company Password"  required="required" data-error="Please enter company password"> <input type="checkbox" id="showHide"> Show Password 
					...
					<input class="form-control"  name="Company_encryptionkey" id="Company_encryptionkey"  type="text" placeholder="Enter Company Encryption key"  required="required" data-error="Please enter company encryption key">
					<div class="help-block form-text with-errors form-control-feedback"></div>
					</div>
					...
					<input class="form-control"  name="redemptionratio" id="redemptionratio"  type="text" placeholder="Enter Redemption Ratio"  required="required" data-error="Please enter redemption ratio" onkeypress="return isNumberKey2(event);">
					<div class="help-block form-text with-errors form-control-feedback"></div>
					</div>
					
					<div class="form-group" >
					<label for=""> <span class="required_info">*</span> Buy Rate </label>
					<input class="form-control"  name="Buy_rate" id="Buy_rate"  type="text" placeholder="Enter Buy rate"  required="required" data-error="Please enter buy rate" onkeypress="return isNumberKey2(event);">
					<div class="help-block form-text with-errors form-control-feedback"></div>
					</div>
					
					<div class="form-group" >
					<label for=""> <span class="required_info">*</span> Tax </label>
					<input class="form-control"  name="Tax" id="Tax"  type="text" placeholder="Enter Tax"  required="required" data-error="Please enter tax" onkeypress="return isNumberKey2(event);">
					<div class="help-block form-text with-errors form-control-feedback"></div>
					</div>
					...
					<div class="form-group" id="url_div">
						...
						<input class="form-control"  name="Authentication_url" id="Authentication_url"  type="text" placeholder="Enter Authentication url"  required="required" data-error="Please enter authentication url">
						...
						<input class="form-control"  name="Transaction_url" id="Transaction_url"  type="text" placeholder="Enter Transaction url"  required="required" data-error="Please enter transaction url">
					...
					<div class="col-sm-6">	
						...
						<label class="radio-inline">
							<input type="radio" name="Cron_purchased_miles_flag" value="1"> Yes
						</label>
						<label class="radio-inline">
							<input type="radio" name="Cron_purchased_miles_flag" value="0"  checked> No
						</label>
						</div>
					
						<div class="form-group">
						<label for=""> <span class="required_info">*</span> Company Address </label>								
						<textarea class="form-control"  name="bcaddress" id="bcaddress"  placeholder="Enter Company Address"  required="required" data-error="Please enter address"></textarea>
						<div class="help-block form-text with-errors form-control-feedback"></div>
					  </div> 
					  ...
					  <div class="form-group" id="Show_Cities">
						...
						<div class="form-group">
								...
								<input type="text" class="form-control" name="Currency" id="Currency" data-error="Please enter currency" placeholder="Currency" required="required">
								<div class="help-block form-text with-errors form-control-feedback"></div>
						</div>
						
						<div class="form-group">
								<label for=""><span class="required_info">* </span> Contact Name</label>
								<input type="text" class="form-control" name="beneficiarycnt" id="beneficiarycnt" data-error="Please enter contact name" placeholder="Please Enter Contact Name" required="required">
								<div class="help-block form-text with-errors form-control-feedback"></div>
						</div>
						
						<div class="form-group" id="beneficiaryphoneno1">
								<label for=""><span class="required_info">* </span>Phone Number</label>
								<input type="text" class="form-control" name="beneficiaryphoneno" id="beneficiaryphoneno" data-error="Please enter phone number" placeholder="Phone Number" required="required" onkeyup="this.value=this.value.replace(/\D/g,'')">
						...
						<div class="form-group"  id="beneficiaryemailId11">
								...
								<input type="email" class="form-control" name="beneficiaryemailId" id="beneficiaryemailId" onblur="EmailValidation('#beneficiaryemailId',this.value,1);" data-error="Please enter email address 1" placeholder="Email Address-1" required="required">
						...
						<div class="form-group"  id="beneficiaryemailId22">
								...
								<input type="email" class="form-control" name="beneficiaryemailId1" id="beneficiaryemailId1" onblur="EmailValidation('#beneficiaryemailId1',this.value,2);" data-error="Please enter email address 2" placeholder="Email Address-2" required="required">
						...
						<div class="form-group"  id="beneficiaryemailId33">
								...
								<input type="email" class="form-control" name="beneficiaryemailId2" id="beneficiaryemailId2" onblur="EmailValidation('#beneficiaryemailId2',this.value,3);" placeholder="Email Address-3">
								<div class="help-block form-text with-errors form-control-feedback" id="email_3_err"></div>
						</div>
						<input type="hidden" name="Company_logo1" id="Company_logo" class="form-control" />
					</div>
				</div>
		...
		<div class="element-wrapper">                
				<div class="element-box">
				  <h5 class="form-header">
				   Active Loyalty Publishers Companies
				  </h5>                  
			...
			<div class="element-wrapper">                
				<div class="element-box">
				  <h5 class="form-header">
				   In-Active Loyalty Publishers Companies
				  </h5>                  
				  <div class="table-responsive">
					<table id="dataTable1" width="100%" class="table table-striped table-lightfont">
						<thead>
...
{	
	if($('#bcname').val() == "" || $('#country').val() == "" || $('#state').val() == "" || $('#city').val() == "" || $('#bcaddress').val() == "" || $('#beneficiarycnt').val() == "" || $('#beneficiaryemailId').val() == "" || $('#beneficiaryemailId1').val() == "" || $('#beneficiaryphoneno').val() == "" || $('#Currency').val() == "" || $('#Publishers_Category').val() == "" || $('#Buy_rate').val() == "" || $('#Tax').val() == "" || $('#redemptionratio').val() == "")
	{
		return false;						
	}	
	else
