		  ...
		  <div class="col-sm-12">
			<div class="element-wrapper">
			  <h6 class="element-header">
				EDIT LOYALTY PUBLISHERS COMPNAY
			  </h6>
			 ...
			 <?php
				...
				<div class="row">
					...
					<div class="form-group">
						...
						<select class="form-control" name="Publishers_Category" id="Publishers_Category" required="required" data-error="Please select category">
							<?php if($record->Publishers_category!=0) { ?>
								...
								<?php } else { ?> <option value="0">Select Publishers Category</option> <?php }?>	
						</select>
						<div class="help-block form-text with-errors form-control-feedback"></div>						
					</div>		  		
				  ...
				  <div class="form-group" id="bcname1">
					...
					<input class="form-control"  name="bcname" id="bcname"  type="text" placeholder="Enter Publishers Company Name" value="<?php echo $record->Beneficiary_company_name; ?>" required="required" data-error="Please enter publishers company name">
