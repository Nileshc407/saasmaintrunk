			  ...
			  <?php
				...
				echo form_open('SegmentC/Segment',$attributes); ?>
					...
					<div class="col-sm-6">	
						...
						<label for=""> <span class="required_info">* </span> Operator </label>
						<select class="form-control" name="Operatorid2" id="Operatorid" onchange="ckeck_operator(this.value);"  data-error="Please select operator">
							<option value="="> = </option>
						</select>
						<div class="help-block form-text with-errors form-control-feedback"></div>
						</div>
							...
							<div class="col-sm-6" >
								...
								<label for=""> <span class="required_info">*</span> Select Sex</label>
						...
						<div class="form-group" id="Hobbies"  style="display:none;width:500px !important;">
							<label for=""> Hobbies/Interest</label>
							<select class="form-control select2" multiple="true" name="Seg_hobbies[]" style="width:500px !important;">
