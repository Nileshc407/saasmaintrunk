			...
			?>
				...
				<?php 	} ?>
							  ...
							  <div class="form-group">
							   ...
							   <div class="form-group">
								...
								<select class="form-control" name="Type_of_survey" id="Type_of_survey" data-error="Please select survey type" required="required" readonly>
									...
									?>"><?php if($Survey_details->Survey_type== 1){ echo 'Feedback Survey'; } else if($Survey_details->Survey_type== 1){ echo 'Service Related Survey';} else{ echo 'Product Survey'; } ?>
								</select>
					   ...
					   <div class="form-buttons-w" align="center">
							...
							<input type="hidden" name="Company_id" value="<?php echo $Survey_details->Company_id ?>"  class="form-control">
							<input type="hidden" name="Survey_id" value="<?php echo $Survey_details->Survey_id ?>"  class="form-control">
					   </div>
					</div>
				</div>
				<?php echo form_close(); ?>	
