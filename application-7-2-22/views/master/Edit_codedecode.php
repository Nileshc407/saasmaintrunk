		  ...
		  <div class="col-sm-12">
			<div class="element-wrapper">
			  ...
			  <?php
				...
				echo form_open('Masterc/Update_CodeDecode', $attributes); ?>
				<div class="col-sm-8">
				 ...
				 <div class="form-group">
					...
					<option value="">Select</option>
					  <?php
							...
							{
						?>
								<option value="<?php echo $val->Code_decode_type_id;?>" <?php if($val->Code_decode_type_id==$Code_decode_type_id){ echo 'selected';}?>><?php echo $val->Code_decode_type;?></option>
						<?php
							}
						?>
					</select>
				  ...
				  <div class="form-group">
					<label for=""> <span class="required_info" style="color:red;">* </span>Code Decode </label>								
					<input class="form-control"  name="Code_decode" id="Code_decode" value="<?php echo $Code_decode;?>" type="text"  placeholder="Enter Code Decode" required="required" data-error="Please enter code decode">
					<div class="help-block form-text with-errors form-control-feedback"></div>
				  </div> 
				  
				  
				  <div class="form-buttons-w">
					<input type="hidden" name="Code_decode_id" value="<?php echo $Code_decode_id; ?>">
						...
						<tbody>
							...
							<tr>
								<td class="row-actions">
									<a href="<?php echo base_url()?>index.php/Masterc/Edit_CodeDecode/?Code_decode_id=<?php echo $row->Code_decode_id;?>" data-target=".bd-example-modal-lg" data-toggle="modal" title="Edit" >
