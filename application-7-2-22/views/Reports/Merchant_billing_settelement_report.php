	...
	<div class="content-box">
		<div class="row">
			...
			<?php $attributes = array('id' => 'formValidate');
				echo form_open_multipart('Reportc/Merchant_billing_Settlement_report',$attributes); ?>
				<div class="element-wrapper">
					<h6 class="element-header">Merchant Billing & Settlement Report</h6>  
				...
				<div class="element-box">				
					<div class="element-wrapper">	
					  ...
					  Merchant Billing & Settlement Report<?php if($Report_type == 0) { echo " Details"; } else { echo " Summary";} ?>
					  </h6>                  
						...
						{ ?>
							<thead>
								<tr>
									...
									<th>Merchant Name</th>
									<th>Invoice No.</th>
									<th><?php echo $Company_details->Currency_name; ?> Issued</th>
									<th>Purchased Amt (<?php echo $Symbol_of_currency ?>)</th>
						...
						{ ?>
							...
							<tfoot>
								<tr>
									...
									<th>Settlement Amount (<?php echo $Symbol_of_currency ?>)</th>
									<th>Status</th>
								</tr>
							</tfoot>
				<?php	} ?>
							...
							if($Seller_billing_details!=NULL)
							{
								...
								{	
									...
									{ ?> 
										...
										<td colspan="10" style="color:blue;"><?php echo $sellerName." - Invoice No. : ".$row->Bill_no; ?></td>
										</tr> 
							<?php   } */
						...
						<?php if($Seller_billing_details != NULL){ ?>
							...
							<a href="<?php echo base_url(); ?>index.php/Reportc/Export_merchant_billing_report/?Report_type=<?php echo $Report_type;?>&start_date=<?php echo $start_date; ?>&end_date=<?php echo $end_date;?>&seller_id=<?php echo $seller_id; ?>&Billing_status=<?php echo $Billing_status;?>&pdf_excel_flag=1">
							<button class="btn btn-success" type="button"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Excel</button>
							</a>
							
							<a href="<?php echo base_url(); ?>index.php/Reportc/Export_merchant_billing_report/?Report_type=<?php echo $Report_type;?>&start_date=<?php echo $start_date; ?>&end_date=<?php echo $end_date;?>&seller_id=<?php echo $seller_id; ?>&Billing_status=<?php echo $Billing_status; ?>&pdf_excel_flag=2">
