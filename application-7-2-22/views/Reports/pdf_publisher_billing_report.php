...
<div class="panel panel-info" style="border-color: #bce8f1;">
	<div>
		...
		<h2 style="text-align:center">Publisher Settelement Report - <?php if($Report_type == 0) { echo " Details"; } else { echo " Summary";} ?></h2>
		...
		<table border="1" cellpadding="10" cellspacing="0" style="border-collapse: collapse;">
			...
			<?php 
				...
				<tr style="background-color: #D9EDF7;">
					...
					<th style="text-align:center">Purchased Miles</th>
					<th style="text-align:center">Purchased Amount (<?php echo $Symbol_of_currency ?>)</th>
		...
		<?php
				...
				?>					
                    <tr>	
						...
						<td style="text-align:center"><?php echo $row->Purchased_miles; ?></td>
						<td style="text-align:center"><?php echo $row->Bill_purchased_amount; ?></td>
						...
						<td style="text-align:center"><?php echo $row->Settlement_flag; ?></td>
				...
				<?php
					...
					{ ?>
						<tr>	
						<td style="text-align:center"><?php echo $row->Bill_Creation_date;?></td>	<td style="text-align:center"><?php echo $row->Publisher_name; ?></td>
						<td style="text-align:center"><?php echo $row->Bill_no; ?></td>
						<td style="text-align:center"><?php echo $row->Purchased_miles; ?></td>
						<td style="text-align:center"><?php echo $row->Bill_purchased_amount; ?></td>
