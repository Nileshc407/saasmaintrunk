                ...
                <div class="element-wrapper">
                    ...
                    <div class="element-box">
                        ...
                        <?php
                          ...
                          echo form_open('Transactionc/loyalty_transaction', $attributes);
                        ?>
						<div class="col-sm-8">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            <td class="row-actions">
                                                <a href="javascript:void(0);" onclick="receipt_details('<?php echo $row->Bill_no; ?>',<?php echo $row->Seller; ?>,<?php echo $row->Trans_id; ?>);" title="Receipt" ><i class="os-icon os-icon-ui-49" id="receipt_details"></i></a>
                                            </td>
...
<!-- Modal receipt_myModal 
<div id="receipt_myModal"  class="modal fade" role="dialog">
    <div class="modal-dialog modal-dialog modal-lg" style="width: 100%;margin-top:180px;">
