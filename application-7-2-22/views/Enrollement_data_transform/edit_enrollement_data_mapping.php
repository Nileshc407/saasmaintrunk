			...
			<div class="element-wrapper">
			  ...
			  <div class="element-box">
				...
				<?php $attributes = array('id' => 'formValidate');
					echo form_open('Enrollement_data_transform/update_data_map',$attributes); ?>
				...
				<div class="row">
					<div class="col-sm-12 col-md-6">
					  ...
					  <div class="form-group">
						...
						<input class="form-control" name="Column_header_rows"  id="Column_header_rows"  type="text" onkeyup="this.value=this.value.replace(/\D/g,'')"   placeholder="Enter Number of Header Rows" required="required" value="<?php echo $Records->Column_header_rows;?>" data-error="Please enter number of header rows">
						<div class="help-block form-text with-errors form-control-feedback"></div>
					  </div>
					  
					   <div class="form-group">
						<label for=""> <span class="required_info">* </span>First Name </label>								
						<input class="form-control" onchange="checkVAL(this.value,this.id);"  name="Column_First_Name"  id="Column_First_Name"  type="text" onkeyup="this.value=this.value.replace(/\D/g,'')" value="<?php echo $Records->Column_First_Name;?>"  placeholder="Enter Column No. First Name" required="required" data-error="Please enter column number of first name" onfocus="removeVal(this.value,this.id);">
						<div class="help-block form-text with-errors form-control-feedback"></div>
					  </div>
					  
					  <div class="form-group">
						<label for=""> <span class="required_info">* </span>Last Name </label>								
						<input class="form-control" onchange="checkVAL(this.value,this.id);"  name="Column_Last_Name"  id="Column_Last_Name"  type="text" onkeyup="this.value=this.value.replace(/\D/g,'')" value="<?php echo $Records->Column_Last_Name;?>"  placeholder="Enter Column No. Last Name" required="required" data-error="Please enter column number of last name" onfocus="removeVal(this.value,this.id);">
						<div class="help-block form-text with-errors form-control-feedback"></div>
					  </div>
					...
					<div class="col-sm-12 col-md-6">
						...
						<input class="form-control" onchange="checkVAL(this.value,this.id);"  name="Column_Address"  id="Column_Address" value="<?php echo $Records->Column_Address;?>" type="text"  placeholder="Enter Column No. Address" required="required" onkeyup="this.value=this.value.replace(/\D/g,'')" data-error="Please enter column number of address" onfocus="removeVal(this.value,this.id);">
						<div class="help-block form-text with-errors form-control-feedback"></div>
						</div>
						
						<div class="form-group">
						<label for=""> <span class="required_info">* </span>Phone No </label>
						<input class="form-control" onchange="checkVAL(this.value,this.id);"  name="Column_Phone_No"  id="Column_Phone_No"  type="text" value="<?php echo $Records->Column_Phone_No;?>" placeholder="Enter Column No. Phone Number" onkeyup="this.value=this.value.replace(/\D/g,'')" required="required" data-error="Please enter column number of phone number" onfocus="removeVal(this.value,this.id);">
						<div class="help-block form-text with-errors form-control-feedback"></div>
						</div>
						
						<div class="form-group">
						<label for=""> <span class="required_info">* </span>User Email ID </label>
						<input class="form-control" onchange="checkVAL(this.value,this.id);"  name="Column_User_Email_ID"  id="Column_User_Email_ID" value="<?php echo $Records->Column_User_Email_ID;?>" type="text"  placeholder="Enter Column No. Email ID" required="required" onkeyup="this.value=this.value.replace(/\D/g,'')" data-error="Please enter column number of email" onfocus="removeVal(this.value,this.id);">
						<div class="help-block form-text with-errors form-control-feedback"></div>
						</div>
						
						<div class="form-group">
						<label for=""> <span class="required_info">* </span>Membership ID </label>
						<input class="form-control" onchange="checkVAL(this.value,this.id);"  name="Column_Membership_ID" id="Column_Membership_ID" type="text" placeholder="Enter Column No. Membership ID" required="required" value="<?php echo $Records->Column_Membership_ID;?>" onkeyup="this.value=this.value.replace(/\D/g,'')" data-error="Please enter column number of membership id" onfocus="removeVal(this.value,this.id);">
						<div class="help-block form-text with-errors form-control-feedback"></div>
						</div>
						
						<div class="form-group">
						<label for=""> <span class="required_info">* </span>Date </label>
						<input class="form-control" onchange="checkVAL(this.value,this.id);"  name="Column_Date" id="Column_Date" type="text" value="<?php echo $Records->Column_Date;?>" placeholder="Enter Column No. Date" required="required" onkeyup="this.value=this.value.replace(/\D/g,'')" data-error="Please enter column number of date" onfocus="removeVal(this.value,this.id);">
						<div class="help-block form-text with-errors form-control-feedback"></div>
						</div>
...
function setArray() {
	...
	Val_array.push(document.querySelector('#Column_First_Name').value);
	Val_array.push(document.querySelector('#Column_Last_Name').value);
	Val_array.push(document.querySelector('#Column_Address').value);
	Val_array.push(document.querySelector('#Column_Phone_No').value);
	Val_array.push(document.querySelector('#Column_User_Email_ID').value);
	Val_array.push(document.querySelector('#Column_Membership_ID').value);
...
$('#Register').click(function()
{
	...
	if( $('#Column_header_rows').val() != "" &&  $('#Column_First_Name').val() != "" &&  $('#Column_Phone_No').val() != "" &&  $('#Column_User_Email_ID').val() != "" &&  $('#Column_Membership_ID').val() != "" )
	{
		show_loader();
	}
});
