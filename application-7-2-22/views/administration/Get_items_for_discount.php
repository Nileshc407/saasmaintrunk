...
<script>
	...
	function Save_items_for_discount_rule()
	{
		...
		if(error_count==0)
		{
			...
			$.ajax({
			  type: "POST",
			  data: {Item_code: Item_code,Merchandize_category_id: Merchandize_category_id,Discount_code: Discount_code,Company_id:Company_id,Discount_percentage_or_value:Discount_percentage_or_value,Merchandize_item_name:Merchandize_item_name,},
