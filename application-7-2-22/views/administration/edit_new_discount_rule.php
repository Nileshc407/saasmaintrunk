				  ...
				  <div class="form-group">
						...
						<label for=""><span class="required_info">* </span>Discount Rule Applicable For</label>	
						 ...
						 <div class="row">
							...
							<div class="col-sm-4" >	
							  <div class="form-check" >
								<label class="form-check-label">
								<input class="form-check-input" name="Discount_rule_for" id="Category_level" type="radio"  value="2" onclick="Toggle_discount(this.value);"  <?php if($Fetch_discount_rule->Discount_rule_for==2){echo 'checked';} ?> >Category Level</label>
							  </div> 
							 </div> 
							<div class="col-sm-4" >	 
							  <div class="form-check" >
					...
					<div class="form-group" id="Bill_block2" <?php if($Fetch_discount_rule->Discount_rule_for!=1){echo 'style="display:none;"';} ?>>
						...
						<div class="form-group"  id="Item_Category" <?php if($Fetch_discount_rule->Discount_rule_for!=3){echo 'style="display:none;"';} ?>>
								<label for=""><span class="required_info" >* </span>Select Category</label>
								<div class="col-sm-12" >
								<select class="form-control" name="Item_Category_id" id="Item_Category_id"  data-error="Please Select Category"  onclick="Get_items(this.value);" >
								<option value="">Select Category</option>
								  <?php
								/*foreach($Merchandize_Category_Records as $Merchandize_Category) 
								{
