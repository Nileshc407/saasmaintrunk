				...
				<div class="col-sm-6">
				 ...
				 <div class="form-group">
						...
						<div class="col-sm-8" >
						  <div class="form-check" >
							...
							<?php if($Category_flag==1)
								{ ?>
								<input type="radio" name="Rule_for" class="form-check-input" id="r1" value="1" checked>Category
								<br> <?php } 
					...
					<div class="form-group"  id="Category" >
							<label for=""><span class="required_info" style="color:red;">* </span> Category Name</label>
							<div class="col-sm-12" >
