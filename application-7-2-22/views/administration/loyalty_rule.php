		...
		<div class="row">
		  ...
		  <div class="col-sm-6">
				  ...
				  <div class="form-group">
					...
					<select class="form-control" name="seller_id" ID="seller_id" data-error="Please Select Brand Name"    required="required">
						...
						<?php
								...
								{
									echo '<option value="0">All Brand</option>';
				 ...
				 <div class="form-group">
					...
					<input class="form-control" placeholder="Enter Loyalty Program Name" type="text" name="LPName" id="LPName" required="required"  onkeypress="return isAlphanumeric(event)" onblur="lp_name_validation(this.value,loyalty_rule_setup.value);"  data-error="Please Enter Loyalty Program Name" >
					...
					<div class="form-group">
						  <label for=""><span class="required_info" style="color:red;">* </span>Loyalty Rule For</label>
							...
							<div class="col-sm-8" >
							  <div class="form-check" >
								<label class="form-check-label">
								<input class="form-check-input" name="Rule_for" type="radio"   id="r1" value="1" checked>Category</label>
							  </div>
						...
						<div class="form-group"  id="Category" >
								...
								<div class="col-sm-12" >
								<select class="form-control select2" multiple="true" name="Category_id[]" id="Category_id"  data-error="Please Select Category" >
