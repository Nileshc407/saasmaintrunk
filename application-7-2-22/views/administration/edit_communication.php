							  ...
							  <div class="form-group">
								...
								<label for=""> Link to LBS </label>
									...
									<div class="form-group" id="Link_to_voucher_div">								
										...
										&nbsp;&nbsp;
										<label class="form-check-label">
											<input type="radio" name="Link_to_voucher" class="form-check-input"  onclick="hide_show_voucher(1)" id="Link_to_voucher" value="1" <?php if($Link_to_voucher==1){echo "checked";} ?>>Yes								
										</label>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<label class="radio-inline">										
											<input type="radio" name="Link_to_voucher"  class="form-check-input"  id="Link_to_voucher" onclick="hide_show_voucher(0)" value="0" <?php if($Link_to_voucher==0){echo "checked";} ?>>No									
										</label>
									</div>
									<div class="form-group" id="voucher_type_div">								
										...
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<label class="form-check-label">
											<input type="radio" name="Voucher_type" class="form-check-input"  onclick="hide_show_voucher_type(1);get_vouchers(122);" id="Voucher_type" value="122" <?php if($Voucher_type==122){echo "checked";} ?> >Revenue Voucher								
										</label>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<label class="radio-inline">										
											<input type="radio" name="Voucher_type"  class="form-check-input"  id="Voucher_type" onclick="hide_show_voucher_type(0);get_vouchers(123);" value="123" <?php if($Voucher_type==123){echo "checked";} ?>>Product Voucher									
										</label>
									</div>
