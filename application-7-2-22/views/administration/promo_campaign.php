		...
		?>
				...
				echo form_open_multipart('Administration/create_promo_campaign',$attributes); ?>	
				  ...
				  <div class="form-group">
						...
						?>
							<textarea class="form-control" rows="5" name="CMPdescription" placeholder="Campaign Description"><?php echo trim($results5[0]->Campaign_description); ?></textarea>
						<?php }else{
							
						?>
							<textarea class="form-control" rows="5" name="CMPdescription" placeholder="Campaign Description"></textarea>
						<?php
						}
						?>
					</div>
...
.modal-body{
	...
	<!-- Modal -->
		<div id="detail_myModal" class="modal fade" role="dialog">
			<div class="modal-dialog" style="width: 100%;margin-top:292px;">
