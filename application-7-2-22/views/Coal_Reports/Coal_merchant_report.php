		...
		<div class="row">
			...
			<?php $attributes = array('id' => 'formValidate');
				...
				<div class="element-wrapper">
					<h6 class="element-header">Merchant Transaction Report</h6>  
							...
							<div class="col-sm-6">	
							  ...
							  <div class="form-group">
								...
								<?php								
									...
									{
										if($transaction->Trans_type_id==1 || $transaction->Trans_type_id==2 || $transaction->Trans_type_id==3 || $transaction->Trans_type_id==4 || $transaction->Trans_type_id==10)
										{ ?>
				...
				<div class="element-wrapper">											
					<div class="element-box">
					  ...
					  Merchant Transaction Report<?php if($Report_type == 0) { echo " Details"; }else{echo " Summary";} ?>
					  </h6>                  
						...
						<?php
							...
							{	
							  ...
							  <?php } ?>
									...
									<td><?php echo $row->purchase_amt; ?></td>
