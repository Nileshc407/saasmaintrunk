...
class Catelogue_model extends CI_Model
 {
	...
	*/
	...
	function Update_Order_Status($data1,$Membership_id,$Company_id,$Evoucher_no,$Order_no)
	{
		$this->db->where(array('Company_id' => $Company_id, 'Voucher_no' => $Evoucher_no, 'Card_id' => $Membership_id, 'Bill_no' => $Order_no));
