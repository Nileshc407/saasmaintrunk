...
Class TierC extends CI_Controller
{
	...
	public function tier_masterc()
	{
		...
		{	
			...
			/*-----------------------Pagination---------------------*/		
			 $config = array();
			$config["base_url"] = base_url() . "/index.php/TierC/tier_masterc";
			$total_row = $this->Tier_model->Tier_count($Company_id);	//echo "--total_row --".$total_row ;	
			...
			$data["tier_results"] = $this->Tier_model->Tier_list($config["per_page"], $page,$Company_id);
