...
class General_setting extends CI_Controller 
{
	...
	function index()
	{
		if($this->session->userdata('logged_in'))
		{
			...
			{
				$total_row = $this->General_setting_model->Company_template_count($session_data['Company_id']);
			}
			...
			else
			{
				...
				// -------------------------------Application Title , Application Color & Header Colour ---------------------------//	
					...
					if($Count_mobile_template == 0 ){						
						...
						$this->db->where(array('Company_id'  => $this->input->post('Company_id'),'type'=>'General'));
				...
				// ------------------------------------application------------------------------------ //
					...
					else 
					{
						...
						$application_data = array( 	'Company_id'  => $this->input->post('Company_id'),
													'type'  	  => 'application', 
													'value'       => $application_filepath );
						$this->db->where(array('Company_id'  => $this->input->post('Company_id'),'type'=>'application'));
				...
				// ------------------------------------dashboard------------------------------------ //
					...
					else 
					{
						...
						$application_data = array( 	'Company_id'  => $this->input->post('Company_id'),
													'type'  	  => 'dashboard', 
													'value'       => $dashboard_filepath );
						$this->db->where(array('Company_id'  => $this->input->post('Company_id'),'type'=>'dashboard'));
						$result = $this->db->update('frontend_settings', $application_data);
				...
				// ------------------------------------profile------------------------------------ //
					if($Count_mobile_template == 0 ) {
						...
						$profile_data = array(	'Company_id'  => $this->input->post('Company_id'),
												'type'  	  => 'profile', 
												'value'       => $profile_filepath );
						$this->db->where(array('Company_id'  => $this->input->post('Company_id'),'type'=>'profile'));
				...
				// ------------------------------------shopping------------------------------------ //
					if($Count_mobile_template == 0 ) {
						...
						$shopping_data = array(	'Company_id'  => $this->input->post('Company_id'),
												'type'  	  => 'shopping', 
												'value'       => $shopping_filepath );
						$this->db->where(array('Company_id'  => $this->input->post('Company_id'),'type'=>'shopping'));
				...
				// ------------------------------------redeem------------------------------------ //
					if($Count_mobile_template == 0 ) {
						...
						$redeem_data = array(	'Company_id'  => $this->input->post('Company_id'),
												'type'  	  => 'redeem', 
												'value'       => $redeem_filepath );
						$this->db->where(array('Company_id'  => $this->input->post('Company_id'),'type'=>'redeem'));
				...
				// ------------------------------------offers------------------------------------ //
					if($Count_mobile_template == 0 ) {
						...
						$offers_data = array(	'Company_id'  => $this->input->post('Company_id'),
												'type'  	  => 'offers', 
												'value'       => $offers_filepath );
						$this->db->where(array('Company_id'  => $this->input->post('Company_id'),'type'=>'offers'));
				...
				// ------------------------------------transfer_points------------------------------------ //
					if($Count_mobile_template == 0 ) {
						...
						$transfer_points_data = array(	
												...
												'type'  	  => 'transfer_points', 
												'value'       => $transfer_points_filepath );
						$this->db->where(array('Company_id'  => $this->input->post('Company_id'),'type'=>'transfer_points'));
				...
				if($Count_mobile_template == 0 ) {
					...
					$transfer_across_data = array( 'Company_id'  => $this->input->post('Company_id'),
											'type'  	  => 'transfer_across', 
											'value'       => $transfer_across_filepath );
					$this->db->where(array('Company_id'  => $this->input->post('Company_id'),'type'=>'transfer_across'));
				...
				// ------------------------------------games icon------------------------------------ //
					if($Count_mobile_template == 0 ) {
						...
						$this->db->where(array('Company_id'  => $this->input->post('Company_id'),'type'=>'games'));
				...
				// ------------------------------------survey------------------------------------ //	
					if($Count_mobile_template == 0 ) {
						...
						$this->db->where(array('Company_id'  => $this->input->post('Company_id'),'type'=>'survey'));
				...
				// ------------------------------------notification------------------------------------ //
					if($Count_mobile_template == 0 ) {
						...
						$this->db->where(array('Company_id'  => $this->input->post('Company_id'),'type'=>'notification'));
				...
				// ------------------------------------statement------------------------------------ //
					if($Count_mobile_template == 0 ) {
						...
						$this->db->where(array('Company_id'  => $this->input->post('Company_id'),'type'=>'statement'));
				...
				// ------------------------------------call_center------------------------------------ //
					if($Count_mobile_template == 0 ) {
						...
						$this->db->where(array('Company_id'  => $this->input->post('Company_id'),'type'=>'call_center'));
				...
				// ------------------------------------contact------------------------------------ //
					if($Count_mobile_template == 0 ) {
						...
						$this->db->where(array('Company_id'  => $this->input->post('Company_id'),'type'=>'contact'));
				...
				// ------------------------------------Add_membership------------------------------------ //
					if($Count_mobile_template == 0 ) {
						...
						$this->db->where(array('Company_id'  => $this->input->post('Company_id'),'type'=>'Add_membership'));
				...
				/*------------------------------------Buy_miles------------------------------------*/
					if($Count_mobile_template == 0 ) {
						...
						$this->db->where(array('Company_id'  => $this->input->post('Company_id'),'type'=>'Buy_miles'));
				...
				// ------------------------------------Small Font------------------------------------ //
					...
					if($Count_mobile_template == 0 ) {
						...
						$this->db->where(array('Company_id'  => $this->input->post('Company_id'),'type'=>'Small_font'));
				...
				// ------------------------------------Medium Font------------------------------------ //
					if($Count_mobile_template == 0 ) {
						...
						$this->db->where(array('Company_id'  => $this->input->post('Company_id'),'type'=>'Medium_font'));
				...
				// ------------------------------------Large Font------------------------------------ //
					...
					if($Count_mobile_template == 0 ) {
						...
						$result = $this->db->insert('frontend_settings', $Large_font_Setting);
							...
							$this->db->where(array('Company_id'  => $this->input->post('Company_id'),'type'=>'Large_font'));
				...
				// ------------------------------------Extra large Font------------------------------------ //
					...
					if($Count_mobile_template == 0 ) {
						...
						$Extra_large_font_Setting = array(
							...
							$this->db->where(array('Company_id'  => $this->input->post('Company_id'),'type'=>'Extra_large_font'));
				...
				// ------------------------------------Value Font---------------------------------------- //
					if($Count_mobile_template == 0 ) {
						...
						$this->db->where(array('Company_id'  => $this->input->post('Company_id'),'type'=>'Value_font'));
				...
				if($Count_mobile_template == 0 ) {
					...
					$result = $this->db->insert('frontend_settings', $Footer_font_Setting);
						...
						$this->db->where(array('Company_id'  => $this->input->post('Company_id'),'type'=>'Footer_font'));
				...
				// ------------------------------------Button Font------------------------------------ //
					if($Count_mobile_template == 0 ) {
						...
						$this->db->where(array('Company_id'  => $this->input->post('Company_id'),'type'=>'Button_font'));
				...
				// ------------------------------------Placeholder Font------------------------------------ //
					if($Count_mobile_template == 0 ) {
						...
						$this->db->where(array('Company_id'  => $this->input->post('Company_id'),'type'=>'Placeholder_font'));
				...
				// ------------------------------------Menu Access------------------------------------ //
					if($Count_mobile_template == 0 ) {
						...
						$this->db->where(array('Company_id'  => $this->input->post('Company_id'),'type'=>'Menu_access'));
