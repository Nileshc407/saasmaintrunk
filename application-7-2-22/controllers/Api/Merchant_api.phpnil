	...
	public function Novacom_api()
	{
		...
		else
		{
			...
			if($Check_company_exist !=NULL)
			{
				...
				$Member_based_earning_flag = $Check_company_exist->Member_based_earning_flag;  
							...
							/********************************************************************************/
									...
									if($Error_Records != NULL)
									{
									  ...
									  $pos_html = "<p>Hello,</p>
										...
										$this->email->subject("$Server_name PoS API Error file for ".$Check_company_exist->Company_name);
