...
<table class="rtable mainTable" cellSpacing=0 cellPadding=0 width="100%" style="height:100% !important; width:100% !important; margin:0; padding:0;border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" bgColor=#ffffff>
	<tr>
	...
	<td vAlign=top>
		<table style="MARGIN: 0px auto; WIDTH: 616px;border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class='rtable' border='0' cellSpacing='0' cellPadding='0' width='616' align='center'>
			<tr>
				<td style="PADDING-BOTTOM: 0px; BACKGROUND-COLOR: #ffffff; PADDING-LEFT: 0px; PADDING-RIGHT: 0px; PADDING-TOP: 0px">
					<table style="WIDTH: 100%;border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class=rtable cellSpacing=0 cellPadding=0 align=left>
						<tr style="HEIGHT: 10px">
							<td style="BORDER-BOTTOM: medium none; TEXT-ALIGN: center; BORDER-LEFT: medium none; PADDING-BOTTOM: 5px; BACKGROUND-COLOR: #ffffff; PADDING-LEFT: 15px; WIDTH: 100%; PADDING-RIGHT: 15px; VERTICAL-ALIGN: middle; BORDER-TOP: medium none; BORDER-RIGHT: medium none; PADDING-TOP: 1px">
								...
								<div class="custom-body msg-box-body">
									<div class="msg-box">
										<div class="text" style="text-align:left;"> 
											<h2>Redeem Points Confirmation</h2>
											<p>Approve the below Redeem Request:</p>
											<p>Redeem Points: <span class="value">$Redeem_points</span></p>
											<p>Redeem Value: <span class="value">$Equivalent_amount</span></p>
											<p>Redeem From: <span class="value">POS</span></p>
										</div>
										<a href="#" class="msg-btn" style="text-align:left;">$Confirmation_link</a><br>
										<a href="#" class="msg-btn cancel-btn">$Decline_link</a>
									</div>
								</div>
								</p>
							</td>
