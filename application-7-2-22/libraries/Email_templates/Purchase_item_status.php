						...
						<tr style="HEIGHT: 10px">
							<td style="BORDER-BOTTOM: medium none; TEXT-ALIGN: center; BORDER-LEFT: medium none; PADDING-BOTTOM: 5px; BACKGROUND-COLOR: #feffff; PADDING-LEFT: 15px; WIDTH: 100%; PADDING-RIGHT: 15px; VERTICAL-ALIGN: middle; BORDER-TOP: medium none; BORDER-RIGHT: medium none; PADDING-TOP: 5px">
											...
											<table border=0 cellSpacing=0 cellPadding=0 style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
												<tr>
													<td style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BACKGROUND-COLOR: transparent; BORDER-TOP: medium none; BORDER-RIGHT: medium none">
														<IMG style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BACKGROUND-COLOR: transparent; DISPLAY: block; BORDER-TOP: medium none; BORDER-RIGHT: medium none;border:0; outline:none; text-decoration:none;" class=rimg border=0 src="<?php echo $Base_url; ?>images/transaction.jpg" width=580 height=200 hspace="0" vspace="0">
													</td>
												</tr>
											</table>
										</td>
								...
								?>
									...
									In view of the Order that you have cancelled, $Credit_points $Comapany_Currency have been Credited into your account by the Company.<br><br> 
									Your Current Loyalty Account balance is $Current_balance $Comapany_Currency . Below are the details of the transaction which was cancelled:<br><br> 
								...
								{   //'Return Initiated' ?>	
									...
									We are in receipt of your request for Return of the Item(s). Below are the details of the Item(s) you would like to return:<br><br>
								...
								{ //'Returned' ?>
									...
									Below are the Item(s) that have been Returned.<br><br>
								...
								{ //'Shipped' ?>
									...
									Thank you for Purchasing from our online Catalogue.<br><br>
								...
								{ //Delivered
								?>	
									Thank you for your recent purchase from our online Catalogue.<br><br>
								...
								<TABLE style="border: #dbdbdb 1px solid; WIDTH: 100%; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class=rtable border=0 cellSpacing=0 cellPadding=0 align=center>
									...
									<TR>
										<TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left> 
											<b>Item $Notification_type Date</b>
										</TD>
										<TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left> 
										    $Todays_date
										</TD>
									...
									<!--<TR>
										...
										<TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left> 
										    $Symbol_of_currency  $Purchase_amount.
										</TD>
									</TR>
									<TR>
										<TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left> 
									...
									<?php 
									if($Voucher_status == 21  || $Voucher_status == 23)  //'Cancel' &&  'Returned'
									{

									?>
									<TR>
										<TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left> 
											<b>Credit $Comapany_Currency</b>
										</TD>
										<TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=left> 
										   $Credit_points $Comapany_Currency
										</TD>
									</TR>	
									<?php } ?>									
									<TR>
