	...
	<td vAlign=top>
		<table style="MARGIN: 0px auto; WIDTH: 616px;border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class='rtable' border='0' cellSpacing='0' cellPadding='0' width='616' align='center'>
					...
					<table style="WIDTH: 100%;border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class=rtable cellSpacing=0 cellPadding=0 align=left>
						<tr style="HEIGHT: 10px">
							<td style="BORDER-BOTTOM: medium none; TEXT-ALIGN: center; BORDER-LEFT: medium none; PADDING-BOTTOM: 5px; BACKGROUND-COLOR: #feffff; PADDING-LEFT: 15px; WIDTH: 100%; PADDING-RIGHT: 15px; VERTICAL-ALIGN: middle; BORDER-TOP: medium none; BORDER-RIGHT: medium none; PADDING-TOP: 5px">
											...
											<table border=0 cellSpacing=0 cellPadding=0 style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
												<tr>
													<td style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BACKGROUND-COLOR: transparent; BORDER-TOP: medium none; BORDER-RIGHT: medium none">
														<IMG style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BACKGROUND-COLOR: transparent; DISPLAY: block; BORDER-TOP: medium none; BORDER-RIGHT: medium none;border:0; outline:none; text-decoration:none;" class=rimg border=0 src="<?php echo $Base_url; ?>images/redemption.jpg" width=580 height=200 hspace="0" vspace="0">
													</td>
												</tr>
											</table>
										</td>
								...
								Congratulations !!! <br>You have recieved free voucher.<br><br>
								</P>
								...
								<TABLE style="border: #dbdbdb 1px solid; WIDTH: 100%; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class=rtable border=0 cellSpacing=0 cellPadding=0 align=center>	
									<TR>										
										<TD colspan="2" style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px;background: #c4e6ff;" align=left> 
										 <IMG style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BACKGROUND-COLOR: transparent; DISPLAY: block; BORDER-TOP: medium none; BORDER-RIGHT: medium none;border:0; outline:none; text-decoration:none;margin: 0 auto;" class=rimg border=0 src="$Item_image" width=200 height=200 hspace="0" vspace="0">
										</TD>											
									</TR>
									<TR>
										<TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px; font-size: 14px;" align=left> 
									...
									<TR>
										...
										<TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px; font-size: 14px;" align=left id="OfferLink"> 
										  <!--<button style="color: #fff;cursor: pointer; display: inline-block;font-size: 14px; font-weight: 400;line-height: 1.42857;margin-bottom: 0;padding-bottom: 6px;padding-left: 12px; padding-right: 12px; padding-top: 6px; text-align: center;vertical-align: middle; white-space: nowrap; background-color: #3c8dbc;border-bottom-color: #367fa9; border-left-color: #367fa9; border-right-color: #367fa9;border-top-color: #367fa9;">Click here to update Offer Status</button>-->
									...
									$(function()
									{
									  $("#submitbutton").click(function(e){  // passing down the event 
										...
										var Offer_link ='<?php echo $Offer_link; ?>';
										if( customer_pin == "" )
										{
											document.getElementById("message").innerHTML = 'Customer Pin should not blank ';
											$("#message").css('color','red');
											return false;
										}
										$("#loader").show();										
										$.ajax({
										   url:'<?php echo base_url()?>Company_<?php echo $Company_id; ?>/index.php/Cust_home/Update_eVoucher_Status',
										   type: 'POST',
										   dataType: 'json',
										   // data: $("#myForm1").serialize(),
										   data: { customer_pin: customer_pin, Offer_link:Offer_link},
										   success: function(data)
										   {
												// alert('---success---'+data.res);
												document.getElementById("message").innerHTML = data.res;
									...
									<TR id="pinForm" style="display:none;">
										<form  method="POST" name="myForm1" id="myForm1" enctype="multipart/form-data" >
											<TD style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px; font-size: 14px;" align=center> 
												
											</TD>
											<TD  style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px; font-size: 14px;" align=left>												
												<input type="text" name="customer_pin" id="customer_pin" style="color: #555;font-size: 14px; height: 34px; line-height: 1.42857; padding-bottom: 6px; padding-left: 12px; padding-right: 12px; padding-top: 6px; width: 44%;float:left;" value="" placeholder="Enter Pin" required>
												
												<input  type="submit" id="submitbutton" style="color: #fff;cursor: pointer; display: inline-block;font-size: 14px; font-weight: 400;line-height: 1.42857;margin-bottom: 0;padding-bottom: 6px;padding-left: 12px; padding-right: 12px; padding-top: 6px; text-align: center;vertical-align: middle; white-space: nowrap; background-color: #3c8dbc;border-bottom-color: #367fa9; border-left-color: #367fa9; border-right-color: #367fa9;border-top-color: #367fa9;" value="Submit">
												<input  type="hidden" id="Offer_link" name="Offer_link" value="<?php echo $Offer_link; ?>">
											</TD>
									...
									<!--<TR id="loader" style="display:none;">
										<TD colspan="2" style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px; font-size: 14px;" align=center> 
											
											<img src="<?php //echo $Base_url; ?>images/loading.gif" align="center" width="100">
										</TD>									
									</TR>
									<TR>
										<TD colspan="2" style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px; font-size: 14px;" align=center> 
									...
									<?php  } else { ?>
									<TR>
										<TD colspan="2" style="border: #dbdbdb 1px solid;PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px; font-size: 14px;" align=left> 
											<b>Kindly visit the Outlet and fullfill the Voucher.</b>
										</TD>										
									</TR>
								<?php  } ?>									
								</TABLE>									
						...
						<tr style="HEIGHT: 20px">
							<td style="BORDER-BOTTOM: medium none; TEXT-ALIGN: center; BORDER-LEFT: medium none; PADDING-BOTTOM: 5px; BACKGROUND-COLOR: #f5f7fa; PADDING-LEFT: 15px; WIDTH: 100%; PADDING-RIGHT: 15px; VERTICAL-ALIGN: middle; BORDER-TOP: medium none; BORDER-RIGHT: medium none; PADDING-TOP: 5px">
								<P style="LINE-HEIGHT: 155%; BACKGROUND-COLOR: transparent; MARGIN-TOP: 0px; FONT-FAMILY: Arial, Helvetica, sans-serif; MARGIN-BOTTOM: 1em; COLOR: #666666; FONT-SIZE: 12px; mso-line-height-rule: exactly" align=center>
									...
									<a style="color:#C7702E" title="Member Website" href="$Member_website" target="_blank">Member Website</a>
									</span>
								</P>									
								<?php if($company_details->Cust_apk_link != "" || $company_details->Cust_ios_link != "") 
								{
								?>
									<P style="LINE-HEIGHT: 155%; BACKGROUND-COLOR: transparent; MARGIN-TOP: 0px; FONT-FAMILY: Arial, Helvetica, sans-serif; MARGIN-BOTTOM: 0; COLOR: #333333; FONT-SIZE: 25px; mso-line-height-rule: exactly" align=center>
									You can also download Android & iOS App  </P>
								<?php 
								} 
								?>
							</td>
			...
			<tr>
				...
				<tr style="HEIGHT: 10px">
				<td style="BORDER-BOTTOM: medium none; TEXT-ALIGN: center; BORDER-LEFT: medium none; PADDING-BOTTOM: 5px; BACKGROUND-COLOR: #f5f7fa; PADDING-LEFT: 15px; WIDTH: 100%; PADDING-RIGHT: 15px; VERTICAL-ALIGN: middle; BORDER-TOP: medium none; BORDER-RIGHT: medium none; PADDING-TOP: 5px">							
					<?php if( $company_details->Cust_apk_link != "" && $company_details->Cust_ios_link != ""){ $app_table_width = "WIDTH: 49%;"; }else{ $app_table_width = "WIDTH: 100%;"; } ?>						
					<?php if($company_details->Cust_apk_link != "") { ?>                                                                        
						<table style="BORDER-BOTTOM: transparent 1px solid; BORDER-LEFT: transparent 1px solid; <?php echo $app_table_width; ?> BORDER-TOP: transparent 1px solid; BORDER-RIGHT: transparent 1px solid;border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class=rtable cellSpacing=0 cellPadding=0 align=left>
								<tr>
									<td style="PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=middle>
											...
											<td style="PADDING-BOTTOM: 10px; PADDING-LEFT: 2px; PADDING-RIGHT: 2px; PADDING-TOP: 2px" align=middle>
												...
												<tr>
														<td style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BACKGROUND-COLOR: transparent; BORDER-TOP: medium none; BORDER-RIGHT: medium none">
														<a href="<?php echo $company_details->Cust_apk_link; ?>" title="Google Play" target="_blank">
															<IMG style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BACKGROUND-COLOR: transparent; DISPLAY: block; BORDER-TOP: medium none; BORDER-RIGHT: medium none;border:0; outline:none; text-decoration:none;" class=rimg border=0 src="$Gooogle_Play" width=64 height=64 hspace="0" vspace="0">
														</a>
														</td>
													</tr>
												</table>
					...
					<?php } ?>
					<?php if($company_details->Cust_ios_link != "") { ?>
							<table style="BORDER-BOTTOM: transparent 1px solid; BORDER-LEFT: transparent 1px solid; <?php echo $app_table_width; ?> BORDER-TOP: transparent 1px solid; BORDER-RIGHT: transparent 1px solid;border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class=rtable cellSpacing=0 cellPadding=0 align=left>
									<tr>
									<td style="PADDING-BOTTOM: 4px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 4px" align=middle>
									<DIV style="mso-table-lspace: 0; mso-table-rspace: 0">
									<table border=0 cellSpacing=0 cellPadding=0 align=center style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
										...
										<td style="PADDING-BOTTOM: 10px; PADDING-LEFT: 2px; PADDING-RIGHT: 2px; PADDING-TOP: 2px" align=middle>
												<table border=0 cellSpacing=0 cellPadding=0 style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
														<tr>
															<td style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BACKGROUND-COLOR: transparent; BORDER-TOP: medium none; BORDER-RIGHT: medium none">
																<a href="<?php echo $company_details->Cust_ios_link; ?>" title="iOS App" target="_blank">
																	<IMG style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BACKGROUND-COLOR: transparent; DISPLAY: block; BORDER-TOP: medium none; BORDER-RIGHT: medium none;border:0; outline:none; text-decoration:none;" class=rimg border=0 src="$iOs_app_store" width=64 height=64 hspace="0" vspace="0">
																</a>
															</td>
														</tr>
												</table>
						...
						<tr style="HEIGHT: 20px">
							<td style="BORDER-BOTTOM: medium none; TEXT-ALIGN: center; BORDER-LEFT: medium none; PADDING-BOTTOM: 5px; BACKGROUND-COLOR: #feffff; PADDING-LEFT: 15px; WIDTH: 100%; PADDING-RIGHT: 15px; VERTICAL-ALIGN: middle; BORDER-TOP: medium none; BORDER-RIGHT: medium none; PADDING-TOP: 5px">
								<P style="LINE-HEIGHT: 155%; BACKGROUND-COLOR: transparent; MARGIN-TOP: 0px; FONT-FAMILY: Arial, Helvetica, sans-serif; MARGIN-BOTTOM: 1em; COLOR: #333333; FONT-SIZE: 10px; mso-line-height-rule: exactly" align=left>
									<strong>DISCLAIMER: </strong><em>This e-mail message is proprietary to '$Company_name' and is intended solely for the use of the entity to whom it is addressed. It may contain privileged or confidential information exempt from disclosure as per applicable law. 
